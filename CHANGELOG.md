...
## 5-10-2023
### Добавлено
- Добавлены новые режимы reserv и inTransit, и их примеры, [в краткий отчёт по остаткам](https://dev.moysklad.ru/doc/api/remap/1.2/reports/#otchety-otchet-ostatki-poluchit-kratkij-otchet-ob-ostatkah)
