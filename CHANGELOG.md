...
### 24-04-2024
#### Добавлено
- Поле `allowNonFiscalTransactions` в [Точку продаж](https://dev.moysklad.ru/doc/api/remap/1.2/dictionaries/#suschnosti-tochka-prodazh), позволяющая включать тестовые продажи
