...
## 16-06-2021
### Документация
- Добавлен эндпоинт получения списка сохраненных фильтров для сущностей, документов и аудита
- Добавлено применение сохраненного фильтра для сущностей и документов
