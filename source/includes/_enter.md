...
### Оприходования 
#### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) об Оприходованиях
...
+ **state** - Статус Оприходования в формате [Метаданных](#metadannye)
...
+ **positions** - Ссылка на позиции Оприходования в формате [Метаданных](#metadannye)
...
С позициями можно работать с помощью [специальных ресурсов для управления позициями Оприходования](#oprihodovanie-pozicii-oprihodovanij),
...
О работе с доп. полями Оприходований можно прочитать [здесь](#rabota-s-dopolnitel-nymi-polyami)
...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) Оприходований.
...
+ **attributes** - Массив объектов доп. полей Оприходований в формате [Метаданных](#metadannye)
...
чем является указанная позиция. Подробнее об этом поле можно прочитать в описании [позиции Оприходования](#pozicii-oprihodovaniya)
