...
+ **name** - номер Счета-фактуры полученного
+ **description** - Комментарий Счета-фактуры полученного
+ **externalCode** - Внешний код Счета-фактуры полученного
+ **moment** - Дата Счета-фактуры полученного
+ **applicable** - Отметка о проведении
+ **sum** - Сумма Счета-фактуры полученного в установленной валюте `Только для чтения`
+ **rate** - Валюта
...
+ **state** - Статус Счета-фактуры полученного в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)
...
- **rows** - Массив JSON объектов, представляющих собой Счета-фактуры полученные.
