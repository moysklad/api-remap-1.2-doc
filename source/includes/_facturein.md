...
|**deleted**            |DateTime|Момент последнего удаления Счета-фактуры полученного|Только для чтения|да
...
|**sum**                |Int|Счета-фактуры полученного в установленной валюте|Только для чтения|нет
