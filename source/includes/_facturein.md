...
#### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) о полученном Счете-фактуре
...
+ **state** - Статус полученного Счета-фактуры в формате [Метаданных](#metadannye)
...
+ **payments** - Массив ссылок на связанные исходящие платежи в формате [Метаданных](#metadannye)
...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) полученных Счетов-фактур.
...
+ **attributes** - Массив объектов доп. полей полученных Счетов-фактур в формате [Метаданных](#metadannye)
