...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**             |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные о Статье расходов|---|да
...
|**description**      |String(4096)|Описание Статьи расходов|---|нет
|**code**             |String(255)|Код Статьи расходов|---|нет
|**externalCode**     |String(255)|Внешний код Статьи расходов|---|да
|**archived**         |Boolean|Добавлена ли Статья расходов в архивы|---|нет
