...
+ **meta** - [Метаданные](/api/remap/1.2/doc/metadata.html) объекта. Содержит тип конкретного уведомления
...
+ **invoice** - Ссылка на счет в формате [Метаданных](/api/remap/1.2/doc/metadata.html) `Только для чтения`
  ...
  + **agentName** - Имя контрагента [Метаданных](/api/remap/1.2/doc/metadata.html) `Только для чтения`
...
+ **performedBy** - Сотрудник, выполнивший изменение `Только для чтения`
  + **meta** - [Метаданные](/api/remap/1.2/doc/metadata.html) сотрудника `Только для чтения`
  + **id** - Идентификатор сотрудника `Только для чтения`
  + **name** - Имя сотрудника `Только для чтения`
+ **task** - Задача `Только для чтения`
  + **meta** - [Метаданные](/api/remap/1.2/doc/metadata.html) задачи
...
+ **retailShift** - Описание смены `Только для чтения`
  + **meta** - [Метаданные](/api/remap/1.2/doc/metadata.html) `Только для чтения`
