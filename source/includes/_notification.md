...
+ **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye) объекта. Содержит тип конкретного уведомления
...
- **rows** - Массив JSON объектов, представляющих собой [Уведомления](/other/#uwedomleniq-lenta-uwedomlenij).
...
+ **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye) объекта `Необходимое`
...
+ **taskType** - [Тип экспорта](/other/#uwedomleniq-tipy-uwedomlenij-formaty-polej-vozmozhnye-znacheniq-tipa-axporta) `Необходимое`
...
+ **taskType** - [Тип импорта](/other/#uwedomleniq-tipy-uwedomlenij-formaty-polej-vozmozhnye-znacheniq-tipa-importa) `Необходимое`
+ **taskState** - Статус завершения `Необходимое`. Может принимать значения `completed`, `interrupted`, `interrupted_by_user`, `interrupted_by_timeout`, `interrupted_by_system`
...
+ **good** - Ссылка на товар в формате [Метаданных](/#mojsklad-json-api-obschie-swedeniq-metadannye) `Необходимое`
...
+ **title** - Краткий текст уведомления `Необходимое`
+ **description** - Описание уведомления `Необходимое`
+ **invoice** - Ссылка на счет в формате [Метаданных](/#mojsklad-json-api-obschie-swedeniq-metadannye) `Необходимое`
...
+ **title** - Краткий текст уведомления `Необходимое`
+ **description** - Описание уведомления `Необходимое`
+ **order** - Ссылка на заказ в формате [Метаданных](/#mojsklad-json-api-obschie-swedeniq-metadannye) `Необходимое`
...
+ **performedBy** - Сотрудник, выполнивший изменение `Необходимое`
  + **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye) сотрудника
...
+ **diff** - Измененные поля `Необходимое`
  + **description** - Изменение описания задачи в [формате изменения поля](/other/#uwedomleniq-tipy-uwedomlenij-formaty-polej-format-izmenennogo-polq)
  + **deadline** - Изменение планируемой даты завершения задачи в [формате изменения поля](/other/#uwedomleniq-tipy-uwedomlenij-formaty-polej-format-izmenennogo-polq)
  + **agentLink** - Изменение контрагента в [формате изменения поля](/other/#uwedomleniq-tipy-uwedomlenij-formaty-polej-format-izmenennogo-polq)
  + **documentLink** - Изменение связанного документа в [формате изменения поля](/other/#uwedomleniq-tipy-uwedomlenij-formaty-polej-format-izmenennogo-polq)
  + **assignee** - Изменение исполнителя в [формате изменения поля](/other/#uwedomleniq-tipy-uwedomlenij-formaty-polej-format-izmenennogo-polq)
+ **task** - Задача `Необходимое`
  + **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye) задачи
  + **id** - Идентификатор Задачи
  + **name** - Описание задачи
...
+ **task** - Задача `Необходимое`
  ...
  + **name** - Описание задачи
  + **deadline** - Планируемая дата завершения задачи
+ **diff** - Изменения комментария в [формате изменения поля](/other/#uwedomleniq-tipy-uwedomlenij-formaty-polej-format-izmenennogo-polq) `Необходимое`
...
+ **retailShift** - Описание смены `Необходимое`
  + **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye)
