...
|**deleted**            |DateTime|Момент последнего удаления Возврата поставщику|Только для чтения|да
...
|**sum**                |Int|Сумма Возврата поставщику в копейках|Только для чтения|нет
