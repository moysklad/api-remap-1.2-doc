...
#### Атрибуты сущности
+ **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye) о Возврате поставщику
...
+ **state** - Статус Возврата поставщику в формате [Метаданных](/#mojsklad-json-api-obschie-swedeniq-metadannye)
