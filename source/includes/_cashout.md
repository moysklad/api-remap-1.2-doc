...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Расходного ордера|---|да
|**id**                 |UUID|ID Расходного ордер|Только для чтения|да
|**accountId**          |UUID| ID учетной записи|Только для чтения|да
|**syncId**             |UUID|ID синхронизации. После заполнения недоступен для изменения|---|нет
|**updated**            |DateTime|Момент последнего обновления Расходного ордер|Только для чтения|да
|**deleted**            |DateTime|Момент последнего удаления Расходного ордер|Только для чтения|да
|**name**               |String(255)|Наименование Расходного ордер|---|да
|**description**        |String(4096)|Комментарий Расходного ордер|---|нет
|**externalCode**       |String(255)|Внешний код Расходного ордер|---| да
