...
#### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) о Расходном ордере
...
+ **state** - Статус Расходного ордера  в формате [Метаданных](#metadannye)
...
+ **factureIn** - Ссылка на Счет-фактура полученный, с которым связан этот Расходный ордер в формате [Метаданных](#metadannye)
...
О работе с доп. полями Расходных ордеров можно прочитать [здесь](#rabota-s-dopolnitel-nymi-polyami)
...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) Расходных ордеров.
...
+ **attributes** - Массив объектов доп. полей Расходных ордеров в формате [Метаданных](#metadannye)
...
помечены `Только для чтения` в описании [атрибутов Расходного ордера ](#rashodnyj-order-rashodnye-ordera).
