...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**             |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные о Стране|---|да
...
|**description**      |String(4096)|Описание Страны|---|нет
|**code**             |String(255)|Код Страны|---|нет
|**externalCode**     |String(255)|Внешний код Страны|---|да
