...
то будут заданы значения пермиссий, которые были у сотрудника до смены роли, аналогично ui.
...
пермисии до смены роли были дефолтные, то произойдет смена роли, иначе будет выведена ошибка об отсутствии пермиссий.
