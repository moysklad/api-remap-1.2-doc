...
Атрибуты **owner**, **shared**, **group** и **archived** может изменять только администратор. Атрибут **email** также может изменять сам сотрудник.
Эти поля будут игнорироваться в случае попытки изменить их сотрудником с недостаточным уровнем доступа.
