...
|**correctionAmount**          |Int|разница между расчетным остатком и фактическимх|Только для чтения|нет
|**calculatedQuantity**         |Int|расчетный остаток|---|нет
|**correctionSum**          |Int|избыток/недостача|Только для чтения|нет
