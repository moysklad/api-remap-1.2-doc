...
|**deleted**            |DateTime|Момент последнего удаления Счета поставщика|Только для чтения|да
...
|**positions**          |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные позиций Счета поставщика|---|нет
|**paymentPlannedMoment**          |DateTime|Планируемая дата оплаты|---|нет
|**payedSum**            |Int|Сумма входящих платежей по Счету поставщика |Только для чтения|нет
