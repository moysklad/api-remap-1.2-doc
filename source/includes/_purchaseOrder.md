...
#### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) о Заказе поставщику
...
+ **state** - Статус Заказа в формате [Метаданных](#metadannye)
...
+ **positions** - Ссылка на позиции в Заказе в формате [Метаданных](#metadannye)
...
+ **customerOrders** - Массив ссылок на связанные заказы покупателей в формате [Метаданных](#metadannye)
+ **invoicesIn** - Массив ссылок на связанные счета поставщиков в формате [Метаданных](#metadannye)
+ **payments** - Массив ссылок на связанные платежи в формате [Метаданных](#metadannye)
+ **supplies** - Массив ссылок на связанные приемки в формате [Метаданных](#metadannye)
+ **internalOrder** - Внутренний заказ, связанный с заказом поставщику, в формате [Метаданных](#metadannye)
...
О работе с доп. полями Заказов поставщикам можно прочитать [здесь](#rabota-s-dopolnitel-nymi-polyami)
...
+ **agent** - Ссылка на контрагента (поставщику) в формате [Метаданных](#metadannye)
...
[Массовое создание и обновление](#sozdanie-i-obnowlenie-neskol-kih-ob-ektow) Заказов поставщику.
...
+ **attributes** - Массив объектов доп. полей Заказов поставщикам в формате [Метаданных](#metadannye)
...
помечены `Только для чтения` в описании [атрибутов Заказа поставщику](#zakaz-postawschiku-zakazy-postavshhikam).
...
чем является указанная позиция. Подробнее об этом поле можно прочитать в описании [позиции Заказа](#pozicii-zakaza-postawschiku-2)
