...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) Заказов поставщику.
...
помечены `Только для чтения` в описании [атрибутов Заказа поставщику](#zakaz-postavshhiku-zakazy-postavshhikam).
...
чем является указанная позиция. Подробнее об этом поле можно прочитать в описании [позиции Заказа](#pozicii-zakaza-postavshhiku)
