...
товар или инструкцию по применению. Удобнее всего такие файлы держать рядом с описание товара, к которому они 
...
список файлов в рамках товара необходимо дабавить в конец запроса `&expand=files&limit=100` при 
...
учитывать то, что переход по данной ссылке уже не требуется заголовок `Authorization`. Время жизни такой ссылки ограничено.
