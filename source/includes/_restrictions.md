...
+ Обязательное использование [сжатия содержимого ответов](#mojsklad-json-api-ogranicheniq)
...
<a name="disabling_in_restrictions">МойСклад автоматически отключает:</a>
