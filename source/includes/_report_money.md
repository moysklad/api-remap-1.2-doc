...
+ **account** - счет организации (не выводится для остатка кассы, так как касса одна на организацию)
  + **meta** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) счета организации
  + **name** - Номер счета
+ **organization** - организация
  + **meta** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) организации
