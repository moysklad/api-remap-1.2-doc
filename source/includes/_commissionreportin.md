...
#### Атрибуты сущности
+ **meta** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) о полученном отчете комиссионера
...
+ **contract** - Ссылка на договор в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) `Необходимое`
+ **project** - Ссылка на проект в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
+ **state** - Статус полученного отчета комиссионера в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
...
+ **positions** - Ссылка на позиции полученного отчета комиссионера в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
...
С позициями можно работать с помощью [специальных ресурсов для управления позициями полученного отчета комиссионера](/java-remap-1.2-doc/api/remap/1.2/ru/#полученный-отчет-комиссионера-позиции-отчета-комиссионера),
...
[Массовое создание и обновление](/java-remap-1.2-doc/api/remap/1.2/ru/#создание-и-обновление-нескольких-объектов) полученных отчетов комиссионера.
...
+ **attributes** - Массив объектов доп. полей отчетов комиссионера в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
...
помечены `Только для чтения` в описании [атрибутов полученного отчета комиссионера](/java-remap-1.2-doc/api/remap/1.2/ru/#полученный-отчет-комиссионера-полученные-отчеты-комиссионера).
...
чем является указанная позиция. Подробнее об этом поле можно прочитать в описании [позиции отчета комиссионера](/java-remap-1.2-doc/api/remap/1.2/ru/#позиции-полученного-отчета-комиссионера)
