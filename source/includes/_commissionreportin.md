...
#### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) о полученном отчете комиссионера
...
+ **state** - Статус полученного отчета комиссионера в формате [Метаданных](#metadannye)
...
+ **positions** - Ссылка на позиции полученного отчета комиссионера в формате [Метаданных](#metadannye)
...
С позициями можно работать с помощью [специальных ресурсов для управления позициями полученного отчета комиссионера](#poluchennyj-otchet-komissionera-pozicii-otcheta-komissionera),
...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) полученных отчетов комиссионера.
...
помечены `Только для чтения` в описании [атрибутов полученного отчета комиссионера](#poluchennyj-otchet-komissionera-poluchennye-otchety-komissionera).
...
чем является указанная позиция. Подробнее об этом поле можно прочитать в описании [позиции отчета комиссионера](#pozicii-poluchennogo-otcheta-komissionera)
