...
С позициями можно работать с помощью [специальных ресурсов для управления позициями полученного отчета комиссионера](#pozicii-otcheta-komissionera),
...
[Массовое создание и обновление](#sozdanie-i-obnowlenie-neskol-kih-ob-ektow) полученных отчетов комиссионера.
...
помечены `Только для чтения` в описании [атрибутов полученного отчета комиссионера](#poluchennyj-otchet-komissionera).
