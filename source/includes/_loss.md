...
### Списания 
#### Атрибуты сущности
+ **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye) о Списании
...
+ **state** - Статус Списания в формате [Метаданных](/#mojsklad-json-api-obschie-swedeniq-metadannye)
...
+ **positions** - Ссылка на позиции Списания в формате [Метаданных](/#mojsklad-json-api-obschie-swedeniq-metadannye)
...
О работе с доп. полями Списаний можно прочитать [здесь](/#rabota-s-dopolnitel-nymi-polqmi)
