...
| Название         | Тип    | Описание                                                                                                                                                                                                                       |
| ---------------- | :----- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **account**      | Object | Счет организации (не выводится для остатка кассы, так как касса одна на организацию). [Подробнее тут](../dictionaries/#suschnosti-jurlico-scheta-urlica)                                                                       |
| **organization** | Object | Организация. [Подробнее тут](../dictionaries/#suschnosti-jurlico)<br>`+Обязательное при ответе`                                                                                                                                |
