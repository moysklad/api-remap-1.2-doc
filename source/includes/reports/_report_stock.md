...
Эндпоинты предназначены для частого и быстрого обновления остатков большого количества товаров. Используйте отчет, если нужно запрашивать данные каждые 5-15 минут. 
...
- мы используем сжатие ответа на этом эндпоинте и ожидаем в запросе увидеть заголовок `Accept-Encoding` с одним из форматов: 'gzip', 'br', 'compress', 'deflate'
