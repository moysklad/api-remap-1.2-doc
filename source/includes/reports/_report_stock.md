...
В отчете будут содержаться остатки по товарам, по которым не происходит пересчет.
...
Для вывода нулевых остатков, необходимо добавить параметр `include=zeroLines`. Данный параметр учитывает только товары, 
которые использовались в операциях. Например, товар, который был создан и не учавствовал в каких-либо операциях, будет 
отсутствовать.
