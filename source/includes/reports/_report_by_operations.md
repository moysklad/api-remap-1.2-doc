## Отчет по документам для номенклатуры
...
Во всех отчетах обязательным параметром фильтрации является фильтр по номенклатуры `assortment`. Можно фильтровать только по одной номенклатуре: Товар, Модификация или Серия.
...
### Отчет по документам отображающим остатки
Отчет формируется для конкретной номенклатуры и содержит информацию о документах, формирующих остатки, в которых данная номенклатуры используется.
...
### Отчет по документам отображающим резервы
Отчет формируется для конкретной номенклатуры и содержит информацию о документах, формирующих резервы, в которых данная номенклатуры используется.
...
### Отчет по документам отображающим ожидания
Отчет формируется для конкретной номенклатуры и содержит информацию о документах, формирующих ожидания, в которых данная номенклатуры используется.
