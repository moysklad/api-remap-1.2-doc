...
Отчет прибыльности по товарам включает: товары, комплекты, услуги и модификации (но наименование указывается не самой модификации, а родительского товара, то есть если в выборке  это будет одно наименование родительского товара, где количество эта сумма обоих наименований).
