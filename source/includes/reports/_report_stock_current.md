...
Ограничения, накладываемые на параметр:
...
- Рекомендуем использовать по формуле не превышающей `3 * интервал` раз (пример: каждую минуту запрашивать остатки за прошедшие три минуты)
