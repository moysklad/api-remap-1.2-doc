...
#### Доступные значения для параметра stockType
...
| Значение          | Описание                                                     |
| ----------------- | ------------------------------------------------------------ |
| **assortmentId**  | Выдать в отчёте только указанные товары, модификации и серии |
| **storeId**       | Выдать в отчёте только указанные склады                      |
