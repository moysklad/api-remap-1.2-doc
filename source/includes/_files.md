...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**filename**               |String(255)|Имя Файла с расширением. Например - "doc.pdf"|---|нет
|**content**                |String(unlimited)|Файл, закодированный в формате Base64.|---|нет
...
|**title**               |String(255)|Название Файла|---|да
