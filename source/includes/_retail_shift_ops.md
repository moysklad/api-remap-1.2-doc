...
В качестве ответа на запросы операций со сменами всегда приходит JSON представление [Розничной смены](/java-remap-1.2-doc/api/remap/1.2/ru/#розничная-смена)
