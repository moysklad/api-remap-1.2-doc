...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Единицы измерения|---|да
|**id**                 |UUID|ID Единицы измерения|Только для чтения|да
|**accountId**          |UUID| ID учетной записи|Только для чтения|да
|**owner**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Владелец (Сотрудник)|Только для пользовательских единиц измерений|да
|**shared**             |Boolean|Общий доступ|Только для пользовательских единиц измерений|да
|**group**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Отдел сотрудника|Только для пользовательских единиц измерений|да
|**updated**            |DateTime|Момент последнего обновления Единицы измерения|Только для чтения|да
|**name**               |String(255)|Наименование Единицы измерения|Необходимое при создании|да
|**description**        |String(4096)|Описание Единциы измерения|---|нет
|**code**               |String(255)|Код Единицы измерения|---| нет
|**externalCode**       |String(255)|Внешний код Единицы измерения|--- да

### Получить Единицы измерения 
Запрос на получения списка всех единиц измерения для данной учетной записи.
