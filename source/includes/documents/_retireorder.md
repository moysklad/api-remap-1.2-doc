...
| **documentState**               | Enum                                                      | `=` `!=` `~` `~=` `=~`     | Статус процесса вывода кодов маркировки из оборота. [Подробнее тут](../dictionaries/#dokumenty-vywod-kodow-markirowki-iz-oborota-vywod-iz-oborota-statusy-processa-wywoda-kodow-markirowki-iz-oborota) <br>`+Обязательное при ответе` `+Только для чтения` |
...
| **retireOrderType**             | Enum                                                      | `=` `!=`                   | Способ вывода из оборота [Подробнее тут](../dictionaries/#dokumenty-vywod-kodow-markirowki-iz-oborota-vywod-iz-oborota-tip-dokumenta-osnowaniq) <br>`+Обязательное при ответе` `+Необходимо при создании`                                                  |
...
| **supportingTransaction**       | Enum                                                      | `=` `!=`                   | Тип документа-основания [Подробнее тут](../dictionaries/#dokumenty-vywod-kodow-markirowki-iz-oborota-vywod-iz-oborota-tip-dokumenta-osnowaniq) <br>`+Обязательное при ответе` `+Необходимо при создании`                                                   |
...
| **trackingType**                | Enum                                                      | `=` `!=`                   | Тип маркируемой продукции. [Подробнее тут](../dictionaries/#dokumenty-vywod-kodow-markirowki-iz-oborota-vywod-iz-oborota-tip-markiruemoj-produkcii) <br>`+Обязательное при ответе` `+Необходимо при создании`                                              |
