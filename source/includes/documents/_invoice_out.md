...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Счета покупателю|&mdash;|да|нет
|**id**                 |UUID|ID Счете покупателю|Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Счета покупателю|Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Счета покупателю|Только для чтения|нет|нет
|**name**               |String(255)|Наименование Счета покупателю|&mdash;|да|нет
|**description**        |String(4096)|Комментарий Счета покупателю|&mdash;|нет|нет
|**code**               |String(255)|Код Счета покупателю|&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Счета покупателю|&mdash;| да|нет
...
|**sum**                |Int|Сумма Счета в установленной валюте|Только для чтения|да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса счета|&mdash;|нет|да
...
|**positions**          |MetaArray|Метаданные позиций Счета покупателю|&mdash;|да|да
|**paymentPlannedMoment**          |DateTime|Планируемая дата оплаты|&mdash;|нет|нет
|**payedSum**            |Float|Сумма входящих платежей по Счету покупателю |Только для чтения|да|нет
