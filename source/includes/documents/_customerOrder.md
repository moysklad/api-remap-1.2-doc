...
| **description**           | String(4096)                                              | Комментарий Заказа покупателя<br>`+Change-handler`                                                                                                                                                        |
| **externalCode**          | String(255)                                               | Внешний код Заказа покупателя<br>`+Обязательное при ответе` `+Change-handler`                                                                                                                             |
...
| **moment**                | DateTime                                                  | Дата Заказа<br>`+Обязательное при ответе` `+Change-handler`                                                                                                                                               |
| **name**                  | String(255)                                               | Наименование Заказа покупателя<br>`+Обязательное при ответе` `+Change-handler`                                                                                                                            |
...
| **positions**             | MetaArray                                                 | Метаданные позиций Заказа покупателя<br>`+Обязательное при ответе` `+Expand` `+Change-handler`                                                                                                            |
...
| **state**                 | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные статуса заказа<br>`+Expand` `+Change-handler`                                                                                                                                                  |
...
| **taxSystem**             | Enum                                                      | Код системы налогообложения. [Подробнее тут](../dictionaries/#dokumenty-zakaz-pokupatelq-zakazy-pokupatelej-atributy-suschnosti-kod-sistemy-nalogooblozheniq)<br>`+Change-handler`                                             |
...
| **reserve**    | Int                                                       | Резерв данной позиции<br>`+Change-handler`                                                                                                                                                                                                                                 |
