...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Полученного отчета комиссионера|Только для чтения|да|нет
|**id**                 |UUID|ID Полученного отчета комиссионера|Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Полученного отчета комиссионера|Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Полученного отчета комиссионера|Только для чтения|нет|нет
|**name**               |String(255)|Наименование Полученного отчета комиссионера|Необходимое при создании|да|нет
|**description**        |String(4096)|Комментарий Полученного отчета комиссионера|&mdash;|нет|нет
|**code**               |String(255)|Код Полученного отчета комиссионера|&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Полученного отчета комиссионера|&mdash;| да|нет
...
|**sum**                |Int|Сумма Полученного отчета комиссионера в копейках|Только для чтения|да|нет
...
|**contract**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные договора|Необходимое при создании|да|да
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Полученного отчета комиссионера|&mdash;|нет|да
...
|**vatSum**                |Float|Сумма включая НДС|Только для чтения|да|нет
|**payedSum**                |Float|Оплаченная сумма|Только для чтения|да|нет
|**positions**        |MetaArray|Метаданные позиций Полученного отчета|Только для чтения|да|да
|**commissionPeriodStart**           |DateTime|Начало периода|Необходимое при создании|да|нет
|**commissionPeriodEnd**            |DateTime|Конец периода|Необходимое при создани|да|нет
|**rewardType**      |String(255)|Тип вознаграждения|&mdash;| нет|нет
|**rewardPercent**              |Int|Процент вознаграждения (всегда 0 если вознаграждение не рассчитывается)|&mdash;|нет|нет
|**commitentSum**                |Float|Сумма коммитента в установленной валюте|Только для чтения|нет|нет
