...
| **externalCode**        | String(255)                                               | Внешний код Возврата Покупателя<br>`+Обязательное при ответе`                                                                                 |
...
| **positions**           | MetaArray                                                 | Метаданные позиций Возврата Покупателя<br>`+Обязательное при ответе` `+Expand`                                                                |
...
| **sum**                 | Int                                                       | Сумма Возврата Покупателя в копейках<br>`+Обязательное при ответе` `+Только для чтения`                                                       |
| **syncId**              | UUID                                                      | ID синхронизации. После заполнения недоступен для изменения                                                                                   |
| **updated**             | DateTime                                                  | Момент последнего обновления Возврата Покупателя<br>`+Обязательное при ответе` `+Только для чтения`                                           |
...
| **cost**       | Int                                                       | Себестоимость (только для услуг. Выводится, если документ был создан без основания)                                                                                                                                                                      |
