...
| ----------------------- | :-------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------- | :----------------------- | :------------------------ | :------------------------ |
| **meta**                | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Входящего платежа                                                                                            | &mdash;                  | да                        | нет                       |
| **id**                  | UUID                                                      | ID Входящего платежа                                                                                                    | Только для чтения        | да                        | нет                       |
...
| **updated**             | DateTime                                                  | Момент последнего обновления Входящего платежа                                                                          | Только для чтения        | да                        | нет                       |
| **deleted**             | DateTime                                                  | Момент последнего удаления Входящего платежаа                                                                           | Только для чтения        | нет                       | нет                       |
| **name**                | String(255)                                               | Наименование Входящего платежа                                                                                          | &mdash;                  | да                        | нет                       |
| **description**         | String(4096)                                              | Комментарий Входящего платежа                                                                                           | &mdash;                  | нет                       | нет                       |
| **code**                | String(255)                                               | Код Входящего платежа                                                                                                   | &mdash;                  | нет                       | нет                       |
| **externalCode**        | String(255)                                               | Внешний код Входящего платежа                                                                                           | &mdash;                  | да                        | нет                       |
| **moment**              | DateTime                                                  | Дата Счета                                                                                                              | &mdash;                  | да                        | нет                       |
| **applicable**          | Boolean                                                   | Отметка о проведении                                                                                                    | &mdash;                  | да                        | нет                       |
| **sum**                 | Int                                                       | Сумма Входящего платежа в установленной валюте                                                                          | Только для чтения        | да                        | нет                       |
...
| **state**               | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные статуса Входящего платежа                                                                                    | &mdash;                  | нет                       | да                        |
...
| **paymentPurpose**      | String(255)                                               | Назначение платежа                                                                                                      | &mdash;                  | да                        | нет                       |
