...
| ---------------- | :-------------------------------------------------------- | :------------------------------------------------ | :----------------------- | :------------------------ | :------------------------ |
| **meta**         | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Тех. карты                             | &mdash;                  | да                        | нет                       |
| **id**           | UUID                                                      | ID Тех. карты                                     | Только для чтения        | да                        | нет                       |
| **accountId**    | UUID                                                      | ID учетной записи                                 | Только для чтения        | да                        | нет                       |
| **updated**      | DateTime                                                  | Момент последнего обновления Тех. карты           | Только для чтения        | да                        | нет                       |
| **deleted**      | DateTime                                                  | Момент последнего удаления Тех. карты             | Только для чтения        | нет                       | нет                       |
| **name**         | String(255)                                               | Наименование Тех. карты                           | Необходимое при создании | да                        | нет                       |
| **code**         | String(255)                                               | Код Тех. карты                                    | &mdash;                  | нет                       | нет                       |
| **externalCode** | String(255)                                               | Внешний код Тех. карты                            | &mdash;                  | да                        | нет                       |
...
| **pathName**     | String                                                    | Наименование группы, в которую входит Тех. карта  | Только для чтения        | да                        | нет                       |
| **parent**       | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные группы Тех. карты                      | &mdash;                  | да                        | да                        |
| **cost**         | Int                                                       | Стоимость производства                            | &mdash;                  | нет                       | нет                       |
| **materials**    | MetaArray                                                 | Коллекция метаданных материалов Тех. карты        | Необходимое при создании | да                        | да                        |
| **products**     | MetaArray                                                 | Коллекция метаданных готовых продуктов Тех. карты | Необходимое при создании | да                        | да                        |
...
| Название       | Тип                                                       | Описание                                                                                                                                              | Свойство поля в запросе | Обязательное при ответе   | Expand                    |
| -------------- | :-------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------- | :------------------------ | :------------------------ |
| **id**         | UUID                                                      | ID Материала                                                                                                                                          | Только для чтения       | да                        | нет                       |
| **accountId**  | UUID                                                      | ID учетной записи                                                                                                                                     | Только для чтения       | да                        | нет                       |
| **product**    | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные товара позиции. В случае, если в поле **assortment** указана модификация, то это поле содержит товар, к которому относится эта модификация | &mdash;                 | да                        | да                        |
| **assortment** | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные товара или модификации позиции                                                                                                             | &mdash;                 | да                        | да                        |
...
| Название       | Тип                                                       | Описание                                                                                                                                              | Свойство поля в запросе | Обязательное при ответе   | Expand                    |
| -------------- | :-------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------- | :------------------------ | :------------------------ |
| **id**         | UUID                                                      | ID Продукта                                                                                                                                           | Только для чтения       | да                        | нет                       |
| **accountId**  | UUID                                                      | ID учетной записи                                                                                                                                     | Только для чтения       | да                        | нет                       |
| **product**    | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные товара позиции. В случае, если в поле **assortment** указана модификация, то это поле содержит товар, к которому относится эта модификация | &mdash;                 | да                        | да                        |
| **assortment** | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные товара или модификации позиции                                                                                                             | &mdash;                 | да                        | да                        |
| **quantity**   | Int                                                       | Количество товаров данного вида в позиции                                                                                                             | &mdash;                 | да                        | нет                       |
