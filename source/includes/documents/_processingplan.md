...
|**materials**         |MetaArray|Коллекция метаданных материалов Тех. карты|Необходимое при создании|да
|**products**         |MetaArray|Коллекция метаданных готовых продуктов Тех. карты|Необходимое при создании|да
