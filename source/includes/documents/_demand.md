...
| **declaration**        | Array(Object)                                             | Информация о прослеживаемости импортных товаров. [Подробнее тут](../documents/#dokumenty-otgruzka-otgruzki-informaciq-o-proslezhiwaemosti-importnyh-towarow)<br>`+Выводится по запросу` `+Только для чтения`                                                                                   |
