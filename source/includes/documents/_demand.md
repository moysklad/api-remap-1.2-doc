...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Отгрузки|&mdash;|да|нет
|**id**                 |UUID|ID Отгрузки|Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Отгрузки|Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Отгрузки|Только для чтения|нет|нет
|**name**               |String(255)|Наименование Отгрузки|&mdash;|да|нет
|**description**        |String(4096)|Комментарий Отгрузки|&mdash;|нет|нет
|**code**               |String(255)|Код Отгрузки|&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Отгрузки|&mdash;| да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Отгрузки|&mdash;|нет|да
...
|**vatSum**                |Float|Сумма включая НДС|&mdash;|нет|нет
|**positions**          |MetaArray|Метаданные позиций Отгрузки|&mdash;|да|да
|**overhead**           |Object|Накладные расходы. [Подробнее тут](../dictionaries/#dokumenty-otgruzka-otgruzki-nakladnye-rashody). Если Позиции Отгрузки не заданы, то накладные расходы нельзя задать|&mdash;|нет|нет
...
| Название  | Тип | Описание                    | Свойство поля в запросе| Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**consignee**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные грузополучателя (контрагент или юрлицо)|&mdash;|нет|нет
|**transportFacilityNumber**              |String(255)|Номер автомобиля|&mdash;|нет|нет
...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**cis_1162**           |String|Значение кода маркировки в формате тега 1162|Только для чтения|да
|**type**          |Enum|Тип кода маркировки. Возможные значения: `trackingcode`, `consumerpack`, `transportpack`|Только для чтения|да
|**trackingCodes_1162** |Array(Object)|Массив вложенных кодов маркировки в формате тега 1162. Может присутствовать, только если **type** имеет значения `consumerpack` или `transportpack`|&mdash;|нет
