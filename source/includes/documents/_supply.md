...
| **moment**              | DateTime                                                  | Дата Приемки<br>`+Обязательное при ответе` `+Сhange-handler`                                                                                                                            |
...
| **overhead**            | Object                                                    | Накладные расходы. [Подробнее тут](../dictionaries/#dokumenty-priemka-priemki-nakladnye-rashody). Если Позиции Приемкм не заданы, то накладные расходы нельзя задать |
