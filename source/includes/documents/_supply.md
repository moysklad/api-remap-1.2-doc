...
| **attributes**          | Array(Object)                                             | Коллекция метаданных доп. полей. [Поля объекта](../#mojsklad-json-api-obschie-swedeniq-rabota-s-dopolnitel-nymi-polqmi)<br>`+Change-handler`                          |
...
| **description**         | String(4096)                                              | Комментарий Приемки<br>`+Change-handler`                                                                                                                              |
...
| **name**                | String(255)                                               | Наименование Приемки<br>`+Обязательное при ответе``+Change-handler`                                                                                                   |
...
| **positions**           | MetaArray                                                 | Метаданные позиций Приемки<br>`+Обязательное при ответе` `+Expand``+Change-handler`                                                                                   |
...
| **state**               | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные статуса Приемки<br>`+Expand``+Change-handler`                                                                                                              |
...
| **vat**           | Boolean                                                   | НДС, которым облагается текущая позиция<br>`+Обязательное при ответе``+Change-handler`                                                                                                                                                                                    |
