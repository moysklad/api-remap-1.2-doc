...
| **externalCode**        | String(255)                                               | `=` `!=` `~` `~=` `=~`                                                                                                                            | Внешний код Приемки<br>`+Обязательное при ответе``+Change-handler` `+Update-provider`                                                                                                    |
...
| **meta**                | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) |                                                                                                                                                   | Метаданные Приемки<br>`+Обязательное при ответе``+Change-handler` `+Update-provider`                                                                                                     |
...
| **vatSum**              | Float                                                     |                                                                                                                                                   | Сумма включая НДС<br>`+Обязательное при ответе``+Change-handler` `+Update-provider`                                                                                                      |
