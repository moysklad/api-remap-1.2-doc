...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Внесения денег |&mdash;|да|нет
|**id**                 |UUID|ID Внесения денег |Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Внесения денег |Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Внесения денег |Только для чтения|нет|нет
|**name**               |String(255)|Наименование Внесения денег  |&mdash;|да|нет
|**description**        |String(4096)|Комментарий Внесения денег |&mdash;|нет|нет
|**code**               |String(255)|Код Внесения денег  |&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Внесения денег  |&mdash;| да|нет
|**moment**             |DateTime|Дата Счета|&mdash;|да|нет
|**applicable**         |Boolean|Отметка о проведении|&mdash;|да|нет
|**sum**                |Int|Сумма Внесения денег в копейках|Только для чтения|да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Внесения денег |&mdash;|нет|да
