...
| **demand**        | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) |                                                                                                                                                   | Метаданные связного документа Отгрузки<br>`+Только для чтения`                                                                                                                                          |
...
| **supply**        | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) |                                                                                                                                                   | Метаданные связного документа Приемки<br>`+Обязательное при ответе` `+Только для чтения``+Change-handler`                                                                                                        |
