...
| **demand**        | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) |                                                                                                                                                   | Метаданные связного документа Отгрузки<br>`+Только для чтения` `+Expand`                                                                                                                                |
...
| **supply**        | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) |                                                                                                                                                   | Метаданные связного документа Приемки<br>`+Только для чтения` `+Expand`                                                                                                                                 |
