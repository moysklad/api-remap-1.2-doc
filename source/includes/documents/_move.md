...
| Название           | Описание                                                                                                                                        |
|--------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| **customerOrder**  | Ссылка на Заказ Покупателя, с которым связано это перемещение в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)         |
| **demand**         | Ссылка на Отгрузку, с которой связано это перемещение в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)                 |
| **internalOrder**  | Ссылка на Внутренний заказ, с которым связано это перемещение в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)         |
| **supply**         | Ссылка на Приёмку, с которой связано это перемещение в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)                  |
| **productionTask** | Ссылка на Производственное задание, с которым связано это перемещение в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye) |
...
| **overhead**   | Int                                                       | Накладные расходы. [Подробнее тут](../documents/#dokumenty-peremeschenie-peremescheniq-nakladnye-rashody). Если Позиции Перемещения не заданы, то накладные расходы нельзя задать<br>`+Обязательное при ответе` `+Только для чтения`                                      |
...
+ **assortment** - Ссылка на товар/услугу/серию/модификацию, которую представляет собой позиция. Подробнее об этом поле можно прочитать в описании [позиции Перемещения](../documents/#dokumenty-peremeschenie-peremescheniq-pozicii-peremescheniq)
