...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Приходного ордера|&mdash;|да|нет
|**id**                 |UUID|ID Приходного ордера|Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Приходного ордера|Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Приходного ордера|Только для чтения|нет|нет
|**name**               |String(255)|Наименование Приходного ордера|&mdash;|да|нет
|**description**        |String(4096)|Комментарий Приходного ордера|&mdash;|нет|нет
|**code**               |String(255)|Код Приходного ордера|&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Приходного ордера|&mdash;| да|нет
|**moment**             |DateTime|Дата Счета|&mdash;|да|нет
|**applicable**         |Boolean|Отметка о проведении|&mdash;|да|нет
|**sum**                |Int|Сумма Приходного ордера в установленной валюте|Только для чтения|да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Приходного ордера|&mdash;|нет|да
