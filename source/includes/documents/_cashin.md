...
| **agent**          | [Meta](../#mojsklad-json-api-obschie-s7wedeniq-metadannye) | Метаданные [яндекс](https://y1andex.ru/) контрагента<br>`+Обязательное при ответе` `+Expand` `+Необходимо при создании`                                                     |
