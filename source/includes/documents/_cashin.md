...
| **agent**          | [Meta](../#mojsklad-json-api-obschie-s7wedeniq-metadannye) | Метаданные [яндекс](https://yandex.ru/) контрагента<br>`+Обязательное при ответе` `+Expand` `+Необходимо при создании`                                                     |
