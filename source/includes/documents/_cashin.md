...
|**name**               |String(255)|Наименование Приходного ордера|&mdash;|да
|**description**        |String(4096)|Комментарий Приходного ордера|&mdash;|нет
|**code**               |String(255)|Код Приходного ордера|&mdash;| нет
|**externalCode**       |String(255)|Внешний код Приходного ордера|&mdash;| да
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Приходного ордера|&mdash;|нет
