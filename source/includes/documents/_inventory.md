...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Инвентаризации|&mdash;|да|нет
|**id**                 |UUID|ID Инвентаризации|Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Инвентаризации|Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Инвентаризации|Только для чтения|нет|нет
|**name**               |String(255)|Наименование выданного Инвентаризации|&mdash;|да|нет
|**description**        |String(4096)|Комментарий Входящего платежа|&mdash;|нет|нет
|**code**               |String(255)|Код выданного Инвентаризации|&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код выданного Инвентаризации|&mdash;| да|нет
|**moment**             |DateTime|Дата Инвентаризации|&mdash;|да|нет
|**sum**                |Int|Сумма Инвентаризации в копейках|Только для чтения|да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Инвентаризации|&mdash;|нет|да
...
|**positions**          |MetaArray|Метаданные позиций Инвентаризации|&mdash;|да|да
...
|**correctionAmount**          |Float|разница между расчетным остатком и фактическимх|Только для чтения|да|нет
|**calculatedQuantity**         |Float|расчетный остаток|&mdash;|да|нет
|**correctionSum**          |Float|избыток/недостача|Только для чтения|да|нет
