...
|**code**               |String(255)|Код выданного Инвентаризации|&mdash;| нет
...
|**positions**          |MetaArray|Метаданные позиций Инвентаризации|&mdash;|да
...
|**calculatedQuantity**         |Float|расчетный остаток|&mdash;|да
