...
| **productionRows**        | MetaArray                                                 |                                                                                                                                                   | Метаданные позиций Производственного задания                                                                                                  |
...
Ограничения на удаление: нельзя удалить последний продукт из позиции Производственного задания и нельзя удалить продукт после начала выполнения финальной позиции Производственного задания.
