...
| **products**              | MetaArray                                                 |                                                                                                                                                   | Метаданные производимой продукции. [Подробнее тут](#/documents/productionTask#3-produkty-proizvodstvennogo-zadaniya)<br>`+Обязательное при ответе` |
