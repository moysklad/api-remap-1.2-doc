...
| **productionRows**        | MetaArray                                                 |                                                                                                                                                   | Метаданные Позиций производственного задани. [Подробнее тут](../documents/#dokumenty-proizwodstwennoe-zadanie-pozicii-proizwodstwennogo-zadaniq)                     |
...
+ **productionStart** - Дата старта производства- не должна быть позже даты первого(по времени) выполнения этапа, если есть хоть одно, иначе возникнет ошибка.
