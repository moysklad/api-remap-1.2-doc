...
| **inventory**                  | Ссылка на связанную со списанием инвентаризацию в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)     |
...
| **declaration**| Array(Object)                                             | Информация о прослеживаемости импортных товаров. [Подробнее тут](../documents/#dokumenty-spisanie-spisaniq-informaciq-o-proslezhiwaemosti-importnyh-towarow)<br>`+Выводится по запросу` `+Только для чтения`                                                             |
...
необходимо передать в URL запроса дополнительный параметр `fields=declaration`, например `../loss/{id}/positions?fields=declaration`. [Подробнее о параметре fields](../#mojsklad-json-api-obschie-swedeniq-chto-takoe-fields).
...
+ **assortment** - Ссылка на товар/услугу/серию/модификацию, которую представляет собой позиция. Подробнее об этом поле можно прочитать в описании [позиции Списания](../documents/#dokumenty-spisanie-spisaniq-pozicii-spisaniq)
