...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Выданного отчета комиссионера|Только для чтения|да|нет
|**id**                 |UUID|ID Выданного  отчета комиссионераы|Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Выданного  отчета комиссионера|Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Выданного  отчета комиссионера|Только для чтения|нет|нет
|**name**               |String(255)|Наименование Выданного отчета комиссионера|Необходимое при создании|да|нет
|**description**        |String(4096)|Комментарий Выданного отчета комиссионера|&mdash;|нет|нет
|**code**               |String(255)|Код Выданного отчета комиссионера|&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Выданного отчета комиссионера|&mdash;| да|нет
...
|**sum**                |Int|Сумма Выданного отчета комиссионера в копейках|Только для чтения|да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Выданного отчета комиссионера|&mdash;|нет|да
...
|**positions**        |MetaArray|Метаданные позиций Выданного отчета|Только для чтения|да|да
