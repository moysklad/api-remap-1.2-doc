...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Розничного возврата|&mdash;|да|нет
|**id**                 |UUID|ID Розничного возврата|Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Розничного возврата|Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Розничного возврата|Только для чтения|нет|нет
|**name**               |String(255)|Наименование Розничного возврата|&mdash;|да|нет
|**description**        |String(4096)|Комментарий Розничного возврата|&mdash;|нет|нет
|**code**               |String(255)|Код Розничного возврата|&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Розничного возврата|&mdash;| да|нет
...
|**sum**                |Int|Сумма Розничного возврата в копейках|Только для чтения|да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Розничного возврата|&mdash;|нет|да
...
|**positions**          |MetaArray|Метаданные позиций Розничного возврата|&mdash;|да|да
|**demand**          |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные позиций Розничного возврата, по которой произошел возврат|&mdash;|нет|да
|**retailStore**         |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Точки продаж|Необъодимое при создании|да|да
...
|**taxSystem**         |Enum|Код системы налогообложения. [Подробнее тут](../dictionaries/#dokumenty-roznichnyj-wozwrat-roznichnye-wozwraty-atributy-suschnosti-kod-sistemy-nalogooblozheniq)|&mdash;|нет|нет
