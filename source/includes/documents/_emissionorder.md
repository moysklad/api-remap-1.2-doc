...
+ **assortment** - Ссылка на товар/серию/модификацию, которую представляет собой позиция. Подробнее об этом поле можно прочитать в описании [позиции Заказа](../documents/#dokumenty-zakaz-kodow-markirowki-zakaz-kodow-markirowki-pozicii-zakaza-kodow-markirowki)
