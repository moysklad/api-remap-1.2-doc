...
> Пример создания новой Тех.операции с привязкой техкарты с телом запроса, содержащим только необходимые поля.
...
> Пример создания новой Тех.операции без привязки техкарты с телом запроса, содержащим только необходимые поля.
...
> Пример создания новой Тех.операции с привязкой техкарты с отличными от техкарты материалами и продуктами.
