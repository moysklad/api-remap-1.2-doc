...
| **costSum**    | Int                                                       | Цена указанного количества товаров<br>`+Обязательное при ответе` `+Только для чтения`                           |
...
| **id**         | UUID                                                      | ID Техоперации<br>`+Обязательное при ответе` `+Только для чтения`                                                                    |
| **quantity**   | Float                                                     | Количество товаров данного вида в позиции<br>`+Обязательное при ответе`                                                              |
| **costSum**    | Int                                                       | Цена указанного количества товаров, вычесленная на основании затрат и материалов <br/>`+Обязательное при ответе` `+Только для чтения`|
