...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Тех. операции |Только для чтения|да|нет
|**id**                 |UUID|ID Тех. операции |Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Тех. операции |Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Тех. операции |Только для чтения|нет|нет
|**name**               |String(255)|Наименование Тех. операции |Необходимое при создании|да|нет
|**description**        |String(4096)|Комментарий Тех. операции |&mdash;|нет|нет
|**code**               |String(255)|Код Тех. операции |&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Тех. операции |&mdash;| да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Тех. операции |&mdash;|нет|да
...
|**quantity**               |Int|Объем производства|Необходимое при создании|да|нет
|**processingSum**              |Int|Затраты на производство|Необходимое при создании|да|нет
| **materials**          |Array(Object)|Список Метаданных материалов Тех. операции|Необходимое при создании|да|да
| **products**          |Array(Object)|Список Метаданных готовых продуктов Тех. операции|Необходимое при создании|да|да
| **productsStore**         |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные склада для продукции|Необходимое при создании|да|да
| **materialsStore**         |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные склада для материалов|Необходимое при создании|да|да
| **processingPlan**           |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Тех. операции|Необходимое при создании|да|да
...
|**id**                 |UUID|ID Тех. операции |Только для чтения|да|нет
|**accountId**          |UUID| ID учетной записи|Только для чтения|да|нет
|**assortment**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные товара/серии/модификации, которую представляет собой позиция|&mdash;|да|да
|**quantity**          |Int|Количество товаров данного вида в позиции|&mdash;|да|нет
