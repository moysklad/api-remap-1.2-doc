...
| **costSum**    | Int                                                       | Цена указанного количества товаров<br>`+Обязательное при ответе`                                               |
...
| **id**         | UUID                                                      | ID Техоперации<br>`+Обязательное при ответе` `+Только для чтения`                                                 |
| **quantity**   | Float                                                     | Количество товаров данного вида в позиции<br>`+Обязательное при ответе`                                           |
| **costSum**    | Int                                                       | Цена указанного количества товаров, вычесленная на основании затрат и материалов <br/>`+Обязательное при ответе` |
...
помечены `Только для чтения` в описании [атрибутов Техоперации](../documents/#dokumenty-tehoperaciq).
...
+ **costSum** - Цена указанного количества товаров
...
+ **assortment** - Ссылка на товар/серию/модификацию в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)
+ **quantity** - Количество товаров данного вида в позиции
+ **costSum** - Цена указанного количества товаров, вычисленная на основании затрат и материалов
