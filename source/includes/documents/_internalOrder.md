...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Внутреннего заказа|Только для чтения|да|нет
|**id**                 |UUID|ID Внутреннего заказа|Только для чтения|да|нет
...
|**updated**            |DateTime|Момент последнего обновления Внутреннего заказа|Только для чтения|да|нет
|**deleted**            |DateTime|Момент последнего удаления Внутреннего заказа|Только для чтения|да|нет
|**name**               |String(255)|Наименование Внутреннего заказа|Необходимое при создании|да|нет
|**description**        |String(4096)|Комментарий Внутреннего заказа|&mdash;|нет|нет
|**code**               |String(255)|Код Внутреннего заказа|&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Внутреннего заказа|&mdash;| да|нет
...
|**sum**                |Int|Сумма Внутреннего заказа в копейках|Только для чтения|да|нет
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Внутреннего заказа|&mdash;|нет|да
...
|**positions**        |MetaArray|Метаданные позиций Внутреннего заказа|Только для чтения|да|да
|**deliveryPlannedMoment**            |DateTime|Планируемая дата приемки|&mdash;|нет|нет
|**purchaseOrders**         |Array(Object)| Коллекция метаданных на связанные заказы поставщику|&mdash;|да|нет
|**moves**          |Array(Object)|Коллекция метаданных на связанные заказы перемещения|&mdash;|да|нет
