...
| **labourUnitCost**      | Double                                                    |            | Оплата труда за единицу продукции<br>`+Обязательное при ответе`                                                    |
| **materials**           | MetaArray                                                 |            | Метаданные материалов Производственного этапа<br>`+Expand`                                                         |
...
| **processingUnitCost**  | Double                                                    |            | Затраты на производство единицы продукции<br>`+Обязательное при ответе`                                            |
...
| **products**            | MetaArray                                                 |            | Метаданные продуктов Производственного этапа<br>`+Expand`                                                          |
