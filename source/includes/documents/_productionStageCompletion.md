...
| **materials**           | MetaArray                                                 |            | Метаданные Материалов выполнения этапа производства [Продробнее тут](#dokumenty-vypolnenie-atapa-proizwodstwa-materialy-wypolneniq-atapa-proizwodstwa)<br>`+Expand`                               |
...
| **products**            | MetaArray                                                 |            | Метаданные Продуктов выполнения этапа производства. Есть только у последнего этапа [Продробнее тут](#dokumenty-vypolnenie-atapa-proizwodstwa-produkty-wypolneniq-atapa-proizwodstwa)<br>`+Expand` |
