...
| **performer**          | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)  |                            | Исполнитель  (Сотрудник или Контрагент)<br>`+Expand`                                                                                                                                              |
...
Для создания Выполнения этапа с контрагентом в качестве исполнителя обязательно должна быть передана услуга.
