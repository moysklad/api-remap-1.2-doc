...
| **materials**           | MetaArray                                                 |            | Метаданные Материалов выполнения этапа производства[Материал выполнения этапа производства](#dokumenty-vypolnenie-atapa-proizwodstwa-materialy-wypolneniq-atapa-proizwodstwa)<br>`+Expand`                                |
...
| **products**            | MetaArray                                                 |            | Метаданные Продуктов выполнения этапа производства. Есть только у последнего этапа [Продукт выполнения этапа производства](#dokumenty-vypolnenie-atapa-proizwodstwa-produkty-wypolneniq-atapa-proizwodstwa)<br>`+Expand`  |
