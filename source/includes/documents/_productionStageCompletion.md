...
### Выполнение производственного этапа
Средствами JSON API можно создавать, обновлять и удалять сведения о Выполнениях производственных этапов,
запрашивать списки Выполнений производственных этапов и сведения по отдельным Выполнениям производственных этапов.
#### Атрибуты сущности
...
| **materials**           | MetaArray                                                 |            | Метаданные материалов Выполнения этапа<br>`+Expand`                                                                |
| **meta**                | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) |            | Метаданные Выполнения этапа<br>`+Обязательное при ответе` `+Только для чтения`                                     |
...
Поле **products** есть только у последнего этапа.
  ...
  "rows": [
    {
      ...
      "performer": {
        "meta": {
          ...
          "type": "employee",
          "mediaType": "application/json",
          "uuidHref": "https://api.moysklad.ru/app/#employee/edit?id=50f4a244-9a95-11ee-0a83-05c8000005af"
        }
      },
      "productionStage": {
        "meta": {
...
### Массовое создание и обновление Выполнения производственных этапов
...
В теле запроса необходимо указать те поля, которые необходимо изменить у Выполнения производственного этапа, кроме тех,
что помечены `Только для чтения` в описании атрибутов Выполнения производственного этапа.
...
#### Материалы Выполнения этапа
Материалы Выполнения этапа - это товары, модификации и серии, затраченные при выполнении этапа производства.

Объект материала Выполнения этапа содержит следующие поля:
...
#### Продукты Выполнения этапа
Продукты Выполнения этапа - это товары, модификации и серии, созданные при выполнении этапа производства.

Объект продукта Выполнения этапа содержит следующие поля:
...
### Материалы Выполнения этапа
Отдельный ресурс для управления материалами Выполнения этапа.
...
| **meta**    | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные о выдаче                                                   |
| **context** | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные о сотруднике, выполнившем запрос                           |
| **rows**    | Array(Object)                                             | Массив JSON объектов, представляющих собой материалы Выполнения этапа |
  ...
  "rows": [
    {
      ...
      "assortment": {
        "meta": {
          ...
          "type": "product",
          "mediaType": "application/json",
          "uuidHref": "https://api.moysklad.ru/app/#good/edit?id=96568199-b716-11ec-0a80-0bba0006dcdc"
        }
      }
    }
  ]
...
### Добавить материал Выполнения этапа
...
| Параметр | Описание                                                                                |
| :------- | :-------------------------------------------------------------------------------------- |
| **id**   | `string` (required) *Example: 7944ef04-f831-11e5-7a69-971500188b19* id Выполнения этапа |

> Пример запроса на добавление материала Выполнения этапа.
...
> Пример запроса на добавление материала Выполнения этапа с учётом серийных номеров.
...
### Изменить материал Выполнения этапа
Запрос на обновление отдельного материала Выполнения этапа.
Для товаров с серийным учётом, поле `consumedQuantity` автоматически изменяется на количество переданных в поле `things` серийных номеров.
...
| :------------- | :------------------------------------------------------------------------------------------------------------------ |
| **id**         | `string` (required) *Example: 7944ef04-f831-11e5-7a69-971500188b19* id Выполнения производственного этапа           |
| **materialID** | `string` (required) *Example: 34f6344f-015e-11e6-9464-e4de0000006c* id материала Выполнение производственного этапа |

> Пример запроса на обновление количества отдельного материала Выполнения этапа.
...
> Пример запроса на обновление серийных номеров отдельного материала Выполнения этапа.
...
### Продукты Выполнения этапа
Отдельный ресурс для управления продуктами Выполнения этапа.

### Получить продукты Выполнения этапа
...
| **meta**    | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные о выдаче                                                  |
| **context** | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные о сотруднике, выполнившем запрос                          |
| **rows**    | Array(Object)                                             | Массив JSON объектов, представляющих собой продукты Выполнения этапа |
...
### Изменить продукт Выполнения этапа
Запрос на обновление отдельного продукта Выполнения этапа.
...
> Пример запроса на обновление количества отдельного продукта Выполнения этапа.
...
> Пример запроса на обновление серийных номеров отдельного продукта Выполнения этапа.
