...
| ----------------------- | :-------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------- | :----------------------- | :------------------------ | :------------------------ |
| **meta**                | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Исходящего платежа                                                                                           | &mdash;                  | да                        | нет                       |
| **id**                  | UUID                                                      | ID Исходящегоо платежа                                                                                                  | Только для чтения        | да                        | нет                       |
...
| **updated**             | DateTime                                                  | Момент последнего обновления Исходящего платежа                                                                         | Только для чтения        | да                        | нет                       |
| **deleted**             | DateTime                                                  | Момент последнего удаления Исходящего платежа                                                                           | Только для чтения        | нет                       | нет                       |
| **name**                | String(255)                                               | Наименование Исходящего платежа                                                                                         | &mdash;                  | да                        | нет                       |
| **description**         | String(4096)                                              | Комментарий Исходящего платежа                                                                                          | &mdash;                  | нет                       | нет                       |
| **code**                | String(255)                                               | Код Исходящего платежа                                                                                                  | &mdash;                  | нет                       | нет                       |
| **externalCode**        | String(255)                                               | Внешний код Исходящего платежа                                                                                          | &mdash;                  | да                        | нет                       |
...
| **state**               | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные статуса Исходящего платежа                                                                                   | &mdash;                  | нет                       | да                        |
