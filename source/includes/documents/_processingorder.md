...
| ------------------------- | :-------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------- | :----------------------- | :------------------------ | :------------------------ |
| **meta**                  | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Заказа на производство                                                                                       | Только для чтения        | да                        | нет                       |
| **id**                    | UUID                                                      | ID Заказа на производство                                                                                               | Только для чтения        | да                        | нет                       |
...
| **updated**               | DateTime                                                  | Момент последнего обновленияЗаказа на производство                                                                      | Только для чтения        | да                        | нет                       |
| **deleted**               | DateTime                                                  | Момент последнего удаления Заказа на производство                                                                       | Только для чтения        | нет                       | нет                       |
| **name**                  | String(255)                                               | Наименование Заказа на производство                                                                                     | Необходимое при создании | да                        | нет                       |
| **description**           | String(4096)                                              | Комментарий Заказа на производство                                                                                      | &mdash;                  | нет                       | нет                       |
| **code**                  | String(255)                                               | Код Заказа на производство                                                                                              | &mdash;                  | нет                       | нет                       |
| **externalCode**          | String(255)                                               | Внешний код Заказа на производство                                                                                      | &mdash;                  | да                        | нет                       |
...
| **state**                 | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные статуса Заказа на производство                                                                               | &mdash;                  | нет                       | да                        |
...
| **processingPlan**        | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Тех. плана                                                                                                   | Необходимое при создании | да                        | да                        |
| **positions**             | MetaArray                                                 | Метаданные позиций Заказа на производство                                                                               | Необходимое при создании | да                        | да                        |
| **deliveryPlannedMoment** | DateTime                                                  | Планируемая дата производства                                                                                           | &mdash;                  | нет                       | нет                       |
| **quantity**              | Int                                                       | Объем производства                                                                                                      | &mdash;                  | да                        | нет                       |
...
| **reserve**    | Int                                                       | Резерв данной позиции                                                                                                                                                                                                      | &mdash;                 | да                        | нет                       |
