...
| **invoicedSum**           | Float                                                     | Сумма счетов поставщику<br>`+Обязательное при ответе` `+Только для чтения`                                                                    |
| **meta**                  | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Заказа поставщику<br>`+Обязательное при ответе`                                                                                    |
| **moment**                | DateTime                                                  | Дата Заказа<br>`+Обязательное при ответе`                                                                                                     |
...
| **payedSum**              | Float                                                     | Сумма входящих платежей по Заказу<br>`+Обязательное при ответе` `+Только для чтения`                                                          |
...
| **sum**                   | Int                                                       | Сумма Заказа поставщику в установленной валюте<br>`+Обязательное при ответе` `+Только для чтения`                                             |
...
| **waitSum**               | Float                                                     | Сумма товаров в пути<br>`+Обязательное при ответе`                                                                                            |
...
В шаблоне будет отсутствует поле `agent`, которое необходимо заполнить самому, 
