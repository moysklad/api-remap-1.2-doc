...
При указании в качестве документа-основы заказа покупателя, содержащего комплекты в позициях, 
комплекты будут автоматически разбиты на составляющие компоненты в отдельные позиции.

Если у переданного документа-основания уже есть связанный заказ поставщику, то позиции, указанные в нем,
