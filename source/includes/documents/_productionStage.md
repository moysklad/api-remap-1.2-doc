...
При получении производственных этапов нужно обязательно передавать фильтр на конкретное производственное задание через `href` и оператор равенства.
...
помечены `Только для чтения` в описании [атрибутов Производственного этапа](#dokumenty-proizwodstwennoe-zadanie-proizwodstwennyj-atap).
...
В случае, если для Производственного задания включен резерв материалов, удалить последний материал не получится.

Нельзя удалить материал из выполненного этапа.
