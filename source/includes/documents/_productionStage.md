...
В случае, если для Производственного задания включен резерв материалов, удалить последний материал нельзя.

Нельзя удалить материал после начала выполнения этапа.
