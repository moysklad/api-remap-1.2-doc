...
При получении производственных этапов обязательным фильтром является ограничение на производственное задание.
...
помечены `Только для чтения` в описании [атрибутов Производственного этапа](#suschnosti-jetap-proizwodstwa).
