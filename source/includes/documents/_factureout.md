...
| **meta**            | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) |                                                                                                                                                   | Метаданные Счета-фактуры выданного<br>`+Обязательное при ответе`                                                                              |
...
| **state**           | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | `=` `!=`                                                                                                                                          | Метаданные статуса Счета-фактуры выданного<br>`+Expand`                                                                                       |
