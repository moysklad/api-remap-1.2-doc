...
| **meta**            | [Meta](#/general#3-metadannye) |                                                                                                                                                   | Метаданные выданного Счета-фактуры<br>`+Обязательное при ответе`                                                                              |
...
| **state**           | [Meta](#/general#3-metadannye) | `=` `!=`                                                                                                                                          | Метаданные статуса выданного Счета-фактуры<br>`+Expand`                                                                                       |
