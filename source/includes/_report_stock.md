# Отчеты
## Отчет Остатки
Средствами JSON API можно запросить отчет "Остатки" по всем товарам, по складам и по операциям.
...
Для доступа к отчету Остатки по документу через API каких-либо дополнительных прав не требуется,
...
- `filter=store.id=656c4032-8667-11e6-8a84-bae500003321;store.id=656c4032-8667-11e6-8a84-bae500003322`
...
|moment|  `string` (optional) Момент времени, на который нужно вывести остатки. Передается в виде строки в формате `ГГГГ-ММ-ДД ЧЧ-ММ-СС`|
