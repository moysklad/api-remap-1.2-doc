...
### Приемки 
#### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) об Приемке
...
+ **state** - Статус Приемки в формате [Метаданных](#metadannye)
...
+ **positions** - Ссылка на позиции в Приемке в формате [Метаданных](#metadannye)
...
+ **purchaseOrder** - Ссылка на связанный заказ поставщику в формате [Метаданных](#metadannye)
+ **factureIn** - Ссылка на Счет-фактура полученный, с которым связана эта Приемка в формате [Метаданных](#metadannye)
...
С позициями можно работать с помощью [специальных ресурсов для управления позициями Приемки](#priemka-pozicii-priemki),
...
О работе с доп. полями Приемок можно прочитать [здесь](#rabota-s-dopolnitel-nymi-polyami)
...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) Приемок.
...
+ **attributes** - Массив объектов доп. полей Приемок в формате [Метаданных](#metadannye)
...
помечены `Только для чтения` в описании [атрибутов Приемки](#priemka-priemki).
...
чем является указанная позиция. Подробнее об этом поле можно прочитать в описании [позиции Приемки](#pozicii-priemki)
