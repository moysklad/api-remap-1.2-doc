...
| **documentState** | Enum                                                      | Способ ввода в оборот. [Подробнее тут](../dictionaries/#suschnosti-zakaz-kodow-markirowki-sposob-wwoda-w-oborot)                         |
| **emissionType**  | Enum                                                      | Состояние документов маркировки. [Подробнее тут](../dictionaries/#suschnosti-zakaz-kodow-markirowki-sostoqnie-dokumentow-markirowki)     |
...
| **price**      | Float                                                     | Цена товара/модификации/серии в копейках<br>`+Обязательное при ответе`                                          |
