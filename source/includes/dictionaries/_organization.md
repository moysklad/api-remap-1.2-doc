...
| **advancePaymentVat** | Number        |                                                                                                                                                   | Налоговая ставка для авансов для плательщиков НДС. Можно использовать значение только из существующих [ставок НДС](../dictionaries/#suschnosti-stawka-nds-poluchit-stawki-nds) |
