...
| **advancePaymentVat** | Number        |                                                                                                                                                   | Налоговая ставка для авансов для плательщиков НДС. Может иметь зачения из [справочника НДС](../dictionaries/#suschnosti-stawka-nds-poluchit-stawki-nds) |
