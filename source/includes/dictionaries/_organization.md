...
| **sex**               | String(255)   |                                                                                                                                                   | Пол контрагента. [Подробнее тут](../dictionaries/#suschnosti-jurlico-jurlica-attributy-suschnosti-adres-podpisi-i-pechat)             |
| **birthDay**          | DateTime      |                                                                                                                                                   | Дата рождения контрагента типа `[Физическое лицо]`. Игнорируется для Юрлиц типа `[Индивидуальный предприниматель, Юридическое лицо]`  |


#### Пол Контрагента
Пол контрагента используется только для контрагента типа `[Физическое лицо]`. Игнорируется для Юрлиц типа `[Индивидуальный предприниматель, Юридическое лицо]`
