...
| **barcodes**            | Array(Object)                                             | Штрихкоды Комплекта. [Подробнее тут](../diction#fghfghfghfghfghfghuschnosti-komplekt-komplekty-komponenty-komplekta-shtrih-kody)                                                                                                             |
...
| **files**               | MetaArray                                                 | Метаданные массива [Файлов](../diction#arfghfghfghfghfchnosti-fajly) (Максимальное количество файлов - 100)<br>`+Expand`                                                                                                                |
