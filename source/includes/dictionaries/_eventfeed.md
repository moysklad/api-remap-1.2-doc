...
| **Редактирование&nbsp;событий** | Необходима тарифная опция CRM. Пользователь с правами администратора или он является автором события.    |
| **Удаление&nbsp;событий**       | Необходима тарифная опция CRM. Пользователь с правами администратора или он является автором события.    |
