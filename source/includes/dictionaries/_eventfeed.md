...
Средствами JSON API можно создавать события, запрашивать списки событий, а также сведения по отдельным событиям для
документов следующего типа: [Заказ покупателя](../documents/#dokumenty-zakaz-pokupatelq)
