...
| **zones**        | MetaArray                                                 |                                                                                                                                                   | Зоны склада.[Подробнее тут](../dictionaries/#suschnosti-sklad-sklady-attributy-suschnosti-adres)<br>`+Только для чтения` `+Expand`                                       |
| **slots**        | MetaArray                                                 |                                                                                                                                                   | Ячейки склада.[Подробнее тут](../dictionaries/#suschnosti-sklad-sklady-attributy-suschnosti-adres)<br>`+Только для чтения` `+Expand`                                       |
...
| **zone**         | Meta                                                      |                                                                                                                                                   | Зона ячейки.[Подробнее тут](../dictionaries/#suschnosti-sklad-sklady-attributy-suschnosti-adres)<br>`+Только для чтения` `+Expand`                                       |
