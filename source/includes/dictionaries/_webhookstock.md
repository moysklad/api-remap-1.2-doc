## Вебхуки на изменение остатков
Вебхук позволяет получать уведомления об изменениях остатков товаров. Уведомление отправляется пользователю каждые 1-5 минут, если произошло изменение остатков. Чтобы получать уведомления, создайте вебхук на изменения остатков и включите его. Ключевое слово для вебхуков на изменение остатков в рамках JSON API — **webhookstock**. 
...
### Массовое удаление Вебхука на изменение остатков

В теле запроса нужно передать массив, содержащий JSON метаданных Вебхука на изменение остатков, которые вы хотите удалить.


> Запрос на массовое удаление Вебхук на изменение остатков. 
