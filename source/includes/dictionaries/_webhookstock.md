...
На бесплатных аккаунтах доступны только операции получения и удаления веб хуков на изменение остатков. **Во время нахождения аккаунта на бесплатном тарифе отправка веб хуков на изменение остатков не производится.** 
Управление веб-хуками на изменение остатков доступно **только администратору аккаунта**. Ключевым словом для веб-хуков на изменение остатков в рамках JSON API является **webhooktock**.
  ...
  "events": [
    {
      ...
      "stockType": "stock",
      "reportType": "all",
      "reportUrl": "localhost/api/remap/1.2/report/stock/all/current?fromDate=2022-09-24 19:14:32"
    }
  ]
}
```

#### Атрибуты сущности отправляемого веб-хука на изменение остатков

| Название         | Тип    | Описание                                                                                    |
| ---------------- | :----- | :------------------------------------------------------------------------------------------ |
| **events**       | Object | Данные о событии, вызвавшем срабатывание веб-хук на изменение остатков а<br>`+Обязательное при ответе` |
| **auditContext** | Object | Контекст аудита, соответствующий событию веб-хука на изменение остатков                                |
...
| **stockType**          | String(255)                                               | Тип остатков, изменение которых вызвает веб-хук на изменение остатков. Возможные значения: `[stock]`<br>`+Обязательное при ответе` `+Необходимо при создании`                                                                                                                                                                 |
| **reportType**         | String(255)                                               | Тип отчета остатков, к которым привязан веб-хук на изменение остатков. Возможные значения: `[all, bystore]`<br>`+Обязательное при ответе` `+Необходимо при создании`                                                                                                                                                          |
