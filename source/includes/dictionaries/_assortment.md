...
## Ассортимент
#### Ассортимент
Сущность assortment представляет собой список всех товаров, услуг, комплектов, и модификаций с полями `stock`,
...
| **type**              | параметр для фильтрации по типу сущности (product, service, bundle, variant). Используется с оператором `=`. Можно передать несколько значений.                                                                                                                                                                                                    |
