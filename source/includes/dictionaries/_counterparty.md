...
| **actualAddressFull**  | Object                                                    |                             | Фактический адрес Контрагента с детализацией по отдельным полям. [Подробнее тут](../dictionaries/#suschnosti-kontragent-kontragenty-atributy-wlozhennyh-suschnostej-atributy-suschnosti-adres)                                  |
...
| Название                    | Тип           | Регион | Фильтрация             | Описание                                                                                                                                                                                                                                                       |
|-----------------------------| :------------ | :----- | :--------------------- |:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| **certificateDate**         | DateTime      |  RU, * |                        | Дата свидетельства                                                                                                                                                                                                                                             |
| **certificateNumber**       | String(255)   |  RU, * |                        | Номер свидетельства                                                                                                                                                                                                                                            |
| **inn**                     | String(255)   |  RU, * | `=` `!=` `~` `~=` `=~` | ИНН                                                                                                                                                                                                                                                            |
| **kpp**                     | String(255)   |  RU, * | `=` `!=` `~` `~=` `=~` | КПП                                                                                                                                                                                                                                                            |
...
| **mod\_\_requisites\_\_uz** | Object        |   UZ   |                        | Реквизиты Узбекистан. [Подробнее тут](#suschnosti-kontragent-kontragenty-atributy-wlozhennyh-suschnostej-rekwizity-uzbekistan)                                                                                                                                 |
| **ogrn**                    | String(255)   |  RU, * |                        | ОГРН                                                                                                                                                                                                                                                           |
| **ogrnip**                  | String(255)   |  RU, * |                        | ОГРНИП                                                                                                                                                                                                                                                         |
| **okpo**                    | String(255)   |  RU, * |                        | ОКПО                                                                                                                                                                                                                                                           |
| **sex**                     | String(255)   |        |                        | Пол Контрагента. [Подробнее тут](../dictionaries/#suschnosti-kontragent-kontragenty-pol-kontragenta)                                                                                                                                                           |

В колонка **регион** типа юридического лица указывает регион для которого применим данный реквизит.
'*' означает что реквизит используется в регионах типа для которых в таблице не указаны иные специфичные для региона типа реквизиты.
...
##### Реквизиты Узбекистан

| Название              | Тип           | Регион | Фильтрация             | Описание            |
|---------------------- | :------------ | :----- | :--------------------- |:------------------- |
| **certificateDate**   | DateTime      |   UZ   | `=` `!=` `~` `~=` `=~` | Дата свидетельства  |
| **certificateNumber** | String(255)   |   UZ   | `=` `!=` `~` `~=` `=~` | Номер свидетельства |
| **inn**               | String(255)   |   UZ   | `=` `!=` `~` `~=` `=~` | ИНН                 |
| **oked**              | String(255)   |   UZ   | `=` `!=` `~` `~=` `=~` | ОКЕД                |
| **pinfl**             | String(255)   |   UZ   | `=` `!=` `~` `~=` `=~` | ПИНФЛ               |
...
'*' обозначены типы юридических лиц, используемые в регионах, для которых не доступны отдельные специфичные для региона типы юридических лиц.
В этих регионах используются юридические лица региона 'RU' и специфичные для него реквизиты.
Так как до ввода новых специфичных для региона юридических лиц, существовал только один набор реквизитов, в регионах для
которых появились свои типы юрлиц, так же будут доступны типы и реквизиты региона 'RU'.
Однако, следует избегать создание и использование новых контрагентов данного типа, так как, в будущем, работа с типами контрагентов
не своего региона может быть изменена.
