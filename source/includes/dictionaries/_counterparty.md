...
| **mod\_\_requisites\_\_uz** | Object        |                        | Реквизиты Узбекистана. [Подробнее тут](#suschnosti-kontragent-kontragenty-attributy-suschnosti-adres-rekwizity-uzbekistana)                                                                                                                                 |
...
Поля помеченные символом `*` не валидны для типов юридических лиц Узбекистана.
...
Для регионов, для которых появились свои наборы реквизитов рекомендуется переключиться на новые реквизиты.
Возможность использовать 'RU' реквизиты в этих регионах может быть в будущем отключена.
