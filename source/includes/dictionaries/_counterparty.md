...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Контрагента|&mdash;|да|нет
...
|**description**        |String(4096)|Комментарий к Контрагенту |&mdash;|нет|нет
|**code**               |String(255)|Код Контрагента |&mdash;| нет|нет
|**externalCode**       |String(255)|Внешний код Контрагента |&mdash;| да|нет
|**archived**           |Boolean|Добавлен ли Контрагент в архив|&mdash;| да|нет
|**created**            |DateTime|Момент создания|&mdash;| да|нет
...
|**actualAddress**      |String(255)|Фактический адрес Контрагента |&mdash;| нет|нет
|**actualAddressFull**  |Object|Фактический адрес Контрагента с детализацией по отдельным полям. [Подробнее тут](../dictionaries/#suschnosti-kontragent-kontragenty-attributy-suschnosti-adres) |&mdash;|нет|нет
|**accounts**           |MetaArray|Массив счетов Контрагентов. [Подробнее тут](../dictionaries/#suschnosti-kontragent-kontragenty-attributy-suschnosti-adres-scheta-kontragentow)|&mdash;| да|да
|**companyType**        |Enum|Тип Контрагента. В зависимости от значения данного поля набор выводимых реквизитов контрагента может меняться. [Подробнее тут](../dictionaries/#suschnosti-kontragent-kontragenty-tip-kontragenta) |&mdash;| да | нет
|**discountCardNumber** |String(255)|Номер дисконтной карты Контрагента |&mdash;| нет |нет
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Статуса Контрагента|&mdash;| нет|да
...
| Название  | Тип | Описание                    | Свойство поля в запросе | Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:---------------|:-----------------------|:-----------------------|
|**legalTitle**       |String(4096)|Полное наименование для Контрагента типа `[Юридическое лицо]`. Игнорируется для Контрагентов типа `[Индивидуальный предприниматель, Физическое лицо]`, если передано одно из значений для ФИО и формируется автоматически на основе получаемых ФИО Контрагента|&mdash;|нет|нет
|**legalLastName**     |String(255)|Фамилия для Контрагента типа `[Индивидуальный предприниматель, Физическое лицо]`. Игнорируется для Контрагентов типа `[Юридическое лицо]`|&mdash;|нет|нет
|**legalFirstName**     |String(255)|Имя для Контрагента типа `[Индивидуальный предприниматель, Физическое лицо]`. Игнорируется для Контрагентов типа `[Юридическое лицо]`|&mdash;|нет|нет
|**legalMiddleName**     |String(255)|Отчество для Контрагента типа `[Индивидуальный предприниматель, Физическое лицо]`. Игнорируется для Контрагентов типа `[Юридическое лицо]`|&mdash;|нет|нет
|**legalAddress**     |String(255)|Юридический адрес Контрагента|&mdash;|нет|нет
|**legalAddressFull** |Object|Юридический адрес Контрагента с детализацией по отдельным полям|&mdash;|нет|нет
...
|**tags**             |Array(String)|Группы контрагента|&mdash;|нет|нет
|**contactpersons**   |MetaArray|Массив контактных лиц фирмы Контрагента. [Подробнее тут](../dictionaries/#suschnosti-kontragent-kontragenty-attributy-suschnosti-adres-kontaktnye-lica-kontragentow)|&mdash;|нет|да
|**attributes**       |Array(Object)|Массив метаданных доп. полей|&mdash;|нет|нет
|**discounts**        |Array(Object)|Массив метаданных скидок. Массив может содержать персональные и накопительные скидки. Персональная скидка выводится, если хотя бы раз изменялся **процент скидки** для контрагента, значение будет указано в поле **personalDiscount**|&mdash;|нет|нет
|**notes**            |MetaArray|Массив событий Контрагента. [Подробнее тут](../dictionaries/#suschnosti-kontragent-kontragenty-attributy-suschnosti-adres-sobytiq-kontragenta)|&mdash;|нет|да
|**priceType**        |Object|Тип цены Контрагента. [Подробнее тут](../dictionaries/#suschnosti-tipy-cen-tipy-cen)|&mdash;|нет|нет
...
| Название  | Тип | Описание                    | Свойство поля в запросе | Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:---------------|:-----------------------|:-----------------------|
|**meta**           |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Счета Контрагента|&mdash;|да|нет
|**id**      |UUID|ID Счета|Только для чтения|да|нет
|**accountId**      |UUID|ID учетной записи|Только для чтения|да|нет
|**updated**        |DateTime|Момент последнего обновления Контрагента|Только для чтения|да|нет
|**isDefault**      |Boolean|Является ли счет основным счетом Контрагента|&mdash;|да|нет
...
| Название  | Тип | Описание                    | Свойство поля в запросе | Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:---------------|:-----------------------|:-----------------------|
|**meta**           |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Контактного лица Контрагента|&mdash;|да|нет
...
|**description**   |String(4096)|Описание контактного лица|&mdash;|нет|нет
|**externalCode**  |String(255)|Внешний код контактного лица|&mdash;|нет|нет
|**email**         |String(255)|Адрес электронной почты контактного лица|&mdash;|нет|нет
|**phone**         |String(255)|Номер телефона контактного лица|&mdash;|нет|нет
|**position**      |String(255)|Должность контактного лица|&mdash;|нет|нет
|**agent**         |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные контрагента|&mdash;|да|да

##### События Контрагента
| Название             | Тип | Описание                    | Свойство поля в запросе | Обязательное при ответе|Expand|
| -------------------- |:----|:----------------------------|:---------------|:-----------------------|:-----------------------|
|**meta**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные событий контрагента|&mdash;|да|нет
...
|**agent**             |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Контрагента|Только для чтения|да|да
|**author**            |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Сотрудника - создателя события (администратор аккаунта, если автор - приложение)|Только для чтения|да|нет
|**authorApplication** |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Приложения - создателя события|Только для чтения|нет|нет
...
| Название  | Тип | Описание                    | Свойство поля в запросе| Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Настроек справочника контрагентов|&mdash;|да|нет
|**uniqueCodeRules**    |Object|Настройки кодов контрагентов|&mdash;|да|нет
|**createShared**       |Boolean|Создавать новые документы с меткой «Общий»|&mdash;|да|нет

#### Настройки кодов контрагентов

| Название  | Тип | Описание                    | Свойство поля в запросе| Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**checkUniqueCode**    |Boolean|Проверка уникальности кода справочника|&mdash;|да|нет
|**fillUniqueCode**     |Boolean|Устанавливать уникальный код|&mdash;|да|нет
