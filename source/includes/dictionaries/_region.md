...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**             |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные о Регионе|&mdash;|да|нет
|**id**               |UUID|ID Региона|Только для чтения|да|нет
|**accountId**        |UUID|ID учетной записи|Только для чтения|да|нет
|**version**          |Int|Версия сущности|Только для чтения|да|нет
|**updated**          |DateTime|Момент последнего обновления сущности|Только для чтения|да|нет
|**name**             |String(255)|Наименование Региона|Необходимое при создании|да|нет
|**code**             |String(255)|Код Региона|&mdash;|нет|нет
|**externalCode**     |String(255)|Внешний код Региона|&mdash;|да|нет
