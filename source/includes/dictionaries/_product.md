...
| **volume**              | Int                                                       | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Объем                                                                                                                                                                                                                                                     |
| **weight**              | Int                                                       | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Вес                                                                                                                                                                                                                                                       |
| **mod__marking__uz**    | Object                                                    |                                                                                                                                                   | Модуль с маркировкой товара<br>`+UZ`                                                                                                                                                                                                                      |
| **mod__tasnif__uz**     | Object                                                    |                                                                                                                                                   | Модуль с информацией из справочника ТАСНИФ<br>`+UZ`                                                                                                                                                                                                       |
...
| **uomCode**        | String    | Код упаковки из справочника ТАСНИФ `+Только для чтения` |
