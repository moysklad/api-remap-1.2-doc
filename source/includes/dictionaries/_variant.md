...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Модификации|&mdash;|да|нет
|**id**                |UUID|ID Модификации|Только для чтения|да|нет
...
|**name**              |String(255)|Наименование товара с Модификацией|&mdash;|да|нет
|**code**              |String(255)|Код Модификации|&mdash;|нет|нет
|**externalCode**      |String(255)|Внешний код Модификации|&mdash;|да|нет
|**archived**          |Boolean|Добавлен ли товар в архив|&mdash;|да|нет
|**characteristics**   |Array(Object)|Характеристики Модификации. [Подробнее тут](../dictionaries/#suschnosti-modifikaciq-modifikacii-atributy-wlozhennyh-suschnostej-metadannye-modifikacij-harakteristiki-modifikacii)|Необходимое при создании|да|нет
|**images**            |MetaArray|Массив метаданных [Изображений](../dictionaries/#suschnosti-izobrazhenie) (Максимальное количество изображений - 10)|&mdash;|да|да
|**minPrice**          |Object|Минимальная цена. [Подробнее тут](../dictionaries/#suschnosti-modifikaciq-modifikacii-atributy-wlozhennyh-suschnostej-minimal-naq-cena)|&mdash;|нет|нет
|**buyPrice**          |Object|Закупочная цена|&mdash;|нет|нет
|**salePrices**        |Array(Object)|Цены продажи. [Подробнее тут](../dictionaries/#suschnosti-modifikaciq-modifikacii-atributy-wlozhennyh-suschnostej-ceny-prodazhi)|&mdash;|нет|нет
|**barcodes**          |Array(Object)|Массив штрихкодов модификации. [Подробнее тут](../dictionaries/#suschnosti-modifikaciq-modifikacii-atributy-wlozhennyh-suschnostej-shtrih-kody)|&mdash;|нет|нет
|**product**           |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные [товара](../dictionaries/#suschnosti-towar), к которому привязана Модификация|Необходимое при создании|да|да
|**things**            |Array(String)|Серийные номера|Только для чтения|нет|нет
|**discountProhibited**|Boolean|Признак запрета скидок|&mdash;|да|нет
|**packs**             |Array(Object)|Упаковки модификации [Подробнее тут](../dictionaries/#suschnosti-modifikaciq-modifikacii-atributy-wlozhennyh-suschnostej-upakowki-modifikacii)|&mdash;|нет|нет
...
| Название  | Тип | Описание                    | Свойство поля в запросе | Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные характеристики|&mdash;|да|нет
|**id**                |UUID|ID соответствующей характеристики|&mdash;|да|нет
|**name**                |String(255)|Наименование характеристики|&mdash;|да|нет
|**value**                |String(255)|Значение характеристики|Необходимое при создании|да|нет
...
| Название  | Тип | Описание                    | Свойство поля в запросе | Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные |&mdash;|да|нет
|**characteristics**         |Array(Object)|Коллекция всех созданных характеристик Модификаций|&mdash;|да|нет
...
|**id**                |UUID|ID соответствующей характеристики|&mdash;|да|нет
|**name**                |String(255)|Наименование характеристики|&mdash;|да|нет
|**type**                |String(255)|Тип значения характеристики|&mdash;|да|нет
|**required**        |Boolean|Флаг о том, является ли характеристика обязательной|&mdash;|да|нет
...
| Название      | Тип | Описание                    | Свойство поля в запросе | Обязательное при ответе|Expand|
| ---------     |:----|:----------------------------|:---------------|:-----------------------|:-----------------------|
|**id**         |UUID|ID упаковки модификации|Только для чтения|да|нет
|**parentpack** |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные родительской упаковки (упаковки товара), для которой переопределяется штрихкод|&mdash;|да|да
|**barcodes**   |Array(Object)|Массив штрихкодов упаковки модификации. Данный массив может содержать только один штрихкод|&mdash;|да|нет
...
| Название  | Тип | Описание                    | Свойство поля в запросе | Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**id**     |UUID| ID характеристики|&mdash;|нет|нет
| **name**  |String(255)|Наименование характеристики|&mdash;|нет|нет
| **value** |String(255)|Значение характеристики|Необходимое при создании|да|нет
...
| --------- |:----|:----------------------------|:------------------------|:------------------------|
|**meta**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные|да|нет
|**characteristics**         |Array(Object)|Коллекция всех созданных характеристик Модификаций|да|нет
