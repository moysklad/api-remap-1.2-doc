...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Стандартного шаблона|&mdash;|да|нет
|**id**                 |UUID|ID шаблона|&mdash;|да|нет
|**name**               |String(255)|Наименование шаблона|&mdash;|да|нет
|**type**               |String(255)|Тип шаблона (entity - документ)|&mdash;|да|нет
|**content**            |URL|Ссылка на скачивание|&mdash;|да|нет
...
|**id**                 |UUID|ID шаблона|&mdash;|да|нет
|**name**               |String(255)|Наименование шаблона|&mdash;|да|нет
|**type**               |String(255)|Тип шаблона (mxtemplate - новый тип шаблона для ценников и этикеток)|&mdash;|да|нет
|**content**            |URL|Ссылка на скачивание|&mdash;|да|нет
...
| Название  | Тип | Описание                    | Свойство поля в запросе| Обязательное при ответе|Expand|
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Пользовательского шаблона|&mdash;|да|нет
|**id**                 |UUID|ID шаблона|&mdash;|да|нет
|**name**               |String(255)|Наименование шаблона|&mdash;|да|нет
|**type**               |String(255)|Тип шаблона (entity - документ)|&mdash;|да|нет
|**content**            |URL|Ссылка на скачивание|&mdash;|да|нет
