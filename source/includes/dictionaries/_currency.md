...
| **majorUnit**      | Object                                                    | Формы единиц целой части Валюты. [Подробнее тут](../dictionaries/#suschnosti-valuta-massowoe-udalenie-bonusnyh-programm-atributy-suschnosti-formy-edinic)<br>`+Обязательное при ответе`   |
...
| **minorUnit**      | Object                                                    | Формы единиц дробной части Валюты. [Подробнее тут](../dictionaries/#suschnosti-valuta-massowoe-udalenie-bonusnyh-programm-atributy-suschnosti-formy-edinic)<br>`+Обязательное при ответе` |
