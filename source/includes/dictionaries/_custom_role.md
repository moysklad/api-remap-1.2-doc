...
Средствами JSON API можно запрашивать и изменять кастомные роли.

#### Атрибуты сущности

| Название  | Тип | Описание                    | Свойство поля в запросе| Обязательное при ответе|
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные кастомной роли|&mdash;|да
|**id**                 |UUID|ID кастомной роли|Только для чтения|да
|**name**               |String(255)|Наименование кастомной роли|Необходимое при создании|да
|**permissions**          |Array(Object)| Список пермиссий|При создании (опционально)|да

### Получить кастомную роль
...
> Запрос на получение кастомной роли с указанным id.
...
Успешный запрос. Результат - JSON представление Кастомной роли.
...
### Получить все кастомные роли

> Запрос на получение кастомных ролей.
...
> Response 200 (application/json)
Успешный запрос. Результат - JSON представление кастомных ролей.
...
> Запрос на создание кастомной роли.
...
> Запрос на обновление кастомной роли.
...
> Запрос на удаление кастомной роли.
