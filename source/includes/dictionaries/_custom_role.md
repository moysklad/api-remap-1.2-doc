...
Получать и изменять роли можно от лица сотрудника с правами `Системного администратора` или от лица `Решения`.
...
| **meta**        | [Meta](#/general#3-metadannye) | Метаданные пользовательской роли<br>`+Обязательное при ответе`                              |
