...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные пользовательской роли|&mdash;|да
|**id**                 |UUID|ID пользовательской роли|Только для чтения|да
|**name**               |String(255)|Наименование пользовательской роли|Необходимое при создании|да
