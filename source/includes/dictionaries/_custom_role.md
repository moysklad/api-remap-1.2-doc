...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные пользовательской роли|&mdash;|да|нет
|**id**                 |UUID|ID пользовательской роли|Только для чтения|да|нет
|**name**               |String(255)|Наименование пользовательской роли|Необходимое при создании|да|нет
|**permissions**          |Array(Object)| Список пермиссий|При создании (опционально)|да|нет
...
> Запрос на получение пользовательски ролей.
