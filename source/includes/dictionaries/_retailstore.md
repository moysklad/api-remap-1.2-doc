...
| **marksCheckMode**                      | Enum                                                      |                             | Настройка проверки КМ перед продажей в ГИС МТ (по умолчанию CORRECT_MARKS_ONLY) [Подробнее тут](../dictionaries/#suschnosti-tochka-prodazh-tochki-prodazh-atributy-suschnosti-nastrojka-prowerki-km-pered-prodazhej-w-gis-mt)<br>`+Обязательное при ответе`                   |
...
| **APP**        | Выбранное приложение фискализации из списка в поле `fiscalAppId` |
