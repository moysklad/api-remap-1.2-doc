...
| **testChestnyZnakMode**                 | Boolean                                                     |                             | Настройка включения тестового режима Честного знака для новых типов маркированных товаров<br>`+Обязательное при ответе` по умолчанию `+true`                                                                                                                                                                |
