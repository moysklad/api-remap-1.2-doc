...
Стоит отметить отличие при замене этапа в позиции техпроцесса со стороны апи от web-интерфейса. Если через web-интерфейс выбрать в селекторе другой этап, 
то будет удалена старая позиция и создастся новая с выбранным этапом. Замена этапа через апи не пересоздает новую позицию
