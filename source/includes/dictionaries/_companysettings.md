...
| **accountCountry**           | String(255)                                               | Передается для информации о том, какая страновая конфигурация активна на аккаунте пользователя. Возможные значения: RU, BY, KZ.`+Обязательное при ответе` `+Только для чтения`                                                                 |
