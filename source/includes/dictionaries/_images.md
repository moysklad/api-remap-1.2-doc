...
Получить ссылку на скачивание изображения можно обратившить по адресу указанному в downloadHref.
...
Ссылка на скачивание изображения находится в заголовке `location` и доступна без авторизации. Время активности ссылки состовляет 5 минут.
