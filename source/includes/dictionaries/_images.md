...
Получить ссылку на скачивание изображения можно обратившить по адресу указанному в поле `downloadHref`, которое было получено при получении изображений.
...
Время активности ссылки состовляет 5 минут.
