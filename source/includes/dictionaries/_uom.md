...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Единицы измерения|&mdash;|да|нет
|**id**                 |UUID|ID Единицы измерения|Только для чтения|да|нет
|**accountId**          |UUID| ID учетной записи|Только для чтения|нет|нет
|**owner**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Владелец (Сотрудник)|Только для пользовательских единиц измерений|нет|да
|**shared**             |Boolean|Общий доступ|Только для пользовательских единиц измерений|да|нет
|**group**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Отдел сотрудника|Только для пользовательских единиц измерений|нет|да
|**updated**            |DateTime|Момент последнего обновления Единицы измерения|Только для чтения|да|нет
|**name**               |String(255)|Наименование Единицы измерения|Необходимое при создании|да|нет
|**description**        |String(4096)|Описание Единциы измерения|&mdash;|нет|нет
|**code**               |String(255)|Код Единицы измерения|&mdash;|нет|нет
|**externalCode**       |String(255)|Внешний код Единицы измерения|&mdash;|да|нет
