...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Единицы измерения|&mdash;|да
|**id**                 |UUID|ID Единицы измерения|Только для чтения|да
|**accountId**          |UUID| ID учетной записи|Только для чтения|нет
|**owner**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Владелец (Сотрудник)|Только для пользовательских единиц измерений|нет
|**shared**             |Boolean|Общий доступ|Только для пользовательских единиц измерений|да
|**group**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Отдел сотрудника|Только для пользовательских единиц измерений|нет
...
|**description**        |String(4096)|Описание Единциы измерения|&mdash;|нет
|**code**               |String(255)|Код Единицы измерения|&mdash;| нет
|**externalCode**       |String(255)|Внешний код Единицы измерения|&mdash; да
