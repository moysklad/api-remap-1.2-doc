...
| --------- |:----|:----------------------------|:----------------|:------------------------|:------------------------|
|**meta**             |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные о Статье расходов|&mdash;|да|нет
...
|**name**             |String(255)|Наименование Статьи расходов|Необходимое при создании|да|нет
|**description**      |String(4096)|Описание Статьи расходов|&mdash;|нет|нет
|**code**             |String(255)|Код Статьи расходов|&mdash;|нет|нет
|**externalCode**     |String(255)|Внешний код Статьи расходов|&mdash;|да|нет
|**archived**         |Boolean|Добавлена ли Статья расходов в архивы|&mdash;|нет|нет
