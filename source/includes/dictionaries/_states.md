...
| **meta**       | [Meta](#/general#3-metadannye) | Метаданные Статуса<br>`+Обязательное при ответе` `+Только для чтения`                                                          |
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Статусов.
