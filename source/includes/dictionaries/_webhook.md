...
| **authorApplication**  | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Приложения, создавшего веб-хук<br>                                                                                                                                                                                                                                                                      |
...
Для удобства отслеживания изменения остатков по номенклатуре можно включить веб-хук на изменения остатков. 
Данный веб-хук приходит каждые 3 минуты, если он включен и за данное время были изменены остатки у номенклатуры.

Url веб-хука имеет следующий вид:

`https://test.ru?requestId=b995757b-e9eb-4111-b944-53e3a00e365f`

Параметр запроса **requestId** - идентификатор уведомления.

Тело веб-хука имеет следующий вид:
