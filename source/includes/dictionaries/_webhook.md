...
Управление вебхуками доступно **администратору аккаунта** и приложениям со специальными правами. 
Подробнее про работу приложений с вебхуками см. в [документации для вендоров](https://dev.moysklad.ru/doc/api/vendor/1.0/#rabota-s-webhukami).
