...
| **authorApplication**  | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные приложения, которое создало веб-хук<br> `+Обязательное при ответе для веб-хука, созданного приложением`                                                                                                                                                                                                 |
