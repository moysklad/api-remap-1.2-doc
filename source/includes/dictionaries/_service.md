...
| **productFolder**       | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) |                                                                                                                                                   | Метаданные группы Услуги<br>`+Expand`                                                                                                                                                                                             |
...
При работе с регионоспецифичными полями необходимо передавать заголовок. Подробнее можно посмотреть [здесь](../#mojsklad-json-api-obschie-swedeniq-regional-nye-zagolowki)

| Название                | Тип    | Описание                                                                                                                                                                                                        |
|-------------------------|:-------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **mod\_\_tasnif\_\_uz** | Object | Модуль с информацией из справочника ТАСНИФ. [Подробнее тут](../dictionaries/#suschnosti-usluga-uslugi-metadannye-uslug-modul-dlq-uzbekistana-s-informaciej-iz-sprawochnika-tasnif)<br>`+Только для Узбекистана` |
