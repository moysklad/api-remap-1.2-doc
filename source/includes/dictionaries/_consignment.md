...
| ---------------- | :-------------------------------------------------------- | :-------------------------------------------------------------------------------------- | :----------------------- | :------------------------ | :------------------------ |
| **meta**         | [Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye) | Метаданные Серии                                                                        | &mdash;                  | да                        | нет                       |
| **id**           | UUID                                                      | ID Серии                                                                                | Только для чтения        | да                        | нет                       |
...
| **name**         | String(255)                                               | Наименование Серии. "Собирается" и отображается как "Наименование товара / Метка Серии" | Только для чтения        | да                        | нет                       |
| **description**  | String(4096)                                              | Описание Серии                                                                          | &mdash;                  | нет                       | нет                       |
| **code**         | String(255)                                               | Код Серии                                                                               | &mdash;                  | нет                       | нет                       |
| **externalCode** | String(255)                                               | Внешний код Серии                                                                       | &mdash;                  | да                        | нет                       |
