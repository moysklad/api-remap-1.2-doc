...
| **type**         | Enum                                                      | `=` `!=`                    | Тип Канала продаж [Подробнее тут](#/dictionaries/saleschannel#4-tip-kanala-prodazh)<br>`+Обязательное при ответе` `+Необходимо при создании` |
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Каналов продаж.
