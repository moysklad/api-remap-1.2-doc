...
+ **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye) о стандартном шаблоне
+ **id** - id шаблона
...
#### Атрибуты сущности
+ **meta** - [Метаданные](/#mojsklad-json-api-obschie-swedeniq-metadannye) о пользовательском шаблоне
+ **id** - id шаблона
+ **name** - наименование шаблона
+ **type** - тип шаблона (entity - документ)
+ **content** - ссылка на скачивание
