...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Стандартного шаблона|---|да
|**id**                 |UUID|ID шаблона|---|да
|**name**               |String(255)|Наименование шаблона|---|да
|**type**               |String(255)|Тип шаблона (entity - документ)|---|да
|**content**            |URL|Ссылка на скачивание|---|да
...
|**id**                 |UUID|ID шаблона|---|да
|**name**               |String(255)|Наименование шаблона|---|да
|**type**               |String(255)|Тип шаблона (mxtemplate - новый тип шаблона для ценников и этикеток)|---|да
|**content**            |URL|Ссылка на скачивание|---|да
...
| Название  | Тип | Описание                    | Свойство поля в запросе| Обязательное при ответе|
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Пользовательского шаблона|---|да
|**id**                 |UUID|ID шаблона|---|да
|**name**               |String(255)|Наименование шаблона|---|да
|**type**               |String(255)|Тип шаблона (entity - документ)|---|да
|**content**            |URL|Ссылка на скачивание|---|да
