...
+ **meta** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) отчета по данному контрагенту
+ **counterparty** - Контрагент
  - **meta** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) контрагента
  - **id** - id контрагента
...
- **meta** [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) отчета,
