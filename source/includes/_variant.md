...
+ **product** - [Метаданные](#metadannye), представляющие с собой ссылку на [товар](#tovar), к которому привязана Модификация. `Необходимое`
...
- **rows** - Массив JSON объектов, представляющих собой [Модификации](#modifikaciya-modifikacii).
...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) Модификаций.
