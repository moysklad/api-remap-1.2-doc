...
+ **product** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные), представляющие с собой ссылку на [товар](/api/remap/1.2/doc/product.html#товар-товары), к которому привязана Модификация. `Необходимое`
...
- **rows** - Массив JSON объектов, представляющих собой [Модификации](/java-remap-1.2-doc/api/remap/1.2/ru/#модификация-модификации).
...
[Массовое создание и обновление](/java-remap-1.2-doc/api/remap/1.2/ru/#создание-и-обновление-нескольких-объектов) Модификаций.
