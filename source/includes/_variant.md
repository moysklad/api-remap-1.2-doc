...
Особенности создания списка штрихкодов при создании модификации:
...
О работе с доп. полями Модификаций можно прочитать [здесь](../#mojsklad-json-api-obschie-swedeniq-rabota-s-dopolnitel-nymi-polqmi)
...
+ **value** - значение характеристики. `Необходимое`
