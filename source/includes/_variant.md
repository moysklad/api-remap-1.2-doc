...
+ **product** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные), представляющие с собой ссылку на [товар](/java-remap-1.2-doc/api/remap/1.2/ru/#товар), к которому привязана Модификация. `Необходимое`
