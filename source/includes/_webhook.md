...
#### Атрибуты сущности
+ **meta** - [Метаданные](../#mojsklad-json-api-obschie-swedeniq-metadannye) веб-хука
+ **id** - id веб-хука
...
сочетание **entityType**, **action**, **url** должно быть уникальным. Всего на пару **entityType**, **action** может быть создано не более 5 веб-хуков.
