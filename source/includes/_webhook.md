...
#### SSL Handshake
Отправка вебхуков возможна только при наличии у получателя SSL сертификата с корректными Certification Paths. Проверить сертификат можно в сервисе https://www.ssllabs.com/ssltest/index.html
