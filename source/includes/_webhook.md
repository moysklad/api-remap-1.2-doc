...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные веб-хука|---|да
|**id**                 |UUID|ID веб-хука|---|да
|**accountId**          |UUID| ID учетной записи Кассира|---|да
...
|**method**         |Enum|HTTP метод, с которым будет происходить запрос. Возможные значения: `POST`|---|да
|**enabled**              |Boolean|Флажок состояние веб-хука (включен / отключен)|---|да
|**action**        |Enum| Действие, которое отслеживается веб-хуком. Возможные значения: `[CREATE, UPDATE, DELETE]`|Необходимое при создании|да
