...
* *authorApplication* - [Метаданные](../#mojsklad-json-api-obschie-swedeniq-metadannye) Приложения, создавшего дополнительное поле, заполняется автоматически при создании.
