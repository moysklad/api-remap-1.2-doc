...
JSON API описана в статье [Дополнительные поля](https://dev.moysklad.ru/doc/api/remap/1.2/#mojsklad-json-api-obschie-swedeniq-fil-traciq-wyborki-s-pomosch-u-parametra-filter-udalit-dopolnitel-noe-pole-scheta-urlica-fil-traciq-po-dopolnitel-nym-polqm).
