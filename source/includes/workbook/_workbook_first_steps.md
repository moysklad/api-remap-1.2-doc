...
При наличии proxy-сервера необходимо проводить именно его настройку. В противном случае нужно выстаить keep-alive при подключении к MC в библиотеке для http запросов
