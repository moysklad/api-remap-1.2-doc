...
Для того, чтобы не опрашивать эндпоинт статуса выполняемой асинхронной задачи можно настроить [вебхук](https://dev.moysklad.ru/doc/api/remap/1.2/dictionaries/#suschnosti-vebhuki) на оповещение, когда задача будет завершена.
