...
#### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) о платеже
...
+ **state** - Статус Входящего платежа в формате [Метаданных](#metadannye)
...
+ **factureOut** - Ссылка на Счет-фактура выданный, с которым связан этот платеж в формате [Метаданных](#metadannye)
...
О работе с доп. полями Входящих платежей можно прочитать [здесь](#rabota-s-dopolnitel-nymi-polyami)
...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) Входящих платежей.
...
+ **attributes** - Массив объектов доп. полей Входящих платежей в формате [Метаданных](#metadannye)
...
помечены `Только для чтения` в описании [атрибутов Входящего платежа](#vhodyashhij-platezh-vhodyashhie-platezhi).
