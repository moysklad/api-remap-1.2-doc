...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**             |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные о Регионе|---|да
...
|**code**             |String(255)|Код Региона|---|нет
|**externalCode**     |String(255)|Внешний код Региона|---|да
