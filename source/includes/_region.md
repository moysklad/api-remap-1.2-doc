...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**             |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные о Регионе|&mdash;|да
...
|**name**             |String(255)|Наименование Региона|Необходимое при создании|да
|**code**             |String(255)|Код Региона|&mdash;|нет
|**externalCode**     |String(255)|Внешний код Региона|&mdash;|да
