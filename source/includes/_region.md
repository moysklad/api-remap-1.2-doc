...
#### Атрибуты сущности
+ **meta** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) о Регионе
...
- **rows** - Массив JSON объектов, представляющих собой [Регионы](/java-remap-1.2-doc/api/remap/1.2/ru/#регион-регионы).
