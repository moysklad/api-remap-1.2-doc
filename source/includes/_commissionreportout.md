...
С позициями можно работать с помощью [специальных ресурсов для управления позициями выданного отчета комиссионера](#vydannyj-otchet-komissionera-pozicii-wydannogo-otcheta-komissionera-2),
...
[Массовое создание и обновление](#sozdanie-i-obnowlenie-neskol-kih-ob-ektow) выданных отчетов комиссионера.
...
помечены `Только для чтения` в описании [атрибутов выданного отчета комиссионера](#vydannyj-otchet-komissionera).
...
чем является указанная позиция. Подробнее об этом поле можно прочитать в описании [позиции отчета комиссионера](#pozicii-wydannogo-otcheta-komissionera-2)
