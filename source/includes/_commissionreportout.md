...
#### Атрибуты сущности
+ **meta** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) о выданном отчете комиссионера
...
+ **state** - Статус выданного отчета комиссионера в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
...
+ **positions** - Ссылка на позиции выданного отчета комиссионера в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
...
С позициями можно работать с помощью [специальных ресурсов для управления позициями выданного отчета комиссионера](/java-remap-1.2-doc/api/remap/1.2/ru/#выданный-отчет-комиссионера-позиции-выданного-отчета-комиссионера),
...
[Массовое создание и обновление](/java-remap-1.2-doc/api/remap/1.2/ru/#создание-и-обновление-нескольких-объектов) выданных отчетов комиссионера.
...
помечены `Только для чтения` в описании [атрибутов выданного отчета комиссионера](/java-remap-1.2-doc/api/remap/1.2/ru/#выданный-отчет-комиссионера-выданные-отчеты-комиссионера).
...
чем является указанная позиция. Подробнее об этом поле можно прочитать в описании [позиции отчета комиссионера](/java-remap-1.2-doc/api/remap/1.2/ru/#позиции-выданного-отчета-комиссионера)
