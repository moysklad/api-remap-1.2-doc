...
<h4>Загрузка</h4>
Для загрузки изображения нужно в теле запроса на [создание](#sozdat-komplekt) или [обновление](#izmenit-komplekt) Комплекта
...
[Массовое создание и обновление](#sozdanie-i-obnowlenie-neskol-kih-ob-ektow) Комплектов.
