...
Структура элементов поля **imageы**, которую вы получите при запросе Комплекта с изображениями:
...
Если в запросе на обновление не будет полей **filename** и **content** у **images**, то все Изображения у Комплекта будут удалены, 
