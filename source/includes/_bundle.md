...
+ **image** - Изображения Комплекта. Изображений у Комплекта может быть не более 10
...
При запросе Комплекта с изображениями будет выведено json представление этого Комплекта, содержащее поле **image**. Данное поле является 
...
Если в запросе на обновление **image** будет содержать пустой массив элементов, то все Изображения у Комплекта будут удалены, 
  ...
  "rows": [
    {
      ...
      "image": {
        "meta": {
          "href": "https://online.moysklad.ru/api/remap/1.2/entity/bundle/c21646cf-ee08-11e6-8af5-581e00000023/image",
          "type": "image",
          "mediaType": "application/json",
          "size": 0,
          "limit": 1000,
