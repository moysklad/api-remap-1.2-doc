...
| Название  | Тип | Описание                    | Поле в запросе | Обязательное при ответе|
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**currency**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Валюта доп расходов|---|да
|**value**               |Int|Значение доп расходов|---|да
...
| Название  | Тип | Описание                    | Поле в запросе | Обязательное при ответе|
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**currency**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Валюта минимальной цены|---|да
|**value**               |Int|Значение минимальной цены|---|нет
