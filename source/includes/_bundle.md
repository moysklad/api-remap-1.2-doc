...
+ **value** - Значение цены
+ **currency** - Ссылка на валюту в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)              |Int|Значение доп расходов|---|да

##### Минимальная цена
Структура объекта minPrice.

+ **value** - Значение цены
+ **currency** - Ссылка на валюту в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)               |Int|Значение минимальной цены|---|нет
