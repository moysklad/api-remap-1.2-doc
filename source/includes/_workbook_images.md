...
обновить список изображений в рамках обновления товара или воспользоваться эндпоинтами для работы с изображениями.
 ...
 Для добавления изображения нужно задать поля `filename` и `context` соответствующие названию файла и содержанию файла,
  закодированного в Base64, соответственно.
 Если нужно добавить или дублировать уже существующее изображение, то можно указать его `meta`.
 
 К примеру, нужно создать Товар с несколькими изображениями. Это можно сделать через обновление товара.
...
Теперь рассмотрим другой вариант работы с изображениями. Предположим есть товар, и нужно обновить его изображения. 
