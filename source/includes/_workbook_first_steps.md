...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/entity/product/a7404318-550f-11e8-56c0-000800000010"
```
...
curl -X PUT 
  ...
  -H "Content-Type: application/json" 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/entity/product/a7404318-550f-11e8-56c0-000800000010" -d
```
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/report/stock/all?stockMode=all"
```
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/entity/product?filter=name=%D0%9D%D0%BE%D0%B2%D0%BE%D0%B5%20%D0%BD%D0%B0%D0%B8%D0%BC%D0%B5%D0%BD%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5;updated%3E2018-01-01%2000:00:00"
```
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/entity/country"
```
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/entity/country/?limit=25&offset=25"
```
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/entity/country/?search=%D0%BC%D0%B0%D1%80%D0%B8>"
```
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/entity/country/?order=name,desc;updated"
```
...
curl -X GET 
  -u login:password 
  -H "Lognex-Pretty-Print-JSON: true" 
  "https://online.moysklad.ru/api/remap/1.1/entity/product/a7404318-550f-11e8-56c0-000800000010?expand=owner,owner.group>\"
```
