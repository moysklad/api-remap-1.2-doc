...
+ **processingPlan** - Ссылка на тех. карту в формате [Метаданных](#metadannye) `Необходимое`
+ **positions** - Ссылка на позиции в Заказе в формате [Метаданных](#metadannye) `Необходимое`
...
+ **processings** - Массив ссылок на связанные тех. операции в формате [Метаданных](#metadannye)
...
О работе с доп. полями Заказов на производство можно прочитать [здесь](#rabota-s-dopolnitel-nymi-polyami)
...
+ **processingPlan** - Ссылка на тех. карту в формате [Метаданных](#metadannye)
...
[Массовое создание и обновление](#sozdanie-i-obnowlenie-neskol-kih-ob-ektow) Заказов на производство.
...
+ **attributes** - Массив объектов доп. полей Заказов на производство в формате [Метаданных](#metadannye)
...
помечены `Только для чтения` в описании [атрибутов Заказа на производство](#zakaz-na-proizwodstwo-zakazy-na-proizvodstvo).
