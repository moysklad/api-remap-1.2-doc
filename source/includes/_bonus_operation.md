...
|**name**               |String(255)|Наименование Бонусной операции|---|да
...
|**transactionType**              |Enum|Тип бонусной операции. Возможные значения: `EARNING`, `SPENDING`|Необходимое при создании|нет
