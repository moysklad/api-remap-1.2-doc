...
Например, для шаблона отгрузки - смотреть в [Шаблонах отгрузки](/java-remap-1.2-doc/api/remap/1.2/ru/#документ-отгрузка-шаблон-отгрузки)
...
К некоторым документам в JSON API могут быть привязаны платежи. Платежи бывают 4-х типов: [Входящий платеж](/java-remap-1.2-doc/api/remap/1.2/ru/#входящий-платеж), [Приходный ордер](/java-remap-1.2-doc/api/remap/1.2/ru/#приходный-ордер), [Исходящий платеж](/java-remap-1.2-doc/api/remap/1.2/ru/#исходящий-платеж), [Расходный ордер](/java-remap-1.2-doc/api/remap/1.2/ru/#расходный-ордер).
