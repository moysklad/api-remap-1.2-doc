...
Например, для шаблона отгрузки - смотреть в [Шаблонах отгрузки](#shablon-otgruzki)
...
К некоторым документам в JSON API могут быть привязаны платежи. Платежи бывают 4-х типов: [Входящий платеж](#vhodqschij-platezh), [Приходный ордер](#prihodnyj-order), [Исходящий платеж](#ishodqschij-platezh), [Расходный ордер](#rashodnyj-order).
