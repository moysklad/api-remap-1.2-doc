...
Например, для шаблона отгрузки - смотреть в [Шаблонах отгрузки](#otgruzka-shablon-otgruzki)
...
К некоторым документам в JSON API могут быть привязаны платежи. Платежи бывают 4-х типов: [Входящий платеж](#vhodyashhij-platezh), [Приходный ордер](#prihodnyj-order), [Исходящий платеж](#ishodyashhij-platezh), [Расходный ордер](#rashodnyj-order).
