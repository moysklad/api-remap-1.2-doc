...
### Прайс-листы 
#### Атрибуты сущности
+ **meta** - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные) о Прайс-листе
...
+ **state** - Статус Прайс-листа в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
...
+ **positions** - Ссылка на позиции в Прайс-листе в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
...
+ **accountId** - ID учетной записи `Только для чтения`
+ **assortment** - Ссылка на товар/услугу/модификацию, которую представляет собой позиция, в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
+ **pack** - Упаковка товара
+ **cells** - массив значений столбцов в позиции Прайс-листа

С позициями можно работать с помощью [специальных ресурсов для управления позициями Прайс-листа](/java-remap-1.2-doc/api/remap/1.2/ru/#документ-прайс-лист-позиции-прайс-листа),
...
О работе с доп. полями Прайс-листов можно прочитать [здесь](/java-remap-1.2-doc/api/remap/1.2/ru/#работа-с-дополнительными-полями)
...
[Массовое создание и обновление](/java-remap-1.2-doc/api/remap/1.2/ru/#создание-и-обновление-нескольких-объектов) Прайс-листов.
...
+ **attributes** - Массив объектов доп. полей Прайс-листов в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные)
...
помечены `Только для чтения` в описании [атрибутов Прайс-листа](/java-remap-1.2-doc/api/remap/1.2/ru/#документ-прайс-лист-прайс-листы).
