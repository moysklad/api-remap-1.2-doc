...
<div class="banner">
  <h4>Внимание!</h4>
  <p>28 августа 2025 года из-за изменения политики доступа Изображения из Товаров, Модификаций и Комплектов станут доступны по ссылкам, не требующим авторизации.</p>
