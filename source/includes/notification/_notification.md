...
<div class="banner">
  <h4>Внимание!</h4>
  <p></p>
  <ui><b>С 28 августа будут добавлены публичные постоянные ссылки на изображения в товарах, комплектах и модификациях.</b>
  ...
  <p>Такие ссылки требуют изменения политики доступа к изображениям, поэтому <b>необходимо удалить картинки, содержащие приватную информацию</b>.</p>
</div>
