...
| **RetireOrderByDemandNotificationCompleted** | Обмен данными          | Вывод из оборота на основании отгрузок выполнен                        |
...
#### Тип уведомления
RetireOrderByDemandNotificationCompleted - завершение Вывода из оборота на основании отгрузок
#### Атрибуты уведомления
...
| **followedEvents**  | Настройки группы уведомлений  | Отслеживаемые события  |
