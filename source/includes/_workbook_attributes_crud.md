...
статье [Дополнительные поля](../workbook/#workbook-rabota-s-dopolnitel-nymi-polqmi-cherez-api-spisok-suschnostej). 
...
JSON API описана в статье [Дополнительные поля](../workbook/#workbook-rabota-s-dopolnitel-nymi-polqmi-cherez-api-spisok-suschnostej).
...
некоторых производителей меняется с такой частотой, что предугадать зарание их тип и наличие невозможно. В таком случае может понадобиться 
...
свойтва - это имя и тип поля. Если добавить к ним id существующего дополнительного поля, то оно будет изменено.
Сформируем тело запроса из 3 элементов. Для поля "Материал корпуса" укажем его id, свойство "name" изменим на "Материал корпуса (дополнение)". 
...
созданы, им автоматически присвоятся id.
