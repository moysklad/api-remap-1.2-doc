...
|**deleted**            |DateTime|Момент последнего удаления Заказа покупателя|Только для чтения|да
...
|**deliveryPlannedMoment**          |DateTime|Планируемая дата отгрузки|Только для чтения|нет
...
|**invoicedSum**            |Int|Сумма счетов покупателю |Только для чтения|нет
...
|**discount**          |Int|Цена товара/услуги в копейках|---|нет
...
**rows** |Array(Object)|Массив JSON объектов, представляющих собой собой Заказы покупателей.
