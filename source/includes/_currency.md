...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Валюты|---|да
|**id**                |UUID|ID Валюты|Только для чтения|да
|**name**         |String(255)|Краткое аименование Валюты|Необходимое при создании|да
|**fullName**         |String(255)|Полное наименование Валюты|---|нет
|**code** |String(255)| Цифровой код Валюты|Необходимое при создании|нет
|**isoCode** |String(255)| Буквенный код Валюты|Необходимое при создании|нет
|**rate** |Double| Курс Валюты|---|да
...
|**majorUnit** |Object| Формы единиц целой части Валюты|---|да
|**minorUnit** |Object| Формы единиц дробной части Валюты|---|да
