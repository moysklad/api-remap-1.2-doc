...
| --------- |:----|:----------------------------|:----------------|:------------------------|
|**meta**               |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные Исходящего платежа|---|да
...
|**name**               |String(255)|Наименование Исходящего платежа|---|да
|**description**        |String(4096)|Комментарий Исходящего платежа|---|нет
|**externalCode**       |String(255)|Внешний код Исходящего платежа|---| да
...
|**state**              |[Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye)|Метаданные статуса Исходящего платежа|---|нет
...
|**attributes**         |Array([Meta](../#mojsklad-json-api-obschie-swedeniq-metadannye))|Коллекция метаданных доп. полей. [Поля при expand'е](../documents/#dokumenty-vhodqschij-platezh-vhodqschie-platezhi-atributy-suschnosti-polq-pri-expand-39-e-dop-polej) |---|нет
