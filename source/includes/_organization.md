...
+ **meta** - [Метаданные](../#mojsklad-json-api-obschie-swedeniq-metadannye) о юрлице
...
В зависимости от значения данного поля набор выводимых реквизитов юрлица может меняться.  Подробнее [тут](../dictionaries/#suschnosti-jurlico-jurlica-tip-urlica)
...
+ **phone** - Телефон
+ **fax** - Факс
+ **accounts** - [Метаданные](../#mojsklad-json-api-obschie-swedeniq-metadannye), представляющие собой ссылку на счета юрлица
...
+ **bic** - БИК
+ **agent** - Ссылка на юрлицо (тип [Мета](../#mojsklad-json-api-obschie-swedeniq-metadannye)) `Необходимо`
