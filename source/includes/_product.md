...
+ **image** - Изображения Товара. Изображений у Товара может быть не более 10
...
При запросе Товара с изображениями будет выведено json представление этого Товара, содержащее поле **image**. Данное поле является 
...
Если в запросе на обновление **image** будет содержать пустой массив элементов, то все Изображения у Товара будут удалены, 
  ...
  "rows": [
    {
      ...
      "image": {
        "meta": {
          "href": "https://online.moysklad.ru/api/remap/1.2/entity/product/26b36824-2c83-11e6-8a84-bae50000001b/image",
          "type": "image",
          "mediaType": "application/json",
          "size": 0,
          "limit": 1000,
    ...
    },
    {
      ...
      "image": {
        "meta": {
          "href": "https://online.moysklad.ru/api/remap/1.2/entity/product/d950551c-2c7f-11e6-8a84-bae50000000b/image",
          "type": "image",
          "mediaType": "application/json",
          "size": 0,
          "limit": 1000,
...
```json
{
  ...
  "image": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.2/entity/product/a355f431-29a1-11e6-8a84-bae500000009/image",
      "type": "image",
      "mediaType": "application/json",
      "size": 0,
      "limit": 1000,
  ...
  ```json
{
  ...
  "image": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.2/entity/product/04996e84-29a1-11e6-8a84-bae500000002/image",
      "type": "image",
      "mediaType": "application/json",
      "size": 0,
      "limit": 1000,
  ...
  ```json
{
  ...
  "image": {
    "meta": {
      "href": "https://online.moysklad.ru/api/remap/1.2/entity/product/bd1c0a3e-95ee-11e6-8a84-bae500000004/image",
      "type": "image",
      "mediaType": "application/json",
      "size": 1,
      "limit": 1000,
