...
О работе с доп. полями Товаров можно прочитать [здесь](#rabota-s-dopolnitel-nymi-polyami)
...
<h4>Загрузка</h4>
Для загрузки изображений нужно в теле запроса на [создание](#towar-towary-post) или [обновление](#towar-towar-put) товара
...
- **rows** - Массив JSON объектов, представляющих собой [Товары](#towar-towary).
