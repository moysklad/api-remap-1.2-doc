...
Структура элементов поля **images**, которую вы получите при запросе товара с изображениями:
...
Если в запросе на обновление не будет полей **filename** и **content** у **images**, то все Изображения у Товара будут удалены, 
