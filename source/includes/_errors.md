...
|43012|Ошибка обновления прав сотрудника: для пермиссии {тип пермиссии} заданое для {название пермиссии} значение {значение пермиссии} шире, чем значение {значение пермиссии} для название пермиссии}|Указаны несовместимые типы для дочерней и родительской пермиссии.
