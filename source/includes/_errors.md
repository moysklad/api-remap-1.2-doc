...
|<a name="error_63002">63001</a>|Ошибка применения сохраненного фильтра: неверный формат ссылки на фильтр|Корректный формат ссылки должен иметь тип [URL](https://dev.moysklad.ru/doc/api/remap/1.2/#mojsklad-json-api-obschie-swedeniq-tipy-dannyh)
|<a name="error_63004">63002</a>|Ошибка применения сохраненного фильтра: допускается одновременное применение только одного сохраненного фильтра|Параметр запроса `namedfilter` может принимать только одно значение
