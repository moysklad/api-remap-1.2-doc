...
|61002|Ошибка при запросе результата асинхронной задачи: результат еще не готов|Задача находится в обработке и имеет статус `PROCESSING`. Дождитесь выполнения асинхронной задачи
...
|61006|Превышено ограничение на количество одновременно выполняемых асинхронных операций|Дождитесь выполнения текущей задачи
