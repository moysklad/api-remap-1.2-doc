...
|1084|Неверное значение {переданное значение} параметра запроса {query параметр запроса}, допустимые значения: {известные обработчику значения}|Значение параметра не поддерживается. Проверьте url и версию API. 
