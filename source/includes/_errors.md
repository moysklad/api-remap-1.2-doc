...
Код ошибки | Сообщение | Описание
---------- | --------- | --------
|<a name="error_63000">63000</a>|Ошибка применения сохраненного фильтра: применять сохраненный фильтр может только его создатель|Просматривать свои сохраненный фильтры и применять их может только создатель
|<a name="error_63001">63001</a>|Ошибка применения сохраненного фильтра: нельзя применять сохраненный фильтр вместо со стандартными|Сохраненный и стандартные фильтры можно применять только по отдельности
|<a name="error_63002">63002</a>|Ошибка применения сохраненного фильтра: сохраненный фильтр с данным id не предполагает применение на текущем эндпоинте|Тип сущностей, для которых был создан фильтр, отличается от типа ресурса, на котором идет применение
|<a name="error_63003">63003</a>|Ошибка применения сохраненного фильтра: неверный формат href|Строка, переданная в параметре, не является href
|<a name="error_63004">63004</a>|Ошибка применения сохраненного фильтра: фильтр с данным id не соответствует типу сущности в href|href ведет на ресурс, несоответствующий текущему
