...
|43011|Ошибка обновления прав сотрудника: для пермиссии {тип пермиссии} задано дочернее значение пермиссии {название пермиссии}, но не указано родительское значение пермиссии {название пермиссии}|Нельзя задавать значение пермиссии, не указавая значения для родительской пермиссии.
