...
Код ошибки | Сообщение | Описание
---------- | --------- | --------
|<a name="error_63000">63000</a>|Ошибка применения сохраненного фильтра: сохраненный фильтр не совместим с любой другой фильтрацией|Был передан параметр `filter`, несовместимый с применением сохраненного фильтра
|<a name="error_63001">63001</a>|Ошибка применения сохраненного фильтра: указанный фильтр не совместим с текущим эндпоинтом|Тип фильтруемых сущностей не соответствует типу выбранного ресурса
|<a name="error_63002">63002</a>|Ошибка применения сохраненного фильтра: неверный формат ссылки на фильтр|Корректный формат ссылки приведен в разделе [Сохраненныъ фильтров]()
|<a name="error_63003">63003</a>|Ошибка применения сохраненного фильтра: указанный фильтр не предназначен для применения к типу сущности в ссылке|
|<a name="error_63004">63004</a>|Ошибка применения сохраненного фильтра: допускается одновременное применение только одного сохраненного фильтра|href ведет на ресурс, несоответствующий текущему
