...
|16106|Ошибка сохранения товара: неизвестный тип маркировки товара|Тип маркировки товара может быть только одним из следующих: NOT_TRACKED, TOBACCO, SHOES, LP_CLOTHES, LP_LINENS, PERFUMERY, ELECTRONICS, TIRES
...
|60001|Ошибка сохранения отдела: у отдела должно быть название|
|60002|Ошибка сохранения отдела: отдел с таким названием уже существует|каждый отдел должен иметь уникальное название
|60003|Ошибка сохранения отдела: индекс за пределами диапазона|индекс не должен быть больше количества отделов или меньше 0
|60004|Ошибка удаления отдела: нельзя удалить все отделы|после удаления должен остаться хотя бы один отдел
