...
|<a name="error_2028">2028</a>|Ошибка формата: отсутствует href для meta создаваемой сущности|В переданном объекте метаданных отсутствует поле href. Проверьте тело запроса.
