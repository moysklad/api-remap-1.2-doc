...
|1018|Доступ запрещен: у вас нет прав на удаление данного объекта|Администратор учётной записи ограничил ваши права на удаление сущностей данного типа. Свяжитесь с ним для выяснения подробностей.|1019|Чтение поля '{имя поля}' не поддерживается|Невозможно чтение поля данного типа.
...
## Коды ошибок для Характеристики модификаций
...
## Коды ошибок для Розничные смены (POS)
...
|14002|Ошибка сохранения дополнительного поля: родительская сущность не поддерживает дополнительные поля|Сущности данного типа не могут иметь доп. полей. Уточнить список типов сущностей, которые могут иметь доп. поля можно в разделе [Работа с дополнительными полями](/api/remap/1.2/doc/index.html#header-работа-с-дополнительными-полями)
...
## Коды ошибок для Продажи/Отгрузки
...
## Коды ошибок для Группы товаров
...
## Коды ошибок для Инвентаризация
...
## Коды ошибок для Технологические операции
...
## Коды ошибок для Заказы на производство
...
## Коды ошибок для Печатные формы
...
## Коды ошибок для Пользовательские справочники
...
## Коды ошибок для Скачивание изображений
...
## Коды ошибок для Тарифные ограничения
