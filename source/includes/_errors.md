...
|16005|Ошибка сохранения товара: Недостаточно места в хранилище.|Место в хранилище, выделенное для вашей учетной записи закончилось.
...
|16009|Ошибка сохранения товара: число изображений у товара не может быть больше 10 | у товара не может быть больше 10 изображений.
