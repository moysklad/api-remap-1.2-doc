...
|17102|Ошибка сохранения документа: неверный формат кода маркировки <значение КМ / КМ ТУ / КМ ПУ>|Код маркировки должен соответствовать формату:<ul><li>Обувная продукция: 01+GTIN+21+SERIAL+TAIL. GTIN - идентификатор товара из 14 цифр, SERIAL - серийный номер из 13 символов, TAIL - ключ проверки и код проверки. Пример: <b><font color='green'>01</font>04630037590265<font color='green'>21</font>K6UT)6\"pIG-<*\u001d<font color='green'>91</font></b>8023<b>\u001d<font color='green'>92</font></b>wUpbNPy.</li><li>Табачная продукция продукция, пачка: GTIN+SERIAL+TAIL. GTIN - идентификатор товара из 14 цифр, SERIAL - серийный номер из 7 символов, TAIL - код проверки. Примеры: <b>00000046198488</b>X?xx+xXXABm8wAYa (с GTIN-8), <b>04606203086627</b>&,8xxxXXX77mXMF (с GTIN-13).</li><li>Табачная продукция продукция, блок (упаковка): 01+GTIN+21+SERIAL+TAIL. GTIN - идентификатор товара из 14 цифр, SERIAL - серийный номер из 7 символов, TAIL - максимальная цена и код проверки. Пример: <b>01</b>04630034070029<b>21</b>tXXXu%d<b>8005</b>0665006875q()""''%A.</li></ul>Код маркировки транспортной упаковки продукции должен содержать 18 цифр - формат GS1.
