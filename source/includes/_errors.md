...
|16111|Ошибка сохранения товара: Ошибка сохранения товара: значение поля ТН ВЭД не соответствует типу маркированной продукции|Тип маркированной продукции товара/комплекта отличается от типа, соответствующего коду ТН ВЭД
