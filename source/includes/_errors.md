...
|3012|Ошибка валидации: для поля '%s' массив элементов не должен содержать атомарный тип или null|Нельзя передавать атомарный тип или null в составе массива.
