...
В JSON API есть возможность применения фильтров, сохраненных в веб-интерфейсе. Для этого необходимо передать в качестве параметра запроса
`namedfilterid` со значением-ссылкой на сохраненный фильтр. 
