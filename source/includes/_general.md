...
+ meta - [Метаданные](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные), представляющие собой ссылку на сущность из соответствующего справочника
...
Ссылки выводятся в формате [Метаданных](/java-remap-1.2-doc/api/remap/1.2/ru/#метаданные). Для того, чтобы вместо ссылок получить связанные объекты,
...
### Доп. поля сущностей
В JSON API есть возможность управлять набором существующих доп. полей для каждого из типов сущностей перечисленных [тут](/java-remap-1.2-doc/api/remap/1.2/ru/#работа-с-дополнительными-полями).
...
Структура объекта доп. поля подробно описана в секции [Работа с дополнительными полями](/java-remap-1.2-doc/api/remap/1.2/ru/#работа-с-дополнительными-полями).
