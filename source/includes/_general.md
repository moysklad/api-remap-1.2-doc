...
Возвращает данные о сотруднике, от лица которого происходит запрос.
...
Многие атрибуты, представленные в этом запросе, за исключением поля `permissions`, повторяют атрибуты запроса [Сотрудника](dictionaries/#suschnosti-sotrudnik-sotrudniki), здесь они подробно описываться не будут.
