...
|:-------|:------------------------------------------------|
| **ru** | Регион Россия. (Является регионом по умолчанию) |
 **uz** | Регион Узбекистан                               |

После передачи регионального заголовка в телах запросов появятся регионоспецифичные поля. [Подробнее тут.](dictionaries/#suschnosti-komplekt-komplekty)
