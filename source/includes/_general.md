...
> Response 200 (application/json)
Успешный запрос. Результат - JSON представление Возвратов покупателей с развернутым полем отгрузки
...
> Response 200 (application/json)
Успешный запрос. Результат - JSON представление обнавлённая Отгрузка с развернутими объектами контрагента и юрлица
