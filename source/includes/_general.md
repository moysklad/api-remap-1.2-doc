...
## Замечание по разработке клиентских приложений
Мы считаем неизменными уже добавленные поля и структуры, но в любой момент можем добавить новые поля и ендпоинты.
