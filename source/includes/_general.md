...
| **DateTime**          | Представляет строку в формате "гггг-мм-дд чч-мм-сс". Максимально допустимое значение `"275760-09-13 00:00:00"`. Пример значения: `"2016-08-23 15:21:09"`. [Подробнее тут](#mojsklad-json-api-obschie-swedeniq-format-daty-i-wremeni)                       |
