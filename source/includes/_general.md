...
Сервер апи при наличии тела ответа и использовании сжатия ответа, укажет явно сжатие ответа и кодировку сжатия в заголовке Content-Encoding. 
Следует обратить внимание на этот заголовок, так как сжатие в редких случаях может быть не применено, когда размер ответа будет минимальным и применять сжатие к такому ответу будет неоправданно дорого.
