...
+ **downloadHref** - Ссылка на скачивание Изображения. Данный параметр указывается только в **download**, **miniature**, **tiny** для Изображения у Товара, Модификаций или Комплекта, также в **download** в поле **value** для доп. полей типа файл ("type": "file").
...
Значение поля value у доп. поля типа Файл, отличается от обычных доп. полей, данное поле включается в себя следующие поля:
