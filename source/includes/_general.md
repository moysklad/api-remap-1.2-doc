...
В JSON API есть возможность применения сохраненных фильтров. Подробное описание доступно в [соответствующем разделе](https://dev.moysklad.ru/doc/api/remap/1.2/dictionaries/#suschnosti-sohranennye-fil-try).
