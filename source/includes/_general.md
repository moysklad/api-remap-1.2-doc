...
+ `/customerorder/{id документа}?fields=stock&expand=positions&limit=100`
...
Максимальный размер выборки, на котором можно получить список операций с остатками в позициях равен 100.
