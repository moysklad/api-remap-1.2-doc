...
**DateTime**|Представляет строку в формате "гг-мм-дд чч-мм-сс". Пример значения: `"2016-08-23 15:21:09"`. [Подробнее тут](../#mojsklad-json-api-obschie-swedeniq-format-daty-i-wremeni)
...
**Array(Type)**|Массив полей. Type - тип элементов массива.
**Enum**|Представляет строку, принимающую константное множестов значений.
...
| Название  | Тип | Описание                    | 
| --------- |:----|:----------------------------|
|**size**|Int|Ссылка на объект|
|**limit**|Int|Максимальное количество элементов в выданном списке. Максимальное количество элементов в списке равно 1000, для вложенных коллекций - 100.|
...
|**code**              |Int|Код ошибки (Если поле ничего не содержит, смотрите HTTP status code)|---|да
|**error_message**               |String(255)|Сообщение, прилагаемое к ошибке.|---|да
...
|**content**              |String(unlimited)|Байты файла, закодированные в base64|Необходимое при создании|да
