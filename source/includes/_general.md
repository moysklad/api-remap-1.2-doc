...
Сортировка поддерживается для следующих типов полей: числовой, строковый, дата-время, логический и uuid. Подробное описание доступно в [соотвествующем разделе](https://dev.moysklad.ru/doc/api/remap/1.2/workbook/#workbook-sortirowka).
