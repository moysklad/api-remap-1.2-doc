...
Сортировка поддерживается для следующих типов полей: числовой, строковый, дата-время, логический и uuid. Подробное описание доступно в [соотвествующем разделе](workbook/#workbook-sortirowka).
