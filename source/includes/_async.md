...
|**errors**       |Object|json ошибки апи, если поле **state** имеет значение `API_EXCEPTION`|Только для чтения|нет
...
Если статус задачи имеет значение `API_EXCEPTION`, то в json ответе на запрос получения результата задачи будет указана [ошибка](https://dev.moysklad.ru/doc/api/remap/1.2/#mojsklad-json-api-oshibki), 
