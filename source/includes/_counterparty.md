...
|**owner**              |Meta|Владелец (Сотрудник)|---|да
|**shared**             |Boolean|Общий доступ|---|да
|**group**              |Meta|Отдел сотрудника|---|да
...
|**name**               |String(255)|Наименование Контрагент|Необходимое при создании|да
...
|**state**              |Meta|Статус Контрагента|---| да
|**salesAmount**        |Int|Сумма продаж|Только для чтения| да
|**bonusProgram**       |Meta|Ссылка на активную Бонусную программу|---| нет
...
|**contactpersons**   |Array(Meta)|Ссылка на контактные лица фирмы Контрагента (массив)|---|нет
...
|**country**      |String(255)|Ссылка на страну|---|нет
|**region**      |String(255)|Ссылка на регион|---|нет
...
|**agent**      |Meta|Ссылка на Контрагента|---|да
...
|**agent**      |Meta|Метаданные Контрагента|Только для чтения|да
|**author**      |Meta|Метаданные сотрудника - создателя события|Только для чтения|да
