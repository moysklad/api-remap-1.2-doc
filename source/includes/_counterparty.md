...
| Название  | Описание| Тип                      | Необходимое при создании | Только для чтения | Обязательное при ответе |
| --------- |:--------|:-------------------------|:-------------------------|:------------------|:------------------------|
|**meta** |[Метаданные](../#mojsklad-json-api-obschie-swedeniq-metadannye) объекта                                   | Объект                                         | нет                      | нет               | да                      |
|**id**                 |ID в формате UUID                                                                                         | Строка в формате UUID                          | нет                      | да                | да                      |
|**accountId**          |ID учетной записи                                                                                         | Строка в формате UUID                          | нет                      | да                | да                      |
|**owner**              |Ссылка на Владельца (Сотрудника) в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)| Объект                                         | нет                      | нет               | да                      |
|**shared**             |Общий доступ                                                                                              | Логический, принимает значение true или false  | нет                      | нет               | да                      |
|**group**              |Отдел сотрудника в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)                | Объект                                         | нет                      | нет               | да                      |
|**syncId**             |ID синхронизации. После заполнения недоступен для изменения                                               | Строка в формате UUID                          | нет                      | нет               | нет                     |
|**updated**            |Момент последнего обновления Контрагента                                                                  | Строка                                         | нет                      | да                | да                      |
|**name**               |Наименование Контрагент                                                                                   | Строка не более 255 символов                   | да                       | нет               | да                      |
|**description**        |Комментарий к Контрагенту                                                                                 | Строка не более 4096 символов                  | нет                      | нет               | нет                     |
|**code**               |Код Контрагента                                                                                           | Строка не более 255 символов                   | нет                      | нет               | нет                     |
|**externalCode**       |Внешний код Контрагента                                                                                   | Строка не более 255 символов                   | нет                      | да                | да                      |
|**archived**           |Добавлен ли Контрагент в архив                                                                            | Логический, принимает значение true или false  | нет                      | нет               | да                      |
|**created**            |Дата создания                                                                                             | Строка                                         | нет                      | нет               | да                      |
|**email**              |Адрес электронной почты                                                                                   | Строка не более 255 символов                   | нет                      | нет               | нет                     |
|**phone**              |Номер городского телефона                                                                                 | Строка не более 255 символов                   | нет                      | нет               | нет                     |
|**fax**                |Номер факса                                                                                               | Строка не более 255 символов                   | нет                      | нет               | нет                     |
|**actualAddress**      |Фактический адрес Контрагента                                                                             | Строка не более 255 символов                   | нет                      | нет               | нет                     |
|**actualAddressFull**  |Фактический адрес Контрагента с детализацией по отдельным полям                                           | Объект                                         | нет                      | нет               |нет                      |
|**accounts**           |Ссылка на счета Контрагента (массив)                                                                      | Массив объектов                                | нет                      | нет               | да                      |
|**companyType**        |Тип Контрагента. В зависимости от значения данного поля набор выводимых реквизитов контрагента может меняться. Подробнее [тут](../dictionaries/#suschnosti-kontragent-kontragenty-tip-kontragenta) | Строка не более 31 символа | нет | нет | да |
|**discountCardNumber** |Номер дисконтной карты Контрагента                                                                        | Строка не более 255 символов                   | нет                      | нет               | нет                     |
|**state**              |Статус Контрагента в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)              | Объект                                         | нет                      | нет               | да                      |
|**salesAmount**        |Сумма продаж                                                                                              | Целочисленный тип                              | нет                      | да                | да                      |
|**bonusProgram**       |Ссылка на активную Бонусную программу в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)  | Объект                                  | нет                      | да                | нет                     |
|**bonusPoints**        |Бонусные баллы по активной бонусной программе                                                             | Целочисленный тип                              | нет                      | да                | нет                     |                          
...
+ **discounts** - Массив ссылок на скидки в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye) `Только для чтения`
...
+ **notes** - Массив ссылок на события Контрагента в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)
...
+ **agent** - Ссылка на Контрагента (тип [Мета](../#mojsklad-json-api-obschie-swedeniq-metadannye))
...
+ **agent** - Ссылка на Контрагента (тип [Мета](../#mojsklad-json-api-obschie-swedeniq-metadannye)) `Только для чтения`
+ **author** - Создатель события, ссылка на сотрудника (тип [Мета](../#mojsklad-json-api-obschie-swedeniq-metadannye)) `Только для чтения`
