...
### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) о возврате предоплаты
...
+ **state** - Статус Возврата предоплаты в формате [Метаданных](#metadannye)
...
+ **retailShift** - Ссылка на Розничную смену, в рамках которой был проведен Возврат предоплаты в формате [Метаданных](#metadannye) `Необходимое`
+ **prepayment** - Ссылка на Предоплату в формате [Метаданных](#metadannye)
...
+ **attributes** - Массив объектов доп. полей Возвратов предоплат в формате [Метаданных](#metadannye)
