...
|**deleted**            |DateTime|Момент последнего удаления Выплаты денег |Только для чтения|да
...
|**sum**                |Int|Сумма Выплаты денегв установленной валюте|Только для чтения|нет
...
| **states**       | Массив статусов Выплат денегг|
