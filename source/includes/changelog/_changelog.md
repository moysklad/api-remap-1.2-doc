...
### 28-10-2024
#### Добавлена
- Ошибка [4003](../#mojsklad-json-api-oshibki-kody-oshibok-dlq-tochek-prodazh) при создании\изменении точки продаж productFolders содержит родительскую и её дочерние группы товаров одновременно
