...
### 10-06-2021
#### Исправлено
- При попытке создания сущности с `meta` без `href` возвращается ошибка 2028
- Добавлена новая ошибка [2028](https://dev.moysklad.ru/doc/api/remap/1.2/#mojsklad-json-api-oshibki-oshibki-formata)
