...
Также, как и при работе с [Позициями Заказа Покупателя](#заказ-покупателя-позиции-заказа-покупателя), можно создать как одну, так и несколько позиций в одном запросе.
