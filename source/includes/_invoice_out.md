...
|**deleted**            |DateTime|Момент последнего удаления Счета покупателю|Только для чтения|да
...
|**sum**                |Int|Сумма Счета в установленной валюте|Только для чтения|нет
...
|**payedSum**            |Int|Сумма входящих платежей по Счету покупателю |Только для чтения|нет
