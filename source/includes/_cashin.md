...
#### Атрибуты сущности
+ **meta** - [Метаданные](#metadannye) о Приходном ордере
...
+ **agent** - Ссылка на контрагента, юрлицо или сотрудника в формате [Метаданных](#metadannye) `Необходимое`
+ **contract** - Ссылка на договор в формате [Метаданных](#metadannye)
+ **state** - Статус Приходного ордера в формате [Метаданных](#metadannye)
...
+ **factureOut** - Ссылка на Счет-фактура выданный, с которым связан этот Приходный ордер, в формате [Метаданных](#metadannye)
+ **operations** - Массив ссылок на связанные операции в формате [Метаданных](#metadannye)
...
О работе с доп. полями Приходных ордеров можно прочитать [здесь](#rabota-s-dopolnitel-nymi-polyami)
...
+ **name** - номер Приходного ордера
+ **organization** - Ссылка на ваше орлицо в формате [Метаданных](#metadannye)
...
[Массовое создание и обновление](#sozdanie-i-obnovlenie-neskol-kih-ob#ektov) Приходных ордеров.
...
+ **attributes** - Массив объектов доп. полей Приходных ордеров в формате [Метаданных](#metadannye)
...
помечены `Только для чтения` в описании [атрибутов Приходного ордера](#prihodnyj-order-prihodnye-ordera).
