...
|**id**                 |UUID|ID Приходного ордер|Только для чтения|да
|**accountId**          |UUID| ID учетной записи|Только для чтения|да
|**syncId**             |UUID|ID синхронизации. После заполнения недоступен для изменения|---|нет
|**updated**            |DateTime|Момент последнего обновления Приходного ордер|Только для чтения|да
|**deleted**            |DateTime|Момент последнего удаления Приходного ордер|Только для чтения|да
|**name**               |String(255)|Наименование Приходного ордер|---|да
|**description**        |String(4096)|Комментарий Приходного ордер|---|нет
|**externalCode**       |String(255)|Внешний код Приходного ордер|---| да
