...
+ **name** - номер Счета-фактуры выданного
+ **description** - Комментарий Счета-фактуры выданного
+ **externalCode** - Внешний код Счета-фактуры выданного
+ **moment** - Дата Счета-фактуры выданного
+ **applicable** - Отметка о проведении
+ **sum** - Сумма Счета-фактуры выданного в установленной валюте `Только для чтения`
+ **rate** - Валюта
...
+ **state** - Статус Счета-фактуры выданного в формате [Метаданных](../#mojsklad-json-api-obschie-swedeniq-metadannye)
