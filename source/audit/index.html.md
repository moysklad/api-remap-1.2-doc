...
<div class="banner">
  ...
  <ui><b>До 1 декабря 2023 года необходимо:</b>
    ...
    <li>Включить использование <a href='https://dev.moysklad.ru/doc/api/remap/1.2/#mojsklad-json-api-obschie-swedeniq-szhatie-soderzhimogo-zaprosow'>сжатия содержимого ответов</a> через передачу заголовка Accept-Encoding</li>
  </ui>
