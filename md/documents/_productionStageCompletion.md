...
| **applicable**           | Boolean                         |                            | Отметка о проведении<br>`+Обязательное при ответе` `+Только для чтения`                                                                                                                           |
...
Изменение типа расчета оплаты труда доступно только в том случае, если в [Производственном этапе](#/documents/productionTask#3-proizvodstvennye-etapy) был ранее установлен признак расчета по нормо-часам (флаг enableHourAccounting=true). 
...
Условие создания Выполненного этапа - наличие начала производства у Производственного задания для которого создается Выполненный этап. Подробнее можно прочитать [тут](#/documents/productionTask#2-proizvodstvennoe-zadanie).
...
+ **productionStage** - Ссылка на Производственный этап в формате [Метаданных](#/general#3-metadannye)
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Выполнений этапов производства.
...
Материалы Выполнения этапа производства - это товары, модификации и партии, затраченные при выполнении этапа производства.
...
| -------------------- |:---------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **accountId**        | UUID                                                     | ID учетной записи<br>`+Обязательное при ответе` `+Только для чтения`                                                                                                                                                                                          |
| **assortment**       | [Meta](#/general#3-metadannye)| Метаданные товара/модификации/партии, которую представляет собой позиция<br>`+Обязательное при ответе` `+Expand`                                                                                                                                               |
...
Продукты Выполнения этапа производства - это товары, модификации и партии, созданные при выполнении этапа производства.
...
Изменять товар / модификацию нельзя, но можно изменить партию товара.
