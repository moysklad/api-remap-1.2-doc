...
| **description**  | String(4096)                          | `=` `!=` `~` `~=` `=~`                                                                                                                            | Комментарий Инвентаризации<br>`+Change-handler`                                                                                            |
...
| **name**         | String(255)                           | `=` `!=` `~` `~=` `=~`                                                                                                                            | Наименование Инвентаризации<br>`+Обязательное при ответе` `+Change-handler`                                                                |
...
| **state**        | [Meta](#/general#3-metadannye)        | `=` `!=`                                                                                                                                          | Метаданные статуса Инвентаризации<br>`+Expand` `+Change-handler`                                                                           |
