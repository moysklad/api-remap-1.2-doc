...
| **description**  | String(4096)                          | `=` `!=` `~` `~=` `=~`                                                                                                                            | Комментарий Инвентаризации<br>`+Change-handler` `+Update-provider`                                                                         |
| **externalCode** | String(255)                           | `=` `!=` `~` `~=` `=~`                                                                                                                            | Внешний код Инвентаризации<br>`+Обязательное при ответе` `+Change-handler`                                                                 |
...
| **id**           | UUID                                  | `=` `!=`                                                                                                                                          | ID Инвентаризации<br>`+Обязательное при ответе` `+Только для чтения` `+Change-handler`                                                     |
| **meta**         | [Meta](#/general#3-metadannye)        |                                                                                                                                                   | Метаданные Инвентаризации<br>`+Обязательное при ответе` `+Change-handler`                                                                  |
| **moment**       | DateTime                              | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Дата документа<br>`+Обязательное при ответе` `+Change-handler` `+Update-provider`                                                          |
| **name**         | String(255)                           | `=` `!=` `~` `~=` `=~`                                                                                                                            | Наименование Инвентаризации<br>`+Обязательное при ответе` `+Change-handler` `+Update-provider`                                             |
...
| **positions**    | MetaArray                             |                                                                                                                                                   | Метаданные позиций Инвентаризации<br>`+Обязательное при ответе` `+Expand` `+Change-handler`                                                |
| **printed**      | Boolean                               | `=` `!=`                                                                                                                                          | Напечатан ли документ<br>`+Обязательное при ответе` `+Только для чтения`                                                                   |
| **published**    | Boolean                               | `=` `!=`                                                                                                                                          | Опубликован ли документ<br>`+Обязательное при ответе` `+Только для чтения`                                                                 |
| **shared**       | Boolean                               | `=` `!=`                                                                                                                                          | Общий доступ<br>`+Обязательное при ответе`                                                                                                 |
| **state**        | [Meta](#/general#3-metadannye)        | `=` `!=`                                                                                                                                          | Метаданные статуса Инвентаризации<br>`+Expand` `+Change-handler` `+Update-provider`                                                        |
...
| **sum**          | Float                                 | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Сумма Инвентаризации в копейках<br>`+Обязательное при ответе` `+Только для чтения` `+Change-handler`                                       |
| **syncId**       | UUID                                  | `=` `!=`                                                                                                                                          | ID синхронизации. После заполнения недоступен для изменения                                                                                |
| **updated**      | DateTime                              | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Момент последнего обновления Инвентаризации<br>`+Обязательное при ответе` `+Только для чтения` `+Change-handler`                           |

#### Связи с другими документами

| Название                       | Описание                                                                                                                      |
| ------------------------------ | :---------------------------------------------------------------------------------------------------------------------------- |
| **enters**                     | Ссылка на связанное с инвентаризацией оприходование в формате [Метаданных](#/general#3-metadannye)     |
| **losses**                     | Ссылка на связанное с инвентаризацией списание в формате [Метаданных](#/general#3-metadannye)     |

#### Позиции Инвентаризации
Позиции Инвентаризации - это список товаров/модификаций/партий.
...
С позициями можно работать с помощью [специальных ресурсов для управления позициями Инвентаризации](#/documents/inventory#3-upravlenie-poziciyami-inventarizacii),
...
О работе с доп. полями Инвентаризации можно прочитать [здесь](#/general#3-rabota-s-dopolnitelnymi-polyami)
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Инвентаризаций.
...
| **attributes**                 | Массив объектов доп. полей Инвентаризацийв формате [Метаданных](#/general#3-metadannye) |
...
### Управление позициями Инвентаризации 
...
+ **assortment** - Ссылка на товар/партию/модификацию, которую представляет собой позиция.
  Подробнее об этом поле можно прочитать в описании [позиции Инвентаризации](#/documents/inventory#4-pozicii-inventarizacii)
...
#### Запросы - Пересчет расчетного остатка в инвентаризации
