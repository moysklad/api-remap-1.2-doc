...
| **meta**         | [Meta](#/general#3-metadannye)        |                                                                                                                                                   | Метаданные Инвентаризации<br>`+Обязательное при ответе`                                                                                    |
| **moment**       | DateTime                              | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Дата документа<br>`+Обязательное при ответе`                                                                                               |
| **name**         | String(255)                           | `=` `!=` `~` `~=` `=~`                                                                                                                            | Наименование Инвентаризации<br>`+Обязательное при ответе`                                                                                  |
...
| **state**        | [Meta](#/general#3-metadannye)        | `=` `!=`                                                                                                                                          | Метаданные статуса Инвентаризации<br>`+Expand`                                                                                             |
| **store**        | [Meta](#/general#3-metadannye)        | `=` `!=`                                                                                                                                          | Метаданные склада<br>`+Обязательное при ответе` `+Expand` `+Необходимо при создании`                                                       |
| **sum**          | Float                                 | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Сумма Инвентаризации в копейках<br>`+Обязательное при ответе` `+Только для чтения`                                                         |
