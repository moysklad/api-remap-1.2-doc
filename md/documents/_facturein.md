...
| **code**         | String(255)                            | `=` `!=` `~` `~=` `=~`                                                                                                                            | Код Счета-фактуры полученного                                                                                                                 |
...
| **description**  | String(4096)                           | `=` `!=` `~` `~=` `=~`                                                                                                                            | Комментарий Счета-фактуры полученного                                                                                                         |
| **externalCode** | String(255)                            | `=` `!=` `~` `~=` `=~`                                                                                                                            | Внешний код Счета-фактуры полученного<br>`+Обязательное при ответе`                                                                           |
...
| **meta**         | [Meta](#/general#3-metadannye)         |                                                                                                                                                   | Метаданные Счета-фактуры полученного<br>`+Обязательное при ответе`                                                                            |
| **moment**       | DateTime                               | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Дата документа<br>`+Обязательное при ответе`                                                                                                  |
| **name**         | String(255)                            | `=` `!=` `~` `~=` `=~`                                                                                                                            | Наименование Счета-фактуры полученного<br>`+Обязательное при ответе`                                                                          |
...
| **state**        | [Meta](#/general#3-metadannye)         | `=` `!=`                                                                                                                                          | Метаданные статуса Счета-фактуры полученного<br>`+Expand`                                                                                     |
| **sum**          | Float                                  | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Сумма Счета-фактуры полученного в установленной валюте<br>`+Обязательное при ответе` `+Только для чтения`                                     |
...
| **payments**                   | Массив ссылок на связанные исходящие платежи в формате [Метаданных](#/general#3-metadannye) |
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Счетов-фактур полученных.
...
| **attributes**                 | Массив объектов доп. полей Счетов-фактур полученных в формате [Метаданных](#/general#3-metadannye) |
...
### Запросы - Счет-фактура полученный
