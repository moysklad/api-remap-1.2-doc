...
| **shipmentAddressFull**   | Object                         |                                                                                                                                                   | Адрес доставки Заказа покупателя с детализацией по отдельным полям. [Подробнее тут](#/documents/customerOrder#4-atributy-sushnosti-adres-dostavki)<br>`+Change-handler` |
