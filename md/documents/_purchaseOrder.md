...
| **meta**                  | [Meta](#/general#3-metadannye)                            |                                                                                                                                                   | Метаданные Заказа поставщику<br>`+Обязательное при ответе`                                                                                    |
...
| **state**                 | [Meta](#/general#3-metadannye)                            | `=` `!=`                                                                                                                                          | Метаданные статуса заказа<br>`+Expand`                                                                                                        |
| **store**                 | [Meta](#/general#3-metadannye)                            | `=` `!=`                                                                                                                                          | Метаданные склада<br>`+Expand`                                                                                                                |
| **sum**                   | Float                                                     | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Сумма Заказа поставщику в установленной валюте<br>`+Только для чтения`                                                                        |
