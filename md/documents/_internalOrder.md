...
| **deliveryPlannedMoment** | DateTime                                                  |                                                                                                                                                   | Планируемая дата приемки<br>`+Change-handler`                                                                                                   |
| **description**           | String(4096)                                              | `=` `!=` `~` `~=` `=~`                                                                                                                            | Комментарий Внутреннего заказа<br>`+Change-handler`                                                                                             |
...
| **name**                  | String(255)                                               | `=` `!=` `~` `~=` `=~`                                                                                                                            | Наименование Внутреннего заказа<br>`+Обязательное при ответе` `+Необходимо при создании` `+Change-handler`                                      |
...
| **positions**             | MetaArray                                                 |                                                                                                                                                   | Метаданные позиций Внутреннего заказа<br>`+Обязательное при ответе` `+Только для чтения` `+Expand` `+Change-handler`                            |
...
| **state**                 | [Meta](#/general#3-metadannye)                            | `=` `!=`                                                                                                                                          | Метаданные статуса Внутреннего заказа<br>`+Expand` `+Change-handler`                                                                            |
