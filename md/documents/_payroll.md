...
| **startPayrollPeriod** | DateTime                       | Начало расчётного периода, за который начисляется зарплата. *Разница начала и окончания расчётного периода должна быть кратна 24 часам*<br>`+Обязательное при ответе` `+Необходимо при создании` `+Update-provider`    |
| **endPayrollPeriod**   | DateTime                       | Окончание расчётного периода, за который начисляется зарплата. *Разница начала и окончания расчётного периода должна быть кратна 24 часам*<br>`+Обязательное при ответе` `+Необходимо при создании` `+Update-provider` |
