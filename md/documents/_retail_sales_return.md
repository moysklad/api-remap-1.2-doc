...
| **demand**              | [Meta](#/general#3-metadannye)                             |                                                                                                                                                   | Метаданные связанной Розничной продажи<br>`+Expand`                                                                                                           |
...
| **meta**                | [Meta](#/general#3-metadannye)                             |                                                                                                                                                   | Метаданные Розничного возврата<br>`+Обязательное при ответе`                                                                                                  |
...
| **organizationBranch**  | [Meta](#/general#3-metadannye)                             | `=` `!=`                                                                                                                                          | Метаданные подразделения юрлица<br>`+Expand` `+Только для чтения`                                                                          |
...
| **state**               | [Meta](#/general#3-metadannye)                             | `=` `!=`                                                                                                                                          | Метаданные статуса Розничного возврата<br>`+Expand`                                                                                                           |
| **store**               | [Meta](#/general#3-metadannye)                             | `=` `!=`                                                                                                                                          | Метаданные склада<br>`+Обязательное при ответе` `+Expand` `+Необходимо при создании`                                                                          |
| **sum**                 | Float                                                      | `=` `!=` `<` `>` `<=` `>=`                                                                                                                        | Сумма Розничного возврата в копейках<br>`+Обязательное при ответе` `+Только для чтения`                                                                       |
| **syncId**              | UUID                                                       | `=` `!=`                                                                                                                                          | ID синхронизации. После заполнения недоступен для изменения                                                                                                   |
| **taxSystem**           | Enum                                                       |                                                                                                                                                   | Код системы налогообложения. [Подробнее тут](#/documents/retail-sales-return#5-kod-sistemy-nalogooblozheniya) |
...
Позиции Розничного возврата - это список товаров/услуг/модификаций/партий/комплектов.
...
С позициями можно работать с помощью специальных [ресурсов для управления позициями Розничного возврата](#/documents/retail-sales-return#3-upravlenie-poziciyami-roznichnogo-vozvrata),
...
О работе с доп. полями Розничных возвратов можно прочитать [здесь](#/general#3-rabota-s-dopolnitelnymi-polyami)
...
+ **demand** - Ссылка на Розничную продажу, по которой произошел возврат в формате [Метаданных](#/general#3-metadannye), обязательное поле только для возврата на основании
+ **retailStore** - Ссылка на точку продаж в формате [Метаданных](#/general#3-metadannye)
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Розничных возвратов.
...
| **attributes**                 | Массив объектов доп. полей Розничных возвратов в формате [Метаданных](#/general#3-metadannye) |
...
помечены `Только для чтения` в описании [атрибутов Розничного возврата](#/documents/retail-sales-return#2-roznichnyj-vozvrat).
...
### Управление позициями Розничного возврата 
...
+ **assortment** - Ссылка на товар/услугу/партию/модификацию, которую представляет собой позиция.
  Подробнее об этом поле можно прочитать в описании [позиции Розничного возврата](#/documents/retail-sales-return#4-pozicii-roznichnogo-vozvrata).
