...
| **organization**        | [Meta](#/general#3-metadannye) | `=` `!=`                                                               | Метаданные юрлица<br>`+Обязательное при ответе` `+Expand` `+Только для чтения`                                                           |
...
Позиции Розничной продажи - это список товаров/услуг/модификаций/партий/комплектов.
...
Объект фискального чека Розничной продажи содержит следующие поля:
...
| **time**            | DateTime                                                    | Время фискализации           |
  ...
  "rows": [
    {
      ...
      "cheque": {
        "fnNumber": "110011",
        "fiscalDocSign": "1122330002",
        "fiscalDocNumber": "22222222222",
        "kktRegNumber": "000001",
        "time": "2025-06-01 22:04:35.000"
      }
    },
    {
      "meta": {
...
### Управление позициями Розничной продажи 
