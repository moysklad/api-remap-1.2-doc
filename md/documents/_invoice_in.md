...
| **incomingNumber**       | String(255)                            | `=` `!=` `~` `~=` `=~`                                                                                                                            | Входящий номер<br>`+Change-handler`                                                                                                           |
| **meta**                 | [Meta](#/general#3-metadannye)   |                                                                                                                                                   | Метаданные Счета поставщика<br>`+Обязательное при ответе` `+Change-handler`                                                                   |
...
| **supplies**                   | Ссылки на связанные приемки в формате [Метаданных](#/general#3-metadannye)                             |

#### Позиции Счета поставщика
Позиции Счета - это список товаров/услуг/модификаций/партий.
...
О работе с доп. полями Счетов поставщиков можно прочитать [здесь](#/general#3-rabota-s-dopolnitelnymi-polyami)
...
| **agent**                      | Ссылка на контрагента (поставщика) в формате [Метаданных](#/general#3-metadannye) |
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Счетов поставщика.
...
| **attributes**                 | Массив объектов доп. полей Счетов поставщиков в формате [Метаданных](#/general#3-metadannye) |
...
помечены `Только для чтения` в описании [атрибутов Счета поставщика](#/documents/invoice-in#2-schet-postavshika).
...
### Управление позициями Счета поставщика 
...
+ **assortment** - Ссылка на товар/услугу/партию/модификацию, которую представляет собой позиция.
  Подробнее об этом поле можно прочитать в описании [позиции Счета](#/documents/invoice-in#4-pozicii-scheta-postavshika)
