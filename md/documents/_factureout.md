...
| **agent**           | [Meta](#/general#3-metadannye) | `=` `!=`                                                               | Метаданные контрагента<br>`+Обязательное при ответе` `+Expand`                                                                           |
...
| **code**            | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Код Счета-фактуры выданного                                                                                                              |
| **contract**        | [Meta](#/general#3-metadannye) | `=` `!=`                                                               | Метаданные договора<br>`+Expand`                                                                                                         |
| **created**         | DateTime                       | `=` `!=` `<` `>` `<=` `>=`                                             | Дата создания<br>`+Обязательное при ответе` `+Только для чтения`                                                                         |
| **deleted**         | DateTime                       | `=` `!=` `<` `>` `<=` `>=`                                             | Момент последнего удаления Счета-фактуры выданного<br>`+Только для чтения`                                                               |
| **description**     | String(4096)                   | `=` `!=` `~` `~=` `=~`                                                 | Комментарий Счета-фактуры выданного                                                                                                      |
| **externalCode**    | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Внешний код Счета-фактуры выданного<br>`+Обязательное при ответе`                                                                        |
...
| **id**              | UUID                           | `=` `!=`                                                               | ID Счета-фактуры выданного<br>`+Обязательное при ответе` `+Только для чтения`                                                            |
| **meta**            | [Meta](#/general#3-metadannye) |                                                                        | Метаданные Счета-фактуры выданного<br>`+Обязательное при ответе`                                                                         |
| **moment**          | DateTime                       | `=` `!=` `<` `>` `<=` `>=`                                             | Дата документа<br>`+Обязательное при ответе`                                                                                             |
| **name**            | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Наименование Счета-фактуры выданного<br>`+Обязательное при ответе`                                                                       |
...
| **state**           | [Meta](#/general#3-metadannye) | `=` `!=`                                                               | Метаданные статуса Счета-фактуры выданного<br>`+Expand`                                                                                  |
...
| **payments**                   | Массив ссылок на связанные входящие платежи в формате [Метаданных](#/general#3-metadannye)     |
...
- Для счетов-фактур с основаниями-платежами (например, CashIn, PaymentIn) можно передавать и обновлять поля **advancePaymentVat** и **paymentPurpose**. Поля **advancePaymentVat**, **paymentPurpose** и **vatSum** возвращаются в ответе только если у счета-фактуры есть связанные платежи.
...
- Валидация **advancePaymentVat**: значение должно быть неотрицательным (ошибка [3002](../#mojsklad-json-api-oshibki-error_3002)), не превышать 100 (ошибка [3008](../#mojsklad-json-api-oshibki-error_3008)), ставка должна существовать в справочнике ставок НДС (ошибка [3005](../#mojsklad-json-api-oshibki-error_3005)).
...
> Пример создания Счета-фактуры выданной на аванс на основании входящего платежа.
```shell
  curl -X POST
...
| **attributes**                 | Массив объектов доп. полей Счетов-фактур выданных в формате [Метаданных](#/general#3-metadannye) |
