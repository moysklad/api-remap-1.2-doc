...
Аналогично [товару](#/dictionaries/product#3-poluchit-tovar): при указании UUID из интерфейса вместо API ID сервер вернёт редирект **308** с заголовком `Location` на URL `.../entity/product/{apiId}/images`.
