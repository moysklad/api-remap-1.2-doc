...
### Площадки для продаж
Средствами JSON API можно просматривать сведения о Площадках для продаж, запрашивать списки Площадок для продаж и сведения по отдельным Площадкам для продаж. Кодом сущности для Площадки для продаж в составе JSON API является ключевое слово saleplatform. Подробнее можно узнать по ссылке.
...
| **salePlatformGroup**         | Enum                                                      | `=` `!=`                    | Группа площадок для продаж [Подробнее тут](#/dictionaries/saleplatform#4-gruppa-ploshchadok-dlya-prodazh)<br>`+Обязательное при ответе` |
...
| **OFFLINE_STORES**             | Оффлайн-магазины  |
