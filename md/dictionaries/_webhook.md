...
Кодом сущности для Вебхуков в составе JSON API является ключевое слово **webhook**.
...
* `webhook`
* `discount`
* `notes` - специальный ресурс внутри документов, подробнее прочитать про [Ленту событий](#/dictionaries/eventfeed#2-lenta-sobytij).
