...
> **Важно:** у организации, передаваемой в поле `organization` при создании и обновлении точки продаж, **основной расчётный счёт** должен быть в **валюте учёта** компании. Иначе API вернёт ошибку [4004](#/errors#3-kody-oshibok-dlya-tochek-prodazh).
