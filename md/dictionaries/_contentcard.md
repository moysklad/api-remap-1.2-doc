...
| Значение              | Описание                                                                                                           | Фильтрация | Примечание                                                              |
|-----------------------|:-------------------------------------------------------------------------------------------------------------------|--------|-------------------------------------------------------------------------|
| **salesChannels**         | Массив ссылок на связанные каналы продаж в формате [Метаданных](#/general#3-metadannye). Максимальное число - 1000<br>`+Expand` `+Обязательное при ответе` | `=`    | Для фильтрации нужно указать атрибут в единственном числе: salesChannel |
