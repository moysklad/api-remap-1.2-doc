...
Кодом сущности для Техпроцессов в составе JSON API является ключевое слово **processingprocess**. Больше о Техпроцессах и работе с ними в основном интерфейсе вы можете прочитать в нашей службе поддержки по [этой ссылке](https://support.moysklad.ru/hc/ru/%D0%BF%D1%80%D0%BE%D0%B8%D0%B7%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE/%D0%BF%D1%80%D0%BE%D1%86%D0%B5%D1%81%D1%81%20%D0%BF%D1%80%D0%BE%D0%B8%D0%B7%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0/%D1%82%D0%B5%D1%85%D0%BF%D1%80%D0%BE%D1%86%D0%B5%D1%81%D1%81%D1%8B_%D0%B8_%D1%8D%D1%82%D0%B0%D0%BF%D1%8B).
...
| **meta**         | [Meta](#/general#3-metadannye) |                            | Метаданные Техпроцесса<br>`+Обязательное при ответе` `+Только для чтения`                            |
...
| **meta**            | [Meta](#/general#3-metadannye) | Метаданные позиции Техпроцесса<br>`+Обязательное при ответе` `+Только для чтения`                                       |
| **processingstage** | [Meta](#/dictionaries/processingstage#2-etap-proizvodstva)    | Метаданные этапа, который представляет собой позиция<br>`+Обязательное при ответе` `+Необходимо при создании` `+Expand` |
...
+ **positions** - Ссылки на позиции Техпроцесса в формате [Метаданных](#/general#3-metadannye)
...
большим количеством позиций можно прочитать на примере работы с позициями документов [тут](#/general#3-rabota-s-poziciyami-dokumentov).
...
При [массовом создании и обновлении](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Техпроцессов в теле запроса нужно передать массив, 
содержащий JSON представления Техпроцессов, которые вы хотите создать или обновить. Идентификатором у обновляемых Техпроцессов является [Meta](#/general#3-metadannye).
