...
| **archived**     | Boolean                        | `=` `!=`                                                               | Добавлена ли партия в архив<br>`+Обязательное при ответе`                                                                                                   |
| **attributes**   | Array(Object)                  | [Операторы доп. полей](#/general#4-filtraciya-po-dopolnitelnym-polyam) | Коллекция доп. полей Партии                                                                                                                                 |
...
| **barcodes**     | Array(Object)                  | `=` `!=` `~` `~=` `=~`                                                 | Штрихкоды партии  . Для фильтрации по полю необходимо указывать его в единственном числе **barcode**.                                                       |
| **code**         | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Код Партии                                                                                                                                                  |
| **description**  | String(4096)                   | `=` `!=` `~` `~=` `=~`                                                 | Описание Партии                                                                                                                                             |
| **expiryDate**   | DateTime                       | `=` `!=` `<` `>` `<=` `>=`                                             | Срок годности Партии<br>`+Необходимо при создании`                                                                                                          |
| **externalCode** | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Внешний код Партии<br>`+Обязательное при ответе`                                                                                                            |
| **id**           | UUID                           | `=` `!=`                                                               | ID Партии<br>`+Обязательное при ответе` `+Только для чтения`                                                                                                |
| **images**       | MetaArray |                                                                        | Массив метаданных [Изображений](#/dictionaries/images#2-izobrazhenie) товара, к которому относится данная партия (Максимальное количество изображений - 10) <br>`+Только для чтения` |
| **label**        | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Метка Партии<br>`+Необходимо при создании`                                                                                                                  |
| **meta**         | [Meta](#/general#3-metadannye) |                                                                        | Метаданные Партии<br>`+Обязательное при ответе`                                                                                                             |
| **name**         | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Наименование Партии. "Собирается" и отображается как "Наименование товара / Метка Партии"<br>`+Обязательное при ответе` `+Только для чтения`                |
...
> Response 200 (application/json) Успешное удаление Партии.
```json
