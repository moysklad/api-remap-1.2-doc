...
| **images**       | MetaArray |                                                                        | Массив метаданных [Изображений](#/dictionaries/images#2-izobrazhenie) товара, к которому относится данная серия (Максимальное количество изображений - 10) `+Только для чтения`  |
