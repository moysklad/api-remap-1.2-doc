...
| **reportUrl**     | String(255)                                               | URL на получения данных по [изменившейся номенклатуре за указанный период](#/reports/report-stock#3-kratkij-otchet-ob-ostatkah)<br>`+Обязательное при ответе`    |
...
|------------------------| :-------------------------------------------------------- |:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **accountId**          | UUID                                                      | ID учетной записи<br>`+Обязательное при ответе`                                                                                                                                                                                                                                                                    |
| **authorApplication**  | [Meta](#/general#3-metadannye) | Метаданные Решения, создавшего вебхук на изменение остатков<br>`+Только для чтения`                                                                                                                                                                                                                                                |
...
| **meta**               | [Meta](#/general#3-metadannye) | Метаданные вебхука на изменение остатков<br>`+Обязательное при ответе`                                                                                                                                                                                                                                            |
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) вебхуков на изменение остатков.
