...
- **`search`** — не часть фильтра, он является отдельным параметром, как у всех сущностей. Подробнее описание работы параметра можно узнать по [ссылке](#/general#3-kontekstnyj-poisk).
