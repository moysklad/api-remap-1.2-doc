...
| **meta**     | [Meta](#/general#3-metadannye) | Метаданные характеристики<br>`+Обязательное при ответе` `+Только для чтения`                                                         |
...
[Массовое создание](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Характеристик.
