...
| **alcoholic**            | Object                                                    |                                                                                                                                                   | Объект, содержащий поля алкогольной продукции. [Подробнее тут](#/dictionaries/product#5-obuekt-soderzhashij-polya-alkogolnoj-produkcii)                                                                  |
...
| **barcodes**             | Array(Object)                                             | `=` `!=` `~` `~=` `=~`                                                                                                                            | Штрихкоды Товаров. [Подробнее тут](#/dictionaries/product#5-shtrihkody). Для фильтрации по полю необходимо указывать его в единственном числе **barcode**.                                                |
| **buyPrice**             | Object                                                    |                                                                                                                                                   | Закупочная цена. [Подробнее тут](#/dictionaries/product#5-zakupochnaya-cena)                                                                                                                               |
...
| **images**               | MetaArray                                                 |                                                                                                                                                   | Массив метаданных [Изображений](#/dictionaries/images#2-izobrazhenie) (Максимальное количество изображений - 10)<br>`+Expand`                                                                                                                         |
...
| **packs**                | Array(Object)                                             |                                                                                                                                                   | фасовки Товара. [Подробнее тут](#/dictionaries/product#5-fasovki-tovara)                                                                                                                                |
...
| **paymentItemType**      | Enum                                                      |                                                                                                                                                   | Признак предмета расчета. [Подробнее тут](#/dictionaries/product#5-priznak-predmeta-rascheta)                                                                                                                         |
| **ppeType**              | Enum                                                      |                                                                                                                                                   | Код вида номенклатурной классификации медицинских средств индивидуальной защиты (EAN-13). [Подробнее тут](#/dictionaries/product#5-kod-vida-nomenklaturnoj-klassifikacii-medicinskih-sredstv-individualnoj-zashity) |
| **productFolder**        | [Meta](#/general#3-metadannye) |                                                                                                                                                   | Метаданные группы Товара<br>`+Expand`                                                                                                                                                                                                                     |
| **salePrices**           | Array(Object)                                             |                                                                                                                                                   | Цены продажи. [Подробнее тут](#/dictionaries/product#5-ceny-prodazhi)                                                                                                                                     |
| **shared**               | Boolean                                                   | `=` `!=`                                                                                                                                          | Общий доступ<br>`+Обязательное при ответе`                                                                                                                                                                                                                |
| **supplier**             | [Meta](#/general#3-metadannye) | `=` `!=`                                                                                                                                          | Метаданные контрагента-поставщика<br>`+Expand`                                                                                                                                                                                                            |
...
| **trackingType**         | Enum                                                      |                                                                                                                                                   | Тип маркируемой продукции. [Подробнее тут](#/dictionaries/product#5-tip-markiruemoj-produkcii)                                                                                                                        |
...
| Название     | Тип                                                       | Описание                                                                                                                                                                                                                                        |
| ------------ | :-------------------------------------------------------- |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **barcodes** | Array(Object)                                             | Массив штрихкодов фасовок товаров. Данный массив может содержать не более одного штрихкода. Если штрихкод в массиве отсутствует, то данное поле не выводится. |
| **id**       | UUID                                                      | ID фасовки товара<br>`+Обязательное при ответе` `+Только для чтения`                                                                                                                                                                           |
| **quantity** | Float                                                     | Количество Товаров в фасовке данного вида<br>`+Обязательное при ответе`                                                                                                                                              |
| **uom**      | [Meta](#/general#3-metadannye) | Метаданные единиц измерения<br>`+Обязательное при ответе` `+Expand`                                                                                                                                                                             |

В версии API 1.2 был удален отдельный ресурс для работы с фасовками товаров. Теперь фасовки - вложенная коллекция.
Для того, чтобы создать новую фасовку для данного товара, нужно в запросе на обновление товара указать ее как элемент
поля **packs**, а в ее составе указать ссылку в формате meta на единицу измерения и количество товаров в фасовке.
Для фасовки товара нельзя указать ссылку на единицу измерения, совпадающую с единицей измерения товара, иначе возникнет ошибка.
При обновлении штрихкодов фасовки в рамках обновления товара, переданная коллекция штрихкодов фасовки полностью заменяет имеющуюся до этого 
коллекцию.
Для обновления списка фасовок товара, необходимо в рамках обновления товара передать новую коллекцию фасовок. Новая коллекия фасовок товара
...
| **attributes**   | Array(Object) | Коллекция всех существующих доп. полей Товаров в формате [Метаданных](#/general#3-metadannye)<br>`+Обязательное при ответе` |
...
О работе с доп. полями Товаров можно прочитать [здесь](#/general#3-rabota-s-dopolnitelnymi-polyami)
...
| Название | Тип                                                       | Описание                                                                          |
| -------- | :-------------------------------------------------------- | :-------------------------------------------------------------------------------- |
| **meta** | [Meta](#/general#3-metadannye) | Метаданные, содержащие ссылку на группу поставщика.<br>`+Обязательное при ответе` |

Тип поставщика - Контрагент. Описание сущности Контрагент вы можете посмотреть [здесь](#/dictionaries/counterparty#2-kontragent)
...
<h4>Загрузка</h4>
Для загрузки изображений нужно в теле запроса на [создание](#/dictionaries/product#3-sozdat-tovar) или [обновление](#/dictionaries/product#3-izmenit-tovar) товара
...
| Название | Тип                                                       | Описание                                                                      |
| -------- | :-------------------------------------------------------- | :---------------------------------------------------------------------------- |
| **meta** | [Meta](#/general#3-metadannye) | Метаданные, содержащие ссылку на группу Товара.<br>`+Обязательное при ответе` |
...
```json
{
  ...
  "rows": [
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/26b36824-2c83-11e6-8a84-bae50000001b",
        "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/product/metadata",
        "type": "product",
        "mediaType": "application/json"
      },
      ...
      "images": {
        "meta": {
          "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/26b36824-2c83-11e6-8a84-bae50000001b/images",
          "type": "image",
          "mediaType": "application/json",
          "size": 0,
          "limit": 1000,
      ...
      "supplier": {
        "meta": {
          "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/6313d1e7-2c7f-11e6-8a84-bae500000051",
    ...
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/d950551c-2c7f-11e6-8a84-bae50000000b",
        "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/product/metadata",
        "type": "product",
        "mediaType": "application/json"
      },
      ...
      "images": {
        "meta": {
          "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/d950551c-2c7f-11e6-8a84-bae50000000b/images",
          "type": "image",
          "mediaType": "application/json",
          "size": 0,
          "limit": 1000,
      ...
      "packs": [
        {
          ...
          "uom": {
            "meta": {
              "href": "https://api.moysklad.ru/api/remap/1.2/entity/uom/c6b91d63-2c83-11e6-8a84-bae5000000a1",
              "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/uom/metadata",
              "type": "uom",
              "mediaType": "application/json"
            }
...
{
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/26b36824-2c83-11e6-8a84-bae50000031b",
        "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/product/metadata",
        "type": "product",
        "mediaType": "application/json"
      },
      ...
      "salePrices": [
        {
          ...
          "currency": {
            "meta": {
              "href": "https://api.moysklad.ru/api/remap/1.2/entity/currency/6314188d-2c7f-11e6-8a84-bae500000255",
              "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/currency/metadata",
              "type": "currency",
              "mediaType": "application/json"
            }
          ...
          "priceType": {
            "meta": {
              "href": "https://api.moysklad.ru/api/remap/1.2/context/companysettings/pricetype/672559f1-cbf3-11e1-9eb9-889ffa6f23fd",
              "type": "pricetype",
              "mediaType": "application/json"
            },
      ...
      "buyPrice": {
        ...
        "currency": {
          "meta": {
            "href": "https://api.moysklad.ru/api/remap/1.2/entity/currency/6314188d-2c7f-11e6-8a84-bae500002255",
            "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/currency/metadata",
            "type": "currency",
            "mediaType": "application/json"
          }
  ...
  curl --compressed -X POST \
    ...
    -H "Content-Type: application/json" \
      -d '{
            ...
            "supplier": {
              "meta": {
                "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/2b5095a4-296b-11e6-8a84-bae500000051",
                "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
                "type": "counterparty",
                "mediaType": "application/json"
              }
...
{
  "meta": {
    "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/a355f431-29a1-11e6-8a84-bae500000009",
    "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/product/metadata",
    "type": "product",
    "mediaType": "application/json"
  },
  ...
  "images": {
    "meta": {
      "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/a355f431-29a1-11e6-8a84-bae500000009/images",
      "type": "image",
      "mediaType": "application/json",
      "size": 0,
      "limit": 1000,
...
{
  "meta": {
    "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/04996e84-29a1-11e6-8a84-bae500000002",
    "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/product/metadata",
    "type": "product",
    "mediaType": "application/json"
  },
  ...
  "images": {
    "meta": {
      "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/04996e84-29a1-11e6-8a84-bae500000002/images",
      "type": "image",
      "mediaType": "application/json",
      "size": 0,
      "limit": 1000,
    ...
    -H "Content-Type: application/json" \
      -d '{
            ...
            "attributes": [
              ...
              {
                "meta": {
                  "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/metadata/attributes/0f1e750e-e1b2-11e7-9464-e4de00000003",
                  "type": "attributemetadata",
                  "mediaType": "application/json"
                },
...
```json
{
  ...
  "attributes": [
    ...
    },
    {
      ...
      "value": "filename",
      "download": {
        "href": "https://api.moysklad.ru/api/remap/1.2/download/00664f3a-e3da-11e7-9464-e4de00000000",
...
[
  ...
  },
  {
    ...
    "supplier": {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/6313f1eb-2c7f-11e6-8a84-bae500000053",
        "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
        "type": "counterparty",
        "mediaType": "application/json"
      }
    ...
    "packs": [
      {
        ...
        "uom": {
          "meta": {
            "href": "https://api.moysklad.ru/api/remap/1.2/entity/uom/2d1fdd55-d935-4d55-80d4-f6904b62ff46",
            "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/uom/metadata",
            "type": "uom",
            "mediaType": "application/json"
          }
...
{
  "meta": {
    "href": "https://api.moysklad.ru/api/remap/1.2/entity/product/metadata/attributes/3cd83619-5585-11e6-8a84-bae500000069",
    "type": "attributemetadata",
    "mediaType": "application/json"
  },
  "customEntityMeta": {
...
> Пример запроса на изменение Товара с фасовками.
