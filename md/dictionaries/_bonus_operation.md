...
| **agent**             | [Meta](#/general#3-metadannye) | `=` `!=`                   | Метаданные Контрагента, связанного с бонусной операцией<br>`+Обязательное при ответе` `+Expand` `+Необходимо при создании` |
| **applicable**        | Boolean                        | `=` `!=`                   | Отметка о проведении<br>`+Обязательное при ответе`                                                                         |
| **bonusProgram**      | [Meta](#/general#3-metadannye) | `=` `!=`                   | Метаданные бонусной программы<br>`+Expand`                                                                                 |
...
| **created**           | DateTime                       | `=` `!=` `<` `>` `<=` `>=` | Момент создания Бонусной операции<br>`+Обязательное при ответе` `+Только для чтения`                                       |
| **description**       | String(4096)                   | `=` `!=` `~` `~=` `=~`     | Комментарий к Бонусной операции                                                                                            |
...
| **meta**              | [Meta](#/general#3-metadannye) |                            | Метаданные Бонусной операции<br>`+Обязательное при ответе`                                                                 |
...
| **parentDocument**    | [Meta](#/general#3-metadannye) |                            | Метаданные связанного документа бонусной операции<br>`+Expand`                                                             |
...
| ------------------- | :-------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------- |
| **agent**           | [Meta](#/general#3-metadannye) | Метаданные Контрагента, связанного с бонусной операцией<br>`+Обязательное при ответе` `+Expand` `+Необходимо при создании` |
| **bonusProgram**    | [Meta](#/general#3-metadannye) | Метаданные Бонусной программы<br>`+Обязательное при ответе` `+Expand` `+Необходимо при создании`                           |
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Бонусных операций.
