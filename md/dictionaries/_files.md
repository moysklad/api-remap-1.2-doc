...
в разделе [Работа с Файлами Операции, Номенклатуры, Задачи или Контрагента с помощью специальных ресурсов] (#/dictionaries/files#2-fajly-rabota-s-fajlami-operacii-nomenklatury-zadachi-ili-kontragenta-s-pomosch-u-special-nyh-resursow).
...
| Название      | Тип                                | Описание                                                                            |
|---------------|:-----------------------------------|:------------------------------------------------------------------------------------|
| **created**   | DateTime                           | Время загрузки Файла на сервер<br>`+Обязательное при ответе` `+Только для чтения`   |
...
| **miniature** | [Meta](#/geneddral#3-metadansdnye) | Метаданные миниатюры изображения (поле передается только для Файлов изображений)    |
