 ...
 **Внимание**: Данный эндпоинт планируется к удалению в будущих версиях API. Рекомендуется переходить на [новый эндпоинт ассортимента](#/dictionaries/assortment#2-assortiment), который работает быстрее и активно развивается.
