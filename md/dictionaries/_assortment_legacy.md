...
**Внимание**: Данный эндпоинт в 2027 году будет постепенно выведен из эксплуатации. Рекомендуется переходить на [новый эндпоинт ассортимента](#/dictiossnaries/assortment#2-assortiment), который работает быстрее и активно развивается.
