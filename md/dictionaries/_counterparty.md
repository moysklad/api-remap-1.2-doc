...
| **accounts**           | MetaArray                      |                                                                        | Массив счетов Контрагентов. [Подробнее тут](#/dictionaries/counterparty#5-scheta-kontragentov)<br>`+Обязательное при ответе` `+Expand`                                                                                                  |
...
| **attributes**         | Array(Object)                  | [Операторы доп. полей](#/general#4-filtraciya-po-dopolnitelnym-polyam) | Массив метаданных доп. полей                                                                                                                                                                                                            |
| **bonusPoints**        | Int                            |                                                                        | Бонусные баллы по активной бонусной программе<br>`+Только для чтения`                                                                                                                                                                   |
| **bonusProgram**       | [Meta](#/general#3-metadannye) |                                                                        | Метаданные активной Бонусной программы<br>`+Expand`                                                                                                                                                                                     |
| **code**               | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Код Контрагента                                                                                                                                                                                                                         |
| **companyType**        | Enum                           | `=` `!=`                                                               | Тип Контрагента. В зависимости от значения данного поля набор выводимых реквизитов контрагента может меняться. [Подробнее тут](#/dictionaries/counterparty#4-tip-kontragenta)<br>`+Обязательное при ответе`                             |
| **contactpersons**     | MetaArray                      |                                                                        | Массив контактных лиц фирмы Контрагента. [Подробнее тут](#/dictionaries/counterparty#5-kontaktnye-lica-kontragentov)<br>`+Expand`                                                                                                       |
...
| **notes**              | MetaArray                      |                                                                        | Массив событий Контрагента. [Подробнее тут](#/dictionaries/counterparty#5-sobytiya-kontragenta)<br>`+Expand`                                                                                                                            |
| **owner**              | [Meta](#/general#3-metadannye) | `=` `!=`                                                               | Владелец (Сотрудник)<br>`+Expand`                                                                                                                                                                                                       |
| **phone**              | String(255)                    | `=` `!=` `~` `~=` `=~`                                                 | Номер городского телефона                                                                                                                                                                                                               |
| **priceType**          | Object                         | `=` `!=`                                                               | Тип цены Контрагента. [Подробнее тут](#/dictionaries/pricetypes#2-tipy-cen)                                                                                                                                                             |
| **salesAmount**        | Int                            |                                                                        | Сумма продаж<br>`+Обязательное при ответе` `+Только для чтения`                                                                                                                                                                         |
| **shared**             | Boolean                        | `=` `!=`                                                               | Общий доступ<br>`+Обязательное при ответе`                                                                                                                                                                                              |
| **state**              | [Meta](#/general#3-metadannye) | `=` `!=`                                                               | Метаданные Статуса Контрагента<br>`+Expand`                                                                                                                                                                                             |
...
| **mod\_\_requisites\_\_uz** | Object        |                        | Реквизиты Узбекистана. [Подробнее тут](#/dictionaries/counterparty#5-rekvizity-uzbekistana) <br>`+UZ`                                                                                                                     |
| **mod\_\_requisites\_\_kz** | Object        |                        | Реквизиты Казахстана. [Подробнее тут](#/dictionaries/counterparty#5-rekvizity-kazahstana) <br>`+KZ`                                                                                                                       |
| **ogrn**                    | String(255)   |                        | ОГРН <br>`+RU`                                                                                                                                                                                                                                                 |
| **ogrnip**                  | String(255)   |                        | ОГРНИП <br>`+RU`                                                                                                                                                                                                                                               |
| **okpo**                    | String(255)   |                        | ОКПО <br>`+RU`                                                                                                                                                                                                                                                 |
| **sex**                     | String(255)   |                        | Пол Контрагента. [Подробнее тут](#/dictionaries/counterparty#4-pol-kontragenta)                                                                                                                                                           |

Поля помеченные тегом региона (например, `+RU`, `+UZ`, `+KZ`) валидны только для типов юридического лица
...
Подробнее о типах юридических лиц [тут](#/dictionaries/counterparty#4-tip-kontragenta).
...
Формат вывода скидок можно посмотреть в разделе [Скидки](#/dictionaries/discount#2-skidki).
...
| **meta**                 | [Meta](#/general#3-metadannye) | Метаданные Счета Контрагента<br>`+Обязательное при ответе`                                  |
| **updated**              | DateTime                                                  | Момент последнего обновления Контрагента<br>`+Обязательное при ответе` `+Только для чтения` |
...
| **meta**         | [Meta](#/general#3-metadannye) | Метаданные Контактного лица Контрагента<br>`+Обязательное при ответе`           |
...
| --------------------- | :-------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------- |
| **accountId**         | UUID                                                      | ID учетной записи<br>`+Обязательное при ответе` `+Только для чтения`                                                                           |
| **agent**             | [Meta](#/general#3-metadannye) | Метаданные Контрагента<br>`+Обязательное при ответе` `+Только для чтения` `+Expand`                                                            |
| **author**            | [Meta](#/general#3-metadannye) | Метаданные Сотрудника - создателя события (администратор аккаунта, если автор - решение)<br>`+Обязательное при ответе` `+Только для чтения` |
| **authorApplication** | [Meta](#/general#3-metadannye) | Метаданные Решения - создателя события<br>`+Только для чтения`                                                                              |
...
| **meta**              | [Meta](#/general#3-metadannye) | Метаданные событий контрагента<br>`+Обязательное при ответе`                                                                                   |
...
##### Реквизиты Казахстана

| Название                 | Тип          | Фильтрация             | Описание            |
|--------------------------|:-------------| :--------------------- |:--------------------|
| **vatCertificateDate**   | DateTime     | `=` `!=` `~` `~=` `=~` | Дата выдачи свидетельства плательщика НДС  |
| **vatCertificateNumber** | String(100)  | `=` `!=` `~` `~=` `=~` | Номер свидетельства плательщика НДС |
| **bin**                  | String(20)   | `=` `!=` `~` `~=` `=~` | БИН                |
| **iin**                  | String(20)   | `=` `!=` `~` `~=` `=~` | ИИН                 |
| **oked**                 | String(20)   | `=` `!=` `~` `~=` `=~` | ОКЭД                |
| **kbe**                  | String(20)   | `=` `!=` `~` `~=` `=~` | КБе                 |

Поля вложены в объект **mod\_\_requisites\_\_kz**.  Конкретный набор полей, определяется типом юридического лица.
Подробнее о типах юридических лиц [тут](#/dictionaries/counterparty#4-tip-kontragenta).
...
| **legalKZ**               | KZ     | Юридическое лицо, Казахстан                |
| **entrepreneurKZ**        | KZ     | Индивидуальный предприниматель, Казахстан  |
| **individualKZ**          | KZ     | Физическое лицо, Казахстан                 |
...
Для регионов со своими типами юридических лиц и наборами реквизитов рекомендуем перейти на их использование, для этого:

- Аккаунт должен быть привязан к тому же региону, что и выбранный тип юридического лица
- Для изменения региона аккаунта обратитесь в техническую поддержку

Ранее созданные контрагенты и юрлица сохранят исходный тип и не будут автоматически изменены.
...
Если тип контрагента `Юридическое лицо, Казахстан`, будут выведены следующие поля реквизитов:

| Название                                         | Описание                                  |
|--------------------------------------------------|-------------------------------------------|
| **legalAddress**                                 | Юридический адрес Контрагента             |
| **legalTitle**                                   | Полное наименование Контрагента           |
| **mod\_\_requisites\_\_kz.bin**                  | БИН                                       |
| **mod\_\_requisites\_\_kz.oked**                 | ОКЕД                                      |
| **mod\_\_requisites\_\_kz.kbe**                  | КБе                                       |
| **mod\_\_requisites\_\_kz.vatCertificateNumber** | Номер свидетельства плательщика НДС       |
| **mod\_\_requisites\_\_kz.vatCertificateDate**   | Дата выдачи свидетельства плательщика НДС |
...
Если тип контрагента `Индивидуальный предприниматель, Казахстан`, будут выведены следующие поля реквизитов:

| Название                                         | Описание                                                                                                                                                                       |
|--------------------------------------------------| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **legalAddress**                                 | Юридический адрес Контрагента                                                                                                                                                  |
| **legalAddressFull**                             | Юридический адрес Контрагента с детализацией по отдельным полям                                                                                                                |
| **legalFirstName**                               | Имя для Контрагента типа `[Индивидуальный предприниматель, Казахстан; Физическое лицо, Казахстан]`. Игнорируется для Контрагентов типа `[Юридическое лицо, Казахстан]`      |
| **legalLastName**                                | Фамилия для Контрагента типа `[Индивидуальный предприниматель, Казахстан; Физическое лицо, Казахстан]`. Игнорируется для Контрагентов типа `[Юридическое лицо, Казахстан]`  |
| **legalMiddleName**                              | Отчество для Контрагента типа `[Индивидуальный предприниматель, Казахстан; Физическое лицо, Казахстан]`. Игнорируется для Контрагентов типа `[Юридическое лицо, Казахстан]` |
| **legalTitle**                                   | Полное наименование Контрагента. Игнорируется, если передано одно из значений для ФИО. Формируется автоматически на основе получаемых ФИО Контрагента                          |
| **mod\_\_requisites\_\_kz.iin**                  | ИИН                                       |
| **mod\_\_requisites\_\_kz.oked**                 | ОКЕД                                      |
| **mod\_\_requisites\_\_kz.kbe**                  | КБе                                       |
| **mod\_\_requisites\_\_kz.vatCertificateNumber** | Номер свидетельства плательщика НДС       |
| **mod\_\_requisites\_\_kz.vatCertificateDate**   | Дата выдачи свидетельства плательщика НДС |
...
| **legalMiddleName**  | Отчество для Контрагента типа `[Индивидуальный предприниматель, Физическое лицо]`. Игнорируется для Контрагентов типа `[Юридическое лицо]`            |
| **legalTitle**       | Полное наименование Контрагента. Игнорируется, если передано одно из значений для ФИО. Формируется автоматически на основе получаемых ФИО Контрагента |
| **sex**              | Пол Контрагента. [Подробнее тут](#/dictionaries/counterparty#4-pol-kontragenta)                                                  |
...
Если тип контрагента `Физическое лицо, Казахстан`, будут выведены следующие поля реквизитов:

| Название                                         | Описание                                                                                                                                                                    |
|--------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **birthDate**                                    | Дата рождения Контрагента типа `[Физическое лицо, Казахстан]`. Игнорируется для Контрагентов типа `[Индивидуальный предприниматель, Юридическое лицо]`                      |
| **legalAddress**                                 | Юридический адрес Контрагента                                                                                                                                               |
| **legalAddressFull**                             | Юридический адрес Контрагента с детализацией по отдельным полям                                                                                                             |
| **legalFirstName**                               | Имя для Контрагента типа `[Индивидуальный предприниматель, Казахстан; Физическое лицо, Казахстан]`. Игнорируется для Контрагентов типа `[Юридическое лицо, Казахстан]`      |
| **legalLastName**                                | Фамилия для Контрагента типа `[Индивидуальный предприниматель, Казахстан; Физическое лицо, Казахстан]`. Игнорируется для Контрагентов типа `[Юридическое лицо, Казахстан]`  |
...
О работе с доп. полями Контрагентов можно прочитать [здесь](#/general#3-rabota-s-dopolnitelnymi-polyami)
...
| **tags**                       | `string`(optional) *Example: рабочие*. Подробнее про данный параметр можно посмотреть в разделе [Фильтрация выборки с помощью параметра filter](#/general#3-filtraciya-vyborki-s-pomoshyu-parametra-filter). Формат строки : `string` |
...
> Пример 8 (работа с KZ контрагентом)
...
> Пример 9 (работа с KZ контрагентом)
...
curl -X POST
  ...
  -d '{
        ...
        "legalAddress": "г.Москва ул Авиастроителей д 93 к 12",
        "mod__requisites__kz": {
          "vatCertificateNumber": "12345",
          "vatCertificateDate": "2024-10-17 00:00:00",
          "iin": "125152124",
          "oked": "134423",
          "kbe": "11"
        }
...
> Пример 10 (работа с KZ контрагентом)
...
curl -X POST
  ...
  "attributes":[  
    ...
    {  
      "meta":{  
        "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata/attributes/0d12a9a5-2c8c-11e6-8a84-bae5000000f4",
        "type":"attributemetadata",
        "mediaType":"application/json"
      },
      "name":"AttributeName2",
    ...
    {  
      "meta":{  
        "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata/attributes/0d12b1e7-2c8c-11e6-8a84-bae5000000f5",
        "type":"attributemetadata",
        "mediaType":"application/json"
      },
      "name":"AttributeName3",
...
{  
  "meta":{  
    "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/88fc07ac-2c8d-11e6-8a84-bae500000050",
    "metadataHref":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
    "type":"counterparty",
    "mediaType":"application/json"
  },
  ...
  "accounts":{  
    "meta":{  
      "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/88fc07ac-2c8d-11e6-8a84-bae500000050/accounts",
      "type":"account",
      "mediaType":"application/json",
      "size":0,
      "limit":1000,
  ...
  "contactpersons":{  
    "meta":{  
      "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/88fc07ac-2c8d-11e6-8a84-bae500000050/contactpersons",
      "type":"contactperson",
      "mediaType":"application/json",
      "size":0,
      "limit":1000,
  ...
  "notes":{  
    "meta":{  
      "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/88fc07ac-2c8d-11e6-8a84-bae500000050/notes",
      "type":"note",
      "mediaType":"application/json",
      "size":0,
      "limit":1000,
...
curl -X POST
  ...
  {  
    "meta":{  
      "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/6a9c3857-2c8b-11e6-8a84-bae500000047",
      "metadataHref":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
      "type":"counterparty",
      "mediaType":"application/json"
    },
...
[  
  ...
  {  
    ...
    "accounts":{  
      "meta":{  
        "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/6a9c3857-2c8b-11e6-8a84-bae500000047/accounts",
        "type":"account",
        "mediaType":"application/json",
        "size":0,
        "limit":1000,
    ...
    "contactpersons":{  
      "meta":{  
        "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/6a9c3857-2c8b-11e6-8a84-bae500000047/contactpersons",
        "type":"contactperson",
        "mediaType":"application/json",
        "size":0,
        "limit":1000,
    ...
    "notes":{  
      "meta":{  
        "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/6a9c3857-2c8b-11e6-8a84-bae500000047/notes",
        "type":"note",
        "mediaType":"application/json",
        "size":0,
        "limit":1000,
...
[Массовое создание и обновление](#/general#3-sozdanie-i-obnovlenie-neskolkih-obuektov) Контрагентов.
...
```shell
curl -X DELETE
  "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b19"
  -H "Authorization: Basic <Credentials>"
  -H "Accept-Encoding: gzip"  
```
...
```shell
curl -X POST
  "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/delete"
  -H "Authorization: Basic <Credentials>"
  -H "Accept-Encoding: gzip"
  -H "Content-Type: application/json"
  -d '[
        {
            "meta": {
                "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b1",
                "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
                "type": "counterparty",
                "mediaType": "application/json"
            }
        ...
        {
            "meta": {
                "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b2",
                "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
                "type": "counterparty",
                "mediaType": "application/json"
            }
...
{  
  ...
  "states":[  
    ...
    {  
      "meta":{  
        "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata/states/fb56cae3-2e58-11e6-8a84-bae50000006a",
        "type":"state",
        "mediaType":"application/json"
      },
...
| **attributes**                 | Массив объектов доп. полей Контрагентов в формате [Метаданных](#/general#3-metadannye) |
...
```shell
curl -X GET
  "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata/attributes/5290a290-0313-11e6-9464-e4de00000020"
  -H "Authorization: Basic <Credentials>"
  -H "Accept-Encoding: gzip"  
```
...
{
  "meta": {
    "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata/attributes/5290a290-0313-11e6-9464-e4de00000020",
    "type": "attributemetadata",
    "mediaType": "application/json"
  },
  "id": "5290a290-0313-11e6-9464-e4de00000020",
...
{
  "meta": {
    "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b19",
    "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
    "type": "counterparty",
    "mediaType": "application/json",
  ...
  "accounts": {
    "meta": {
      "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b19/accounts",
      "type": "account",
      "mediaType": "application/json",
      "size": 0,
      "limit": 100,
  ...
  "contactpersons": {
    "meta": {
      "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b19/contactpersons",
      "type": "contactperson",
      "mediaType": "application/json",
      "size": 0,
      "limit": 100,
  ...
  "notes": {
    "meta": {
      "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b19/notes",
      "type": "note",
      "mediaType": "application/json",
      "size": 0,
      "limit": 100,
...
#### Описание изменения контранегта
...
помечены `Только для чтения` в описании [атрибутов Контрагента](#/dictionaries/counterparty#2-kontragent).
...
{  
  ...
  "contactpersons":{  
    "meta":{  
      "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/ee15550e-2c9e-11e6-8a84-bae500000003/contactpersons",
      "type":"contactperson",
      "mediaType":"application/json",
      "size":2,
      "limit":1000,
  ...
  "notes":{  
    "meta":{  
      "href":"https://api.moysklad.ru/api/remap/1.2/entity/counterparty/ee15550e-2c9e-11e6-8a84-bae500000003/notes",
      "type":"note",
      "mediaType":"application/json",
      "size":0,
      "limit":1000,
...
```json
{
  ...
  "rows": [
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/6a9c3857-2c8b-11e6-8a84-bae500000047/accounts/04c5d0dc-2c92-11e6-8a84-bae5000000f6",
        "type": "account",
        "mediaType": "application/json"
      },
    ...
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/6a9c3857-2c8b-11e6-8a84-bae500000047/accounts/6a9c43ce-2c8b-11e6-8a84-bae500000048",
        "type": "account",
        "mediaType": "application/json"
      },
...
#### Описание обновления счета Контрагента
...
```shell
curl -X GET
  "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b19/contactpersons"
  -H "Authorization: Basic <Credentials>"
  -H "Accept-Encoding: gzip"
```
...
```json
{
  ...
  "rows": [
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/b80ea81b-7058-11e6-8a84-bae500000000/contactpersons/43e39375-7059-11e6-8a84-bae5000000cb",
        "type": "contactperson",
        "mediaType": "application/json"
      },
    ...
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/b80ea81b-7058-11e6-8a84-bae500000000/contactpersons/308142fc-7059-11e6-8a84-bae5000000c6",
        "type": "contactperson",
        "mediaType": "application/json"
      },
    ...
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/b80ea81b-7058-11e6-8a84-bae500000000/contactpersons/13af74bf-7059-11e6-8a84-bae5000000c3",
        "type": "contactperson",
        "mediaType": "application/json"
      },
...
[
  {
    "meta": {
      "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b19/contactpersons/ceba215c-d5cb-11e7-0532-9eed00000005",
      "type": "contactperson",
      "mediaType": "application/json"
    },
...
{
  "meta": {
    "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/ee15550e-2c9e-11e6-8a84-bae500000003/contactpersons/94433ed3-2c9f-11e6-8a84-bae500000010",
    "type": "contactperson",
    "mediaType": "application/json"
  },
  ...
  "agent": {
    "meta": {
      "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/ee15550e-2c9e-11e6-8a84-bae500000003",
      "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
      "type": "counterparty",
      "mediaType": "application/json"
    }
...
#### Описание обновления контактного лица Контрагента
Обновить контактное лицо Контрагента с указанным id.
Обновляются все поля, указанные в JSON объекте запроса, кроме
помеченных `Только для чтения` в описании [атрибутов контактных лиц Контрагента](#/dictionaries/counterparty#5-kontaktnye-lica-kontragentov).
Поля, которые не были указаны в JSON запроса, не изменяются.
...
```shell
curl -X GET
  "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/67e5a691-3c9c-11e7-8af5-581e00000056/notes"
  -H "Authorization: Basic <Credentials>"
  -H "Accept-Encoding: gzip"
```
...
```json
{
  ...
  "meta": {
    "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/67e5a691-3c9c-11e7-8af5-581e00000056/notes",
    "type": "note",
    "mediaType": "application/json",
    "size": 2,
    "limit": 1000,
  ...
  "rows": [
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/67e5a691-3c9c-11e7-8af5-581e00000056/notes/7e391b16-3efd-11e7-8af5-581e0000009d",
        "type": "note",
        "mediaType": "application/json"
      },
      ...
      "agent": {
        "meta": {
          "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/67e5a691-3c9c-11e7-8af5-581e00000056",
          "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/metadata",
          "type": "counterparty",
          "mediaType": "application/json"
        }
      ...
      "author": {
        "meta": {
          "href": "https://api.moysklad.ru/api/remap/1.2/entity/employee/b1876a85-3efa-11e7-8af5-581e0000002a",
          "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/employee/metadata",
          "type": "employee",
          "mediaType": "application/json"
        }
    ...
    {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/67e5a691-3c9c-11e7-8af5-581e00000056/notes/7b919056-3efd-11e7-8af5-581e0000009a",
        "type": "note",
        "mediaType": "application/json"
      },
...
[
  {
    "meta": {
      "href": "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/67e5a691-3c9c-11e7-8af5-581e00000056/notes/50b318cb-3cb0-11e7-8af5-581e00000007",
      "type": "note",
      "mediaType": "application/json"
    },
    ...
    "author": {
      "meta": {
        "href": "https://api.moysklad.ru/api/remap/1.2/entity/employee/67b86071-3c9c-11e7-8af5-581e0000002a",
        "metadataHref": "https://api.moysklad.ru/api/remap/1.2/entity/employee/metadata",
        "type": "employee",
        "mediaType": "application/json"
      }
...
```shell
curl -X GET
  "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/7944ef04-f831-11e5-7a69-971500188b19/notes/7944ef04-f831-11e5-7a69-971500188b19"
  -H "Authorization: Basic <Credentials>"
  -H "Accept-Encoding: gzip"
```
...
### Изменить событие
#### Описание обновления события Контрагента

Обновить событие Контрагента с указанным id.
Обновляются все поля, указанные в JSON объекте запроса, кроме
помеченных `Только для чтения` в описании [атрибутов событий Контрагента](#/dictionaries/counterparty#5-sobytiya-kontragenta).
Поля, которые не были указаны в JSON запроса, не изменяются.
...
```shell
curl -X DELETE
  "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/67e5a691-3c9c-11e7-8af5-581e00000056/notes/50b318cb-3cb0-11e7-8af5-581e00000007"
  -H "Authorization: Basic <Credentials>"
  -H "Accept-Encoding: gzip"
```
...
| Название            | Тип                                                       | Описание                                                                   |
| ------------------- | :-------------------------------------------------------- | :------------------------------------------------------------------------- |
| **meta**            | [Meta](#/general#3-metadannye) | Метаданные Настроек справочника контрагентов<br>`+Обязательное при ответе` |
...
```shell
curl -X GET
  "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/settings"
  -H "Authorization: Basic <Credentials>"
  -H "Accept-Encoding: gzip"
```
...
{
  "meta" : {
    "href" : "https://api.moysklad.ru/api/remap/1.2/entity/counterparty/settings",
