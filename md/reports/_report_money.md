...
curl --compressed -X GET \
  "https://api.moysklad.ru/api/remap/1.2/report/money/plotseries?momentFrom=2018-09-01&momentTo=2018-09-04&interval=day" \
...
{  
  ...
  "meta":{  
    "href":"https://api.moysklad.ru/api/remap/1.2/report/money/plotseries?momentFrom=2018-09-01&momentTo=2018-09-04&interval=day",
...
```shell
curl --compressed -X GET \
  "https://api.moysklad.ru/api/remap/1.2/report/money/plotseries?momentFrom=2018-09-01&momentTo=2018-09-04&interval=day&filter=organization=https://api.moysklad.ru/api/remap/1.2/entity/organization/00cd5a99-6897-11e7-7a6c-d2a9000c4fc0;project=https://api.moysklad.ru/api/remap/1.2/entity/project/02e64f51-6897-11e7-7a34-5acf000c8448" \
  -H "Authorization: Basic <Credentials>" \
  -H "Accept-Encoding: gzip"
```
...
{  
  ...
  "meta":{  
    "href":"https://api.moysklad.ru/api/remap/1.2/report/money/plotseries?momentFrom=2018-09-01&momentTo=2018-09-04&interval=day&filter=organization=https://api.moysklad.ru/api/remap/1.2/entity/organization/00cd5a99-6897-11e7-7a6c-d2a9000c4fc0;project=https://api.moysklad.ru/api/remap/1.2/entity/project/02e64f51-6897-11e7-7a34-5acf000c8448",
    "type":"moneyplotseries",
    "mediaType":"application/json"
  },
  "credit":60,
...
| Название         | Тип    | Описание                                                                                                                                                                          |
| ---------------- | :----- |:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **account**      | Object | Счет организации (не выводится для остатка кассы, так как касса одна на организацию). [Подробнее тут](#/dictionaries/organization#3-zaprosy-scheta-yurlica)                       |
| **organization** | Object | Организация. [Подробнее тут](#/dictionaries/organization#2-yurlico)<br>`+Обязательное при ответе`                                                                                 |
| **balance**      | Float  | Текущий остаток денежных средств средств в валюте счета<br>`+Обязательное при ответе`                                                                                             |

#### Счет организации

| Название | Тип                                                       | Описание                                             |
| -------- | :-------------------------------------------------------- | :--------------------------------------------------- |
| **meta** | [Meta](#/general#3-metadannye) | Метаданные организации<br>`+Обязательное при ответе` |
...
{  
  ...
  "meta":{  
    "href":"https://api.moysklad.ru/api/remap/1.2/report/money/byaccount",
    "type":"moneyreport",
    "mediaType":"application/json"
  },
  "rows":[  
