...
### 23-01-2026
**Добавлено**
- Поле `rate` с валютой расчетного счета в счетах юрлица, возвращаемое в ответах [Юрлица](#/dictionaries/organization#2-yurlico) (раздел «Счета юрлица»).
- Коды ошибок для расчетных счетов: [80000-80001](#/errors#3-kody-oshibok-dlya-raschetnyh-schetov)
