...
### 31-03-2026
**Добавлено**
- Новый эндпоинт [Ассортимент](#/dictionaries/assortment) облегчённая версия без расчёта остатков

**Изменено**
- Эндпоинт [Ассортимент](#/dictionaries/assortment-legacy) помечен как планируемый к удалению
