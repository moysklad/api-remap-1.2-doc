...
### 23-01-2026
**Добавлено**
- Поле `currency` с валютой расчетного счета в счетах юрлица, возвращаемое в ответах [Юрлица](#/dictionaries/organization#2-yurlico) (раздел «Счета юрлица») для счетов с заполненным `accountNumber`.
- Код ошибки для расчетных счетов: [72000](#/errors#3-kody-oshibok-dlya-raschetnyh-schetov)
- При попытке изменить валюту существующего расчетного счета возвращается ошибка [3001](#/errors#3-obshie-oshibki-validacii)
