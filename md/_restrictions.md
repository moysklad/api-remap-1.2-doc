...
Лимиты на количество запросов в 3-секундный период зависят от используемого способа аутентификации ([подробнее в этом разделе](#/restrictions#3-limit-zaprosov-za-3-sekundnyj-period))
...
Количество оставшихся запросов в рамках лимита «запросов в единицу времени» можно определить с помощью заголовков. [Подробнее тут](#/general#3-obrabotka-oshibok).
...
+ для интеграций, использующих логин и пароль пользователя или токен пользователя вес одного запроса будет увеличиваться поэтапно:
...
При превышении лимита будет отдаваться ошибка 429. [Подробнее тут](#/general#3-obrabotka-oshibok).
