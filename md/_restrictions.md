...
### Повышенный расход лимитов запросов

Для следующих эндпоинтов действует повышенный расход лимитов: каждый запрос к этим эндпоинтам засчитывается как 5 запросов:
