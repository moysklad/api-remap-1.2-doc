...
| **NewMentionInTaskNote**                     | Упоминания сотрудников | Новое упоминание в комментарии Задачи                                  |
...
| **SalesManagerChatMessage**                  | Чаты                   | Новое сообщение от менеджера отдела продаж                             |
